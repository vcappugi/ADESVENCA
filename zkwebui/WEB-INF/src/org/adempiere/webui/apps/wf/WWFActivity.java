...
public class WWFActivity extends ADForm implements EventListener
{
	...
	//Modificacion preview en web vcappugi
	private Button preview = new Button();
	//Fin Modificacion preview en web vcappugi
    ...
    protected void initForm()
    {
    	...
    	preview.setImage("/images/Print24.png");
	...
	private void init()
	{
		...
		preview.addEventListener(Events.ON_CLICK, this);
		//fin boton preview
	...
	private void cmd_preview()
	{
		...
		if (m_activity == null)
			return;
		//AEnv.zoom(m_activity.getAD_Table_ID(), m_activity.getRecord_ID());
		ProcessInfo pi = new ProcessInfo ("Preview", 110, m_activity.getAD_Table_ID(),  m_activity.getRecord_ID());
		pi.setAD_User_ID (Env.getAD_User_ID(Env.getCtx()));
		pi.setAD_Client_ID (Env.getAD_Client_ID(Env.getCtx()));
		pi.setPrintPreview(true);
		
		ProcessCtl.process(null, 0, pi, null); //  calls lockUI, unlockUI
