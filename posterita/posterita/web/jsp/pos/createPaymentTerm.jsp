...
<html:form action="/PaymentTermAction">
<html:hidden property="action" value="<%=PaymentTermAction.CREATE_PAYMENT_TERM%>"/>
...
<table>
	<tr>
		<td>
				<pos:message key="FixMonthOffset" />  
		<td>
	</tr>
	
	<tr>
		<td>
				<pos:message key="FixMonthCutoff" />  
		<td>
	</tr>
	<tr>
		<td>
				<pos:message key="FixMonthDay" />  
		<td>
	</tr>
</table>
-->
