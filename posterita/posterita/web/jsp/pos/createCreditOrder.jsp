...
<html:form action="/AddToPOSShoppingCartAction" focus="barCode">
	<html:hidden property="orderType" value="<%=Constants.CREDIT_ORDER%>"/>
	<%@ include file="/jsp/include/creditOrderWithAdvanced.jsp" %>
...
function checkout()
{
	...
	setAction(document.forms[0],'GetCreditOrderDiscDetailsAction.do','getCreditOrderDiscDetails');
	disableButtons();
}
...
{
	window.location = "InitCreatePOSCustomer.do?action=initCreatePOSCustomer&creatingFromOrder=creditOrder";
}
...
{
	var pin  = PIN.value;		
	var url  = 'CreateCreditOrderAction.do';
