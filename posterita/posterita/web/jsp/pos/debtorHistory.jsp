...
<h2><pos:message key="debtor.history"/></h2>
...
<table class="display" border="1">
	...
	<logic:notEmpty name="<%= Constants.DEBTOR_HISTORY %>">
	<logic:iterate id="element" name="<%= Constants.DEBTOR_HISTORY %>" type="org.posterita.beans.StatementOfAccountBean">
	<tr>
