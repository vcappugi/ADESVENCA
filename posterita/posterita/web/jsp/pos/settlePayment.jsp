...
<bean:define id="title"><pos:message key="smenu.settle.payment.credit.sales" textOnly="true"/></bean:define>
<%@ include file="/jsp/include/posHeader.jsp" %>


<html:form action="/GetBpartnerPaymentStatus">
<html:hidden property="action" value="<%=CreditOrderAction.GET_BPARTNER_PAYMENT_STATUS%>"/> 
<table>
<tr>
<td valign="top" width="400px">
	<fieldset>
	<legend><pos:message key="customer.info" textOnly="true"/></legend>
	<div>
		<div>
			<label><pos:message key="customer.id" textOnly="true"/></label>
		</div>
		<html:text property="bpartnerId" styleClass="text" accesskey="i"/> 
		<div>
			<label><pos:message key="search.customer" textOnly="true"/></label>
		</div>
...
--%>
<html:form action="/MatchInvoiceAction">
...
toConsole(chks[0].type);
toConsole(amts[0].type);
toConsole(payBtn.type);
