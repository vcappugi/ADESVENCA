...
<table class="view" width="100%">
	<tr>
		<td align="right">			
			<html:button property="btn" styleClass="newnote bigbutton" onclick="createNewGoodsReceiveNote()" accesskey="n">&nbsp;</html:button> 		
		</td>
	</tr>
	<tr>					  
		<td align="center">
		<span>
			<span class="shortcutkey">
				<label><pos:message key="new.goods.received.note"/>-</label>
...
<script>
function createNewGoodsReceiveNote()
{
	window.location = "GetAllPOSVendor.do?action=getAllVendors&isSales=true";
}
