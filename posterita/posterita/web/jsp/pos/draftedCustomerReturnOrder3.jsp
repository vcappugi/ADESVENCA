...
<!-- draftedCustomerReturnOrder3.jsp -->
...
<bean:define id="title"><pos:message textOnly="true" key="credit.memo"/></bean:define>
<%@ include file="/jsp/include/posHeader.jsp" %>
<%@ include file="/jsp/include/errors.jsp" %>  
	  						   

<html:form action="/CreateCustomerReturnOrderAction3">
...
<div class="space"></div>
<div align="right"><html:button property="deleteBtn" styleClass="delete smallbutton" disabled="true" accesskey="d">&nbsp;</html:button>
</div>									
</html:form>
<div class="space"></div>
<div align="right">
<html:form action="/CompleteCustomerReturnOrderAction3">
	<html:hidden property="action" value="<%=POSGoodsAction.COMPLETE_CUSTOMER_RETURN_ORDER%>"/>
					<logic:present name="<%= Constants.CUSTOMER_RETURN_ORDER_ID  %>">
							...
							<html:button property="edit" styleClass="smallbutton edit">
								&nbsp;
							</html:button>							
					   </logic:present>	
	&nbsp;	
...
{
	setAction(this.form,'CompleteCustomerReturnOrderAction2.do','completeCustomerReturnOrder');
	disableButtons();
};
