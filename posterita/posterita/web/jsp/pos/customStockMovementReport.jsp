...
<bean:define id="title"><pos:message textOnly="true" key="stock.movement.report"/></bean:define>
<%@ include file="/jsp/include/posHeader.jsp" %> 
<%@ include file="/jsp/include/errors.jsp" %>
 
<html:form action="/CustomStockMovementReportAction">
