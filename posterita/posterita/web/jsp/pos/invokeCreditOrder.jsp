...
<bean:define id="title"><pos:message textOnly="true" key="smenu.creditmemo.from.creditorder.id"/></bean:define>
<%@ include file="/jsp/include/posHeader.jsp" %>   
<%@ include file="/jsp/include/errors.jsp" %> 
	  						   	
<html:form action="/CreditMemoAction" focus="documentNo">
<html:hidden property="action" value="loadCreditOrder"/>
