...
<html:form action="/EditPOSRoleAction" styleId="roleConfig">
<%
	...
	boolean isDiscountUptoLimitPrice = roleBean.getIsDiscountUptoLimitPrice().booleanValue();
	String discountUptoLimitPrice = "";
	if(isDiscountUptoLimitPrice)
		discountUptoLimitPrice = "checked=\"checked\"";
	
	boolean isDiscountOnTotal = roleBean.getIsDiscountAllowedOnTotal().booleanValue();
	String discountOnTotal = "";
	if(isDiscountOnTotal)
		discountOnTotal = "checked=\"checked\"";;
...
<table class="display" border="1">
   <tr>
   		...
   		<td  class="contentName"><html:text property="name" styleClass="text" value="<%= role%>"/></td>
   </tr>
   ...
   <tr id="discLimitPrice">				
		<td align="left"><pos:message key="discount.upto.price.limit"/></td>
   		<td><html:checkbox property="isDiscountUptoLimitPrice" styleId="isDiscountUptoLimitPrice" name="<%=Constants.ROLE%>" value="true"/></td>
	</tr>
	<tr id="overidePrice">				
			<td>
			...
			<td>
   				<html:checkbox property="isOverwritePriceLimit" styleId="isOverwritePriceLimit" name="<%=Constants.ROLE%>" value="true"/>
   			</td>
	</tr>
	<tr id="discountOnTotal">				
			...
			<td>
   				<html:checkbox property="isDiscountAllowedOnTotal" styleId="isDiscountAllowedOnTotal" name="<%=Constants.ROLE%>" value="true"/>
   			</td>
	</tr>
   <tr id="discount">			
		...
		<td class="contentName" >
			<html:text property="userDiscount" name="<%=Constants.ROLE%>" styleId="userDiscount" styleClass="text"/>
		</td>
	</tr>
</table>
<table class="main">	
