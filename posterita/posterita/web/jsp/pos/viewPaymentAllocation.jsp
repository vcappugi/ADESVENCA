...
<html:form action="/ViewPaymentAllocationAction">
<html:hidden property="action" value="<%=CreditOrderAction.GET_ALLOCATION_DETAILS_FOR_PARTNER %>"/>	
<html:hidden property="isCustomer" value="true"/>	
<html:hidden property="isVendor" value="false"/>	
