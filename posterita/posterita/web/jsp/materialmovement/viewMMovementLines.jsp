...
<bean:define id="title">Stock Movement</bean:define>
	...
	<html:hidden property="movementId"/>
		...
		<tr width = "100%">
			<td padding="10px" width = "100%" align="left">
				<input type="button" value="<pos:message key="back" textOnly="true"/>" class="newbutton" onclick="get('ViewMMovement.do?action=viewMMovement')">
			</td>
			<td align="right">
