...
public class EMailServerLoginException extends OperationException
{
	/**
	 * 
	 */
	...
	public EMailServerLoginException(String msg)
	{
		super(msg);
	}
	
	public EMailServerLoginException(String msg, Exception ex)
	{
		super(msg, ex);
	}
}
