...
*
* Created on Jun 1, 2006 by ashley
* 
*/
...
public class EMailServerMessageException extends OperationException
{
	/**
	 * 
	 */
	...
	public EMailServerMessageException(String msg)
	{
		super(msg);
	}
	
	public EMailServerMessageException(String msg, Exception ex)
	{
		super(msg, ex);
	}
