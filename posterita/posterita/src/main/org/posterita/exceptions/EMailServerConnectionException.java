...
*
* Created on May 31, 2006 by ashley
* 
*/
...
public class EMailServerConnectionException extends OperationException
{
	/**
	 * 
	 */
	...
	public EMailServerConnectionException(String msg)
	{
		super(msg);
	}
	
	public EMailServerConnectionException(String msg, Exception ex)
	{
		super(msg, ex);
	}
}
