...
public class RoleKeyNamePair extends KeyNamePairUtil
{
	 public static ArrayList getKeyName(Properties ctx) throws OperationException
	 {
	 	String sql = "ad_client_id=" + Env.getAD_Client_ID(ctx) + "and ad_org_id=" + Env.getAD_Org_ID(ctx) + " and isactive = 'Y'";
	 	
	 	try 
        {
            return getData(ctx, MRole.Table_Name,sql);
        } 
