...
// N
	...
	/** Set HR_Payroll_Type_Line2_ID.
		@param HR_Payroll_Type_Line2_ID HR_Payroll_Type_Line2_ID	  */
	public void setHR_Payroll_Type_Line2_ID (int HR_Payroll_Type_Line2_ID)
	{
		if (HR_Payroll_Type_Line2_ID < 1) 
			set_Value (COLUMNNAME_HR_Payroll_Type_Line2_ID, null);
		else 
			set_Value (COLUMNNAME_HR_Payroll_Type_Line2_ID, Integer.valueOf(HR_Payroll_Type_Line2_ID));
	}

	/** Get HR_Payroll_Type_Line2_ID.
		@return HR_Payroll_Type_Line2_ID	  */
	public int getHR_Payroll_Type_Line2_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_HR_Payroll_Type_Line2_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set HR_Payroll_Type_Line.
		@param HR_Payroll_Type_Line_ID HR_Payroll_Type_Line	  */
	public void setHR_Payroll_Type_Line_ID (int HR_Payroll_Type_Line_ID)
	{
		if (HR_Payroll_Type_Line_ID < 1) 
			set_Value (COLUMNNAME_HR_Payroll_Type_Line_ID, null);
		else 
			set_Value (COLUMNNAME_HR_Payroll_Type_Line_ID, Integer.valueOf(HR_Payroll_Type_Line_ID));
	}

	/** Get HR_Payroll_Type_Line.
		@return HR_Payroll_Type_Line	  */
	public int getHR_Payroll_Type_Line_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_HR_Payroll_Type_Line_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
