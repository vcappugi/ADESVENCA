...
public class X_HR_Movement extends PO implements I_HR_Movement, I_Persistent 
{
	...
	@Override
	public void setHR_Change_Job_ID(int HR_Change_Job_ID) {
		// TODO Auto-generated method stub
		if (HR_Change_Job_ID< 1) 
			set_ValueNoCheck (COLUMNNAME_HR_Change_Job_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_HR_Change_Job_ID, Integer.valueOf(HR_Change_Job_ID));
	}

	@Override
	public int getHR_Change_Job_ID() {
		
		Integer ii = (Integer)get_Value(COLUMNNAME_HR_Change_Job_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
