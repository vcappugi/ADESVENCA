...
// N
	...
	@Override
	public void setHR_Contract_ID(int HR_Contract_ID_ID) {
	...
	public void setHR_Payroll_Type_Line_ID(int HR_Payroll_Type_Line_ID) {
		...
		if (HR_Payroll_Type_Line_ID< 1) 
			set_ValueNoCheck (COLUMNNAME_HR_Payroll_Type_Line_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_HR_Payroll_Type_Line_ID, Integer.valueOf(HR_Payroll_Type_Line_ID));
	...
	public void setHR_Standing_ID(int HR_Standing_ID) {
		// TODO Auto-generated method stub
		if (HR_Standing_ID< 1) 
			set_ValueNoCheck (COLUMNNAME_HR_Standing_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_HR_Standing_ID, Integer.valueOf(HR_Standing_ID));
