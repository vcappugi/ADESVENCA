...
public class VHRActionNotice extends HRActionNotice implements FormPanel, ActionListener, VetoableChangeListener
{
	...
	public static void saveMovement()
	{
		...
		movementOK.setQty(fieldQty.getValue() != null ? getRound(fieldQty.getValue()).setScale(2,BigDecimal.ROUND_UP) : Env.ZERO);
		movementOK.setAmount(fieldAmount.getValue() != null ? getRound(fieldAmount.getValue()).setScale(2,BigDecimal.ROUND_UP) : Env.ZERO );
	...
	private static BigDecimal getRound(Object value){
