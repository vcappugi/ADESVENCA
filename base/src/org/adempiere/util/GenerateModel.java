...
public class GenerateModel
{
	...
	public static void main (String[] args)
	{
		...
		String directory = "/home/vcappugi/workspace2/Adempiere_370_EXTEND";
		if (args.length > 0)
			directory = args[0];
		...
		//	second parameter
		String packageName = "pentanet.model";
		if (args.length > 1)
			packageName = args[1]; 
		...
		//	third parameter
		//String entityType = "'U','A', 'P'";	//	User, Application
		String entityType = "'P'";	//	User, Application
		if (args.length > 2)
			entityType = args[2]; 
		...
		if (tableLike.indexOf(",") == -1)
			sql.append(" AND TableName LIKE '").append(tableLike).append("'") ;
		else
