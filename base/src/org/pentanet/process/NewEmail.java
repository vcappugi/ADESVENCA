...
public class NewEmail extends SvrProcess{
	...
	public String sendEmail(String from, String to, String tittle, String subtittle, String body){
		...
		if (m_cc != null){
			for(InternetAddress ia : m_cc)
				correo.addCc(ia.toString());
		}
	...
	/*****************************************************************************
	 * Creacion y Envio de mensaje desde Plantilla (R_MailText)
	 ******************************************************************************/
	public void sendEmail(int R_MailText_ID)
	{
		MMailText mailT = new MMailText(Env.getCtx(), R_MailText_ID, null);
		
		for(MMailData list : mailT.getMailData())
		{	
	        //sendEmail(String from, String to,String tittle,String subtittle, String body)    
	        sendEmail(null, list.getEmail(), list.getTittle(),null, list.getBody());
		}
	}
	 ...
	 * Agregar CC
	 */
	public boolean addCc(ArrayList<InternetAddress> newListCc){
