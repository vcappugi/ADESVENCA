...
/** Generated Model for C_WorkDD
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0.1LTS (VE) - $Id$ */
public class X_C_WorkDD extends PO implements I_C_WorkDD, I_Persistent 
{
    ...
    public X_C_WorkDD (Properties ctx, int C_WorkDD_ID, String trxName)
    {
...
// @#Date@
    ...
    /** Load Constructor */
    public X_C_WorkDD (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_WorkDD[")
	...
	{
		throw new IllegalArgumentException ("C_Division_ID is virtual column");	}
    ...
    {
		return (org.pentanet.model.I_C_Municipality)MTable.get(getCtx(), org.pentanet.model.I_C_Municipality.Table_Name)
	...
	{
		throw new IllegalArgumentException ("C_ServiceLine_ID is virtual column");	}
	...
	public org.pentanet.model.I_C_Standing getC_Standing() throws RuntimeException
    {
		return (org.pentanet.model.I_C_Standing)MTable.get(getCtx(), org.pentanet.model.I_C_Standing.Table_Name)
			.getPO(getC_Standing_ID(), get_TrxName());	}

	/** Set Standing.
		@param C_Standing_ID Standing	  */
	public void setC_Standing_ID (int C_Standing_ID)
	{
		throw new IllegalArgumentException ("C_Standing_ID is virtual column");	}

	/** Get Standing.
		@return Standing	  */
	public int getC_Standing_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_Standing_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public org.pentanet.model.I_C_Well getC_Well() throws RuntimeException
    {
		return (org.pentanet.model.I_C_Well)MTable.get(getCtx(), org.pentanet.model.I_C_Well.Table_Name)
			.getPO(getC_Well_ID(), get_TrxName());	}

	/** Set C_Well.
		@param C_Well_ID C_Well	  */
	public void setC_Well_ID (int C_Well_ID)
	{
		throw new IllegalArgumentException ("C_Well_ID is virtual column");	}
	...
	{
		if (C_WorkDD_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_WorkDD_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_WorkDD_ID, Integer.valueOf(C_WorkDD_ID));
	}
	...
	/** Set GenerateAdjustment.
		@param GenerateAdjustment GenerateAdjustment	  */
	public void setGenerateAdjustment (String GenerateAdjustment)
	{
		set_Value (COLUMNNAME_GenerateAdjustment, GenerateAdjustment);
	}

	/** Get GenerateAdjustment.
		@return GenerateAdjustment	  */
	public String getGenerateAdjustment () 
	{
		return (String)get_Value(COLUMNNAME_GenerateAdjustment);
	}
	...
	/** Set GrandTotal_Pure.
		@param GrandTotal_Pure GrandTotal_Pure	  */
	public void setGrandTotal_Pure (BigDecimal GrandTotal_Pure)
	{
		set_Value (COLUMNNAME_GrandTotal_Pure, GrandTotal_Pure);
	}

	/** Get GrandTotal_Pure.
		@return GrandTotal_Pure	  */
	public BigDecimal getGrandTotal_Pure () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_GrandTotal_Pure);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set GrandTotal_Usd.
		@param GrandTotal_Usd GrandTotal_Usd	  */
	public void setGrandTotal_Usd (BigDecimal GrandTotal_Usd)
	{
		set_Value (COLUMNNAME_GrandTotal_Usd, GrandTotal_Usd);
	}

	/** Get GrandTotal_Usd.
		@return GrandTotal_Usd	  */
	public BigDecimal getGrandTotal_Usd () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_GrandTotal_Usd);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
