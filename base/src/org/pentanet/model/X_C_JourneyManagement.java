...
/** Generated Model for C_JourneyManagement
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0.1LTS (VE) - $Id$ */
public class X_C_JourneyManagement extends PO implements I_C_JourneyManagement, I_Persistent 
{
    ...
    public X_C_JourneyManagement (Properties ctx, int C_JourneyManagement_ID, String trxName)
    {
      super (ctx, C_JourneyManagement_ID, trxName);
      /** if (C_JourneyManagement_ID == 0)
        {
			setC_BPartner_ID (0);
			setC_JourneyManagement_ID (0);
    ...
    /** Load Constructor */
    public X_C_JourneyManagement (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_JourneyManagement[")
	...
	public org.pentanet.model.I_C_Table_Cost getC_Table_Cost() throws RuntimeException
    {
		return (org.pentanet.model.I_C_Table_Cost)MTable.get(getCtx(), org.pentanet.model.I_C_Table_Cost.Table_Name)
			.getPO(getC_Table_Cost_ID(), get_TrxName());	}
	...
	/** Set IsApproved3.
		@param IsApproved3 IsApproved3	  */
	public void setIsApproved3 (boolean IsApproved3)
	{
		set_Value (COLUMNNAME_IsApproved3, Boolean.valueOf(IsApproved3));
	}
	...
	{
		set_Value (COLUMNNAME_LicensePlate, LicensePlate);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_LicensePlate);
	}
	...
	public org.compiere.model.I_M_Requisition getM_Requisition2() throws RuntimeException
    {
		return (org.compiere.model.I_M_Requisition)MTable.get(getCtx(), org.compiere.model.I_M_Requisition.Table_Name)
			.getPO(getM_Requisition2_ID(), get_TrxName());	}

	/** Set M_Requisition2_ID.
		@param M_Requisition2_ID M_Requisition2_ID	  */
	public void setM_Requisition2_ID (int M_Requisition2_ID)
	{
		if (M_Requisition2_ID < 1) 
			set_Value (COLUMNNAME_M_Requisition2_ID, null);
		else 
			set_Value (COLUMNNAME_M_Requisition2_ID, Integer.valueOf(M_Requisition2_ID));
	}

	/** Get M_Requisition2_ID.
		@return M_Requisition2_ID	  */
	public int getM_Requisition2_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_M_Requisition2_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
