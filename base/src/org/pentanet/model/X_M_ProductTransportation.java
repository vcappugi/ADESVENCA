...
/** Generated Model for M_ProductTransportation
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0.1LTS (VE) - $Id$ */
public class X_M_ProductTransportation extends PO implements I_M_ProductTransportation, I_Persistent 
{
    ...
    public X_M_ProductTransportation (Properties ctx, int M_ProductTransportation_ID, String trxName)
    {
      super (ctx, M_ProductTransportation_ID, trxName);
      /** if (M_ProductTransportation_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_M_ProductTransportation (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_M_ProductTransportation[")
