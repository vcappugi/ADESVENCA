...
/** Generated Model for C_PreInvoice
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0.1LTS (VE) - $Id$ */
public class X_C_PreInvoice extends PO implements I_C_PreInvoice, I_Persistent 
{
    ...
    public X_C_PreInvoice (Properties ctx, int C_PreInvoice_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_C_PreInvoice (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_PreInvoice[")
	...
	public void setC_PreInvoice_ID (int C_PreInvoice_ID)
	{
		if (C_PreInvoice_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_PreInvoice_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_PreInvoice_ID, Integer.valueOf(C_PreInvoice_ID));
	}
