...
/** Generated Model for P_ShipmentDoc
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS (VE) - $Id$ */
public class X_P_ShipmentDoc extends PO implements I_P_ShipmentDoc, I_Persistent 
{
    ...
    public X_P_ShipmentDoc (Properties ctx, int P_ShipmentDoc_ID, String trxName)
    {
      ...
      /** if (P_ShipmentDoc_ID == 0)
        {
			setDocStatus (null);
// DR
			setP_ShipmentDoc_ID (0);
        } */
    }

    /** Load Constructor */
    public X_P_ShipmentDoc (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_P_ShipmentDoc[")
	...
	public void setP_ShipmentDoc_ID (int P_ShipmentDoc_ID)
	{
		if (P_ShipmentDoc_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_P_ShipmentDoc_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_P_ShipmentDoc_ID, Integer.valueOf(P_ShipmentDoc_ID));
	}
