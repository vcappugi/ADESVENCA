...
/** Generated Model for HR_Movement_Ret
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0.1LTS (VE) - $Id$ */
public class X_HR_Movement_Ret extends PO implements I_HR_Movement_Ret, I_Persistent 
{
    ...
    public X_HR_Movement_Ret (Properties ctx, int HR_Movement_Ret_ID, String trxName)
    {
      super (ctx, HR_Movement_Ret_ID, trxName);
      /** if (HR_Movement_Ret_ID == 0)
        {
			setHR_Concept_ID (0);
			setHR_Movement_Ret_ID (0);
			setProcessed (false);
    ...
    /** Load Constructor */
    public X_HR_Movement_Ret (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HR_Movement_Ret[")
	...
	/** Set HR_Movement_Ret.
		@param HR_Movement_Ret_ID HR_Movement_Ret	  */
	public void setHR_Movement_Ret_ID (int HR_Movement_Ret_ID)
	{
		if (HR_Movement_Ret_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_HR_Movement_Ret_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_HR_Movement_Ret_ID, Integer.valueOf(HR_Movement_Ret_ID));
	}

	/** Get HR_Movement_Ret.
		@return HR_Movement_Ret	  */
	public int getHR_Movement_Ret_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_HR_Movement_Ret_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set HR_ProcessRet_ID.
		@param HR_ProcessRet_ID HR_ProcessRet_ID	  */
	public void setHR_ProcessRet_ID (BigDecimal HR_ProcessRet_ID)
	{
		set_Value (COLUMNNAME_HR_ProcessRet_ID, HR_ProcessRet_ID);
	}

	/** Get HR_ProcessRet_ID.
		@return HR_ProcessRet_ID	  */
	public BigDecimal getHR_ProcessRet_ID () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_HR_ProcessRet_ID);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	public org.pentanet.model.I_HR_Retroactive_Line getHR_Retroactive_Line() throws RuntimeException
    {
		return (org.pentanet.model.I_HR_Retroactive_Line)MTable.get(getCtx(), org.pentanet.model.I_HR_Retroactive_Line.Table_Name)
			.getPO(getHR_Retroactive_Line_ID(), get_TrxName());	}
	...
	public void setHR_Retroactive_Line_ID (int HR_Retroactive_Line_ID)
	{
		if (HR_Retroactive_Line_ID < 1) 
			set_Value (COLUMNNAME_HR_Retroactive_Line_ID, null);
		else 
			set_Value (COLUMNNAME_HR_Retroactive_Line_ID, Integer.valueOf(HR_Retroactive_Line_ID));
	}
	...
	/** Set IsWorkedTime.
		@param IsWorkedTime IsWorkedTime	  */
	public void setIsWorkedTime (boolean IsWorkedTime)
	{
		set_Value (COLUMNNAME_IsWorkedTime, Boolean.valueOf(IsWorkedTime));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsWorkedTime);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
