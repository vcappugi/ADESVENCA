...
/** Generated Model for HR_Standing
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS (VE) - $Id$ */
public class X_HR_Standing extends PO implements I_HR_Standing, I_Persistent 
{
    ...
    public X_HR_Standing (Properties ctx, int HR_Standing_ID, String trxName)
    {
      super (ctx, HR_Standing_ID, trxName);
      /** if (HR_Standing_ID == 0)
        {
			setHR_Standing_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_HR_Standing (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HR_Standing[")
