...
/** Generated Model for HR_VacationProg
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0.1LTS (VE) - $Id$ */
public class X_HR_VacationProg extends PO implements I_HR_VacationProg, I_Persistent 
{
    ...
    public X_HR_VacationProg (Properties ctx, int HR_VacationProg_ID, String trxName)
    {
      super (ctx, HR_VacationProg_ID, trxName);
      /** if (HR_VacationProg_ID == 0)
        {
			setHR_Payroll_ID (0);
			setHR_Period_ID (0);
			setHR_VacationProg_ID (0);
			setName (null);
			setValue (null);
        } */
    }
    ...
    /** Load Constructor */
    public X_HR_VacationProg (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HR_VacationProg[")
