...
/** Generated Model for HR_GuardRole
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS (VE) - $Id$ */
public class X_HR_GuardRole extends PO implements I_HR_GuardRole, I_Persistent 
{
    ...
    public X_HR_GuardRole (Properties ctx, int HR_GuardRole_ID, String trxName)
    {
      super (ctx, HR_GuardRole_ID, trxName);
      /** if (HR_GuardRole_ID == 0)
        {
			setHR_GuardRole_ID (0);
			setName (null);
			setValue (null);
        } */
    }
    ...
    /** Load Constructor */
    public X_HR_GuardRole (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HR_GuardRole[")
