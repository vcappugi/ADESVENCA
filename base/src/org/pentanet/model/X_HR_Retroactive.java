...
/** Generated Model for HR_Retroactive
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0.1LTS (VE) - $Id$ */
public class X_HR_Retroactive extends PO implements I_HR_Retroactive, I_Persistent 
{
    ...
    public X_HR_Retroactive (Properties ctx, int HR_Retroactive_ID, String trxName)
    {
      super (ctx, HR_Retroactive_ID, trxName);
      /** if (HR_Retroactive_ID == 0)
        {
			setHR_Retroactive_ID (0);
			setName (null);
			setValue (null);
        } */
    }
    ...
    /** Load Constructor */
    public X_HR_Retroactive (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HR_Retroactive[")
	...
	/** Set BtnConcept.
		@param BtnConcept BtnConcept	  */
	public void setBtnConcept (String BtnConcept)
	{
		set_Value (COLUMNNAME_BtnConcept, BtnConcept);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_BtnConcept);
	}
	...
	/** Set BtnRetroactive.
		@param BtnRetroactive BtnRetroactive	  */
	public void setBtnRetroactive (String BtnRetroactive)
	{
		set_Value (COLUMNNAME_BtnRetroactive, BtnRetroactive);
	}

	/** Get BtnRetroactive.
		@return BtnRetroactive	  */
	public String getBtnRetroactive () 
	{
		return (String)get_Value(COLUMNNAME_BtnRetroactive);
	}
	...
	public org.eevolution.model.I_HR_Concept getHR_Concept2() throws RuntimeException
    {
		return (org.eevolution.model.I_HR_Concept)MTable.get(getCtx(), org.eevolution.model.I_HR_Concept.Table_Name)
			.getPO(getHR_Concept2_ID(), get_TrxName());	}

	/** Set HR_Concept2_ID.
		@param HR_Concept2_ID HR_Concept2_ID	  */
	public void setHR_Concept2_ID (int HR_Concept2_ID)
	{
		if (HR_Concept2_ID < 1) 
			set_Value (COLUMNNAME_HR_Concept2_ID, null);
		else 
			set_Value (COLUMNNAME_HR_Concept2_ID, Integer.valueOf(HR_Concept2_ID));
	}

	/** Get HR_Concept2_ID.
		@return HR_Concept2_ID	  */
	public int getHR_Concept2_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_HR_Concept2_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public void setHR_Retroactive_ID (int HR_Retroactive_ID)
	{
		if (HR_Retroactive_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_HR_Retroactive_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_HR_Retroactive_ID, Integer.valueOf(HR_Retroactive_ID));
	}
	...
	/** Set IsCompensatory.
		@param IsCompensatory IsCompensatory	  */
	public void setIsCompensatory (boolean IsCompensatory)
	{
		set_Value (COLUMNNAME_IsCompensatory, Boolean.valueOf(IsCompensatory));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsCompensatory);
		if (oo != null) 
		{
