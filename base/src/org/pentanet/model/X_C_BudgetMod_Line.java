...
/** Generated Model for C_BudgetMod_Line
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0.1LTS (VE) - $Id$ */
public class X_C_BudgetMod_Line extends PO implements I_C_BudgetMod_Line, I_Persistent 
{
    ...
    public X_C_BudgetMod_Line (Properties ctx, int C_BudgetMod_Line_ID, String trxName)
    {
      super (ctx, C_BudgetMod_Line_ID, trxName);
      /** if (C_BudgetMod_Line_ID == 0)
        {
			setC_BudgetMod_Line_ID (0);
			setMovementTye (null);
// R
			setValue (null);
        } */
    ...
    /** Load Constructor */
    public X_C_BudgetMod_Line (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_BudgetMod_Line[")
	...
	{
		if (C_BudgetMod_ID < 1) 
			set_Value (COLUMNNAME_C_BudgetMod_ID, null);
		else 
			set_Value (COLUMNNAME_C_BudgetMod_ID, Integer.valueOf(C_BudgetMod_ID));
	}
	...
	/** Set C_BudgetMod_Line.
		@param C_BudgetMod_Line_ID C_BudgetMod_Line	  */
	public void setC_BudgetMod_Line_ID (int C_BudgetMod_Line_ID)
	{
		if (C_BudgetMod_Line_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_BudgetMod_Line_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_BudgetMod_Line_ID, Integer.valueOf(C_BudgetMod_Line_ID));
	}

	/** Get C_BudgetMod_Line.
		@return C_BudgetMod_Line	  */
	public int getC_BudgetMod_Line_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_BudgetMod_Line_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
