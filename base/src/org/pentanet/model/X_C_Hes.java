...
/** Generated Model for C_Hes
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0.1LTS (VE) - $Id$ */
public class X_C_Hes extends PO implements I_C_Hes, I_Persistent 
{
    ...
    public X_C_Hes (Properties ctx, int C_Hes_ID, String trxName)
    {
...
// 1000094
    ...
    /** Load Constructor */
    public X_C_Hes (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_Hes[")
	...
	{
		if (C_Hes_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_Hes_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_Hes_ID, Integer.valueOf(C_Hes_ID));
	}
	...
	{
		set_Value (COLUMNNAME_Requested, Requested);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_Requested);
	}
