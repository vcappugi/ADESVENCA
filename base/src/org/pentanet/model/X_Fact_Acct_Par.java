...
/** Generated Model for Fact_Acct_Par
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0.1LTS (VE) - $Id$ */
public class X_Fact_Acct_Par extends PO implements I_Fact_Acct_Par, I_Persistent 
{
    ...
    public X_Fact_Acct_Par (Properties ctx, int Fact_Acct_Par_ID, String trxName)
    {
      super (ctx, Fact_Acct_Par_ID, trxName);
      /** if (Fact_Acct_Par_ID == 0)
        {
			setAccount_ID (0);
			setAD_Table_ID (0);
    ...
    /** Load Constructor */
    public X_Fact_Acct_Par (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Fact_Acct_Par[")
	...
	/** Set Fact_Acct_Par.
		@param Fact_Acct_Par_ID Fact_Acct_Par	  */
	public void setFact_Acct_Par_ID (int Fact_Acct_Par_ID)
	{
		if (Fact_Acct_Par_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Fact_Acct_Par_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Fact_Acct_Par_ID, Integer.valueOf(Fact_Acct_Par_ID));
	}

	/** Get Fact_Acct_Par.
		@return Fact_Acct_Par	  */
	public int getFact_Acct_Par_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Fact_Acct_Par_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
    ...
    {
        return new KeyNamePair(get_ID(), String.valueOf(getFact_Acct_Par_ID()));
    }
