 ...
 */
public class MButton extends JButton implements CEditor {
	/**
	 * 
	 */
	private static final long serialVersionUID = 70278798402299341L;
	private int Valor_CampoID =0;
	 ...
	 */
//	public void  MCButton(Icon icon) {
//		this(null, icon);
//	} // CButton
	...
	public void SetValor_CampoID(int el_valor)
	{
		Valor_CampoID=el_valor;
	}

	public int GetValor_CampoID()
	{
		return Valor_CampoID;
	}
	
	public void SetNombreCampoID(String el_valor)
	{
		this.NombreCampoID = el_valor;
	}
	...
	public void SetAD_Window_ID(int el_valor)
	{
		AD_Window_ID=el_valor;
	}
	...
	public void SetAD_Table_ID(int el_valor)
	{
		this.AD_Table_ID=el_valor;
	}
