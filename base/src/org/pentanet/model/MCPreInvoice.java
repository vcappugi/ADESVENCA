...
public class MCPreInvoice extends X_C_PreInvoice implements DocAction, DocOptions{

private String m_processMsg;
	
	
	public MCPreInvoice (Properties ctx, int C_PreInvoice_ID, String trxName)
	{
		super (ctx, C_PreInvoice_ID, trxName);
		//  New
		if (C_PreInvoice_ID == 0)
		{
	 ...
	 *	@param rs result set
	 */
	public MCPreInvoice (Properties ctx, ResultSet rs, String trxName)
	{
	...
	protected boolean beforeDelete() {
		...
		String valida =  DB.getSQLValueString(null,"SELECT DocStatus FROM C_PreInvoice WHERE C_PreInvoice_ID=" + getC_PreInvoice_ID());
	...
	public void setProcessed (boolean processed)
	{
		...
		int noLine = DB.executeUpdate("UPDATE C_PreInvoiceLine " + set, get_TrxName());
