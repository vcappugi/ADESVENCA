...
/** Generated Model for C_PreInvoiceG
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0.1LTS (VE) - $Id$ */
public class X_C_PreInvoiceG extends PO implements I_C_PreInvoiceG, I_Persistent 
{
    ...
    public X_C_PreInvoiceG (Properties ctx, int C_PreInvoiceG_ID, String trxName)
    {
...
// @#Date@
    ...
    /** Load Constructor */
    public X_C_PreInvoiceG (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_PreInvoiceG[")
	...
	public void setC_PreInvoiceG_ID (int C_PreInvoiceG_ID)
	{
		if (C_PreInvoiceG_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_PreInvoiceG_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_PreInvoiceG_ID, Integer.valueOf(C_PreInvoiceG_ID));
	}
	...
	/** Set GenerateHes.
		@param GenerateHes GenerateHes	  */
	public void setGenerateHes (String GenerateHes)
	{
		set_Value (COLUMNNAME_GenerateHes, GenerateHes);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_GenerateHes);
	}
