...
/** Generated Model for C_PreInvoiceLineG
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0.1LTS (VE) - $Id$ */
public class X_C_PreInvoiceLineG extends PO implements I_C_PreInvoiceLineG, I_Persistent 
{
    ...
    public X_C_PreInvoiceLineG (Properties ctx, int C_PreInvoiceLineG_ID, String trxName)
    {
      super (ctx, C_PreInvoiceLineG_ID, trxName);
      /** if (C_PreInvoiceLineG_ID == 0)
        {
			setC_Charge_ID (0);
			setC_ContractLine_ID (0);
			setC_PreInvoiceG_ID (0);
			setC_PreInvoiceLineG_ID (0);
    ...
    /** Load Constructor */
    public X_C_PreInvoiceLineG (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_PreInvoiceLineG[")
	...
	public void setC_PreInvoiceLineG_ID (int C_PreInvoiceLineG_ID)
	{
		if (C_PreInvoiceLineG_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_PreInvoiceLineG_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_PreInvoiceLineG_ID, Integer.valueOf(C_PreInvoiceLineG_ID));
	}
	...
	/** Set QtyHes_Usd.
		@param QtyHes_Usd QtyHes_Usd	  */
	public void setQtyHes_Usd (BigDecimal QtyHes_Usd)
	{
		set_Value (COLUMNNAME_QtyHes_Usd, QtyHes_Usd);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_QtyHes_Usd);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set QtyHes_Veb.
		@param QtyHes_Veb QtyHes_Veb	  */
	public void setQtyHes_Veb (BigDecimal QtyHes_Veb)
	{
		set_Value (COLUMNNAME_QtyHes_Veb, QtyHes_Veb);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_QtyHes_Veb);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
