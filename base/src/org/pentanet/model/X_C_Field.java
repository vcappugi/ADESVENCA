...
/** Generated Model for C_Field
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0.1LTS (VE) - $Id$ */
public class X_C_Field extends PO implements I_C_Field, I_Persistent 
{
    ...
    public X_C_Field (Properties ctx, int C_Field_ID, String trxName)
    {
      super (ctx, C_Field_ID, trxName);
      /** if (C_Field_ID == 0)
        {
			setC_Field_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_C_Field (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_Field[")
	...
	{
		if (C_Field_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_Field_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_Field_ID, Integer.valueOf(C_Field_ID));
	}
