...
/** Generated Model for HR_Rotation
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS (VE) - $Id$ */
public class X_HR_Rotation extends PO implements I_HR_Rotation, I_Persistent 
{
    ...
    public X_HR_Rotation (Properties ctx, int HR_Rotation_ID, String trxName)
    {
      super (ctx, HR_Rotation_ID, trxName);
      /** if (HR_Rotation_ID == 0)
        {
			setHR_Rotation_ID (0);
			setName (null);
    ...
    /** Load Constructor */
    public X_HR_Rotation (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_HR_Rotation[")
