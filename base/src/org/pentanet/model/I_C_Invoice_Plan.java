...
/** Generated Interface for C_Invoice_Plan
 *  @author Adempiere (generated) 
 *  @version Release 3.7.0LTS (VE)
 */
public interface I_C_Invoice_Plan 
{

    /** TableName=C_Invoice_Plan */
    public static final String Table_Name = "C_Invoice_Plan";
    ...
    /** Column name C_Invoice_Plan_ID */
    public static final String COLUMNNAME_C_Invoice_Plan_ID = "C_Invoice_Plan_ID";

	/** Set C_Invoice_Plan	  */
	public void setC_Invoice_Plan_ID (int C_Invoice_Plan_ID);

	/** Get C_Invoice_Plan	  */
	public int getC_Invoice_Plan_ID();
