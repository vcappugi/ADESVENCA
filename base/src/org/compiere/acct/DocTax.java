...
public final class DocTax
{
	...
	public DocTax (int C_Tax_ID, String name, BigDecimal rate, 
		BigDecimal taxBaseAmt, BigDecimal amount, boolean salesTax, boolean CurrencyScheme)
	{
		m_C_Tax_ID = C_Tax_ID;
		m_name = name;
		m_rate = rate;
		m_amount = amount;
		m_salesTax = salesTax;
		m_CurrencyScheme = CurrencyScheme;
	}	//	DocTax
	...
	/** Currency Scheme		*/
	private boolean		m_CurrencyScheme = false;
	/** Activity        	 */
	...
	/**
	 * 	Is Currency Scheme
	 *	@return Currency Scheme
	 */
	public boolean isCurrencyScheme()
	{
		return m_CurrencyScheme;
	}	//	isCurrencyScheme
