 ...
 *
 * 	PreInvoice		PIN
 *		C_PreInvoice	1000295 - DocType fixed
 *	
 * 	C_WorkDD		WDD
 *		C_WorkDD	1000306 - DocType fixed
 *
 *  </pre>
 *  @author Jorg Janke
...
public abstract class Doc
{
	...
	/** Preinvoice   */
	public static final String	DOCBASETYPE_PreInvoice = "PIN";
	/** WorkDD   */
	public static final String	DOCBASETYPE_WorkDD = "WDD";
	...
	/** GL Accounts - Commitment Offset	Sales */
	public static final int     ACCTTYPE_V_EmployeeCxC = 113;
	...
	public int getValidCombination_ID (int AcctType, MAcctSchema as)
	{
		...
		//CxC Cuentas por cobrar empleados
		else if (AcctType == ACCTTYPE_V_EmployeeCxC)
		{
			sql = "SELECT V_EmployeeCxC_Acct FROM C_BP_Group_Acct WHERE C_BP_Group_ID IN "
					+ "(SELECT C_BP_Group_ID FROM C_BPartner WHERE C_BPartner_ID = ?) AND C_AcctSchema_ID=?";
			para_1 = getC_BPartner_ID();
