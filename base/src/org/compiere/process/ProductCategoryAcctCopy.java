...
public class ProductCategoryAcctCopy extends SvrProcess
{
	...
	protected String doIt () throws Exception
	{
		...
		String sql = "UPDATE M_Product_Acct pa "
			...
			+ " P_MixVariance_Acct,P_Labor_Acct,P_Burden_Acct,P_CostOfProduction_Acct,P_OutsideProcessing_Acct,P_Overhead_Acct,P_Scrap_Acct, P_Order_Invt_Acct, P_Order_InvtPC_Acct, LCO_Product_CIIU_ID,P_Expense2_Acct)="
		...
		sql = "INSERT INTO M_Product_Acct "
			...
			+ " P_TradeDiscountRec_Acct, P_TradeDiscountGrant_Acct, "
			+ " P_WIP_Acct,P_FloorStock_Acct, P_MethodChangeVariance_Acct, P_UsageVariance_Acct, P_RateVariance_Acct," 
			+ " P_MixVariance_Acct, P_Labor_Acct, P_Burden_Acct, P_CostOfProduction_Acct, P_OutsideProcessing_Acct, P_Overhead_Acct, P_Scrap_Acct, P_Expense2_Acct) "
			...
			+ " acct.P_MixVariance_Acct, acct.P_Labor_Acct, acct.P_Burden_Acct, acct.P_CostOfProduction_Acct, acct.P_OutsideProcessing_Acct, acct.P_Overhead_Acct, acct.P_Scrap_Acct, P_Expense2_Acct "
			+ "FROM M_Product p"
