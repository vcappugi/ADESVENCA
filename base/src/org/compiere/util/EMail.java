...
public final class EMail implements Serializable
{
	...
	public String send ()
	{
		...
		//	m_msg = new MimeMessage(session);
			...
			//para solicitar acuse de recibo
			if(m_receipt!=null)
			{
				m_msg.setHeader("Disposition-Notification-To", m_receipt);
			}
	...
	{
		m_subject = subject;
		StringBuffer sb = new StringBuffer("<HTML lang=\"es\">\n")
			.append("<HEAD><meta charset=\"UNICODE\" />\n")
			.append("<TITLE>\n")
			.append(subject + "\n")
			.append("</TITLE>\n")
			.append("</HEAD>\n");
		sb.append("<BODY><meta charset=\"UNICODE\" />\n")
	...
	{
		//	Local Character Set
		String charSetName = null; //Ini.getCharset().name();
