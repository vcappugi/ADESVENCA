...
// 1
	...
	public org.compiere.model.I_C_BPartner getC_BPartner_Med() throws RuntimeException
    {
		return (org.compiere.model.I_C_BPartner)MTable.get(getCtx(), org.compiere.model.I_C_BPartner.Table_Name)
			.getPO(getC_BPartner_Med_ID(), get_TrxName());	}

	/** Set C_BPartner_Med_ID.
		@param C_BPartner_Med_ID C_BPartner_Med_ID	  */
	public void setC_BPartner_Med_ID (int C_BPartner_Med_ID)
	{
		if (C_BPartner_Med_ID < 1) 
			set_Value (COLUMNNAME_C_BPartner_Med_ID, null);
		else 
			set_Value (COLUMNNAME_C_BPartner_Med_ID, Integer.valueOf(C_BPartner_Med_ID));
	}

	/** Get C_BPartner_Med_ID.
		@return C_BPartner_Med_ID	  */
	public int getC_BPartner_Med_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_BPartner_Med_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
