...
public interface I_M_RequisitionLine 
{
    ...
    /** Column name C_UOM_TRANSP_ID */
    public static final String COLUMNNAME_C_UOM_TRANSP_ID = "C_UOM_TRANSP_ID";
    ...
    /** Column name hour_qty */
    public static final String COLUMNNAME_hour_qty = "hour_qty";
    ...
    /** Column name IsReady */
    public static final String COLUMNNAME_IsReady = "IsReady";
    ...
    /** Column name IsRecLib */
    public static final String COLUMNNAME_IsRecLib = "IsRecLib";
    ...
    /** Column name Product_Tarnsp */
    public static final String COLUMNNAME_Product_Tarnsp = "Product_Tarnsp";
    ...
    /** Column name Qty_transp */
    public static final String COLUMNNAME_Qty_transp = "Qty_transp";
	...
	public int getUpdatedBy();
	   ...
	   public static final String COLUMNNAME_H_Request_ID = "H_Request_ID";
		...
		/** Set C_Manage_Unit_ID	  */
		public void setC_Manage_Unit_ID (int C_Manage_Unit_ID);

		/** Get C_Manage_Unit_ID	  */
		public int getC_Manage_Unit_ID();
		
		/** Column name C_ElementValuet_ID */
	    public static final String COLUMNNAME_C_ElementValuet_ID = "C_ElementValuet_ID";
		
		/** Set C_ElementValuet_ID	  */
