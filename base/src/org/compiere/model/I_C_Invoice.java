...
public interface I_C_Invoice 
{
    ...
    /** Column name afected_invoice */
    public static final String COLUMNNAME_afected_invoice = "afected_invoice";

	/** Set afected_invoice	  */
	public void setafected_invoice (String afected_invoice);

	/** Get afected_invoice	  */
	public String getafected_invoice();

    /** Column name BaseTax */
    public static final String COLUMNNAME_BaseTax = "BaseTax";
    ...
    /** Column name Close_Dist */
    public static final String COLUMNNAME_Close_Dist = "Close_Dist";
    ...
    /** Column name exped_imp */
    public static final String COLUMNNAME_exped_imp = "exped_imp";

	/** Set exped_imp	  */
	public void setexped_imp (String exped_imp);

	/** Get exped_imp	  */
	public String getexped_imp();

    /** Column name Ext_Amount */
    public static final String COLUMNNAME_Ext_Amount = "Ext_Amount";

	/** Set Ext_Amount	  */
	public void setExt_Amount (BigDecimal Ext_Amount);

	/** Get Ext_Amount	  */
	public BigDecimal getExt_Amount();
    ...
    /** Column name GenerateIVA_Tercero */
    public static final String COLUMNNAME_GenerateIVA_Tercero = "GenerateIVA_Tercero";

	/** Set GenerateIVA_Tercero	  */
	public void setGenerateIVA_Tercero (String GenerateIVA_Tercero);

	/** Get GenerateIVA_Tercero	  */
	public String getGenerateIVA_Tercero();
    ...
    /** Column name G_Num_C */
    public static final String COLUMNNAME_G_Num_C = "G_Num_C";

	/** Set G_Num_C	  */
	public void setG_Num_C (String G_Num_C);

	/** Get G_Num_C	  */
	public String getG_Num_C();
    ...
    /** Column name IsCadivi */
    public static final String COLUMNNAME_IsCadivi = "IsCadivi";
    ...
    /** Column name IsPayDirect */
    public static final String COLUMNNAME_IsPayDirect = "IsPayDirect";

	/** Set IsPayDirect	  */
	public void setIsPayDirect (boolean IsPayDirect);
    ...
    /** Column name IVA_Tercero */
    public static final String COLUMNNAME_IVA_Tercero = "IVA_Tercero";

	/** Set IVA_Tercero	  */
	public void setIVA_Tercero (boolean IVA_Tercero);

	/** Get IVA_Tercero	  */
	public boolean isIVA_Tercero();

    /** Column name M_Percent */
    public static final String COLUMNNAME_M_Percent = "M_Percent";
    ...
    /** Column name num_impres */
    public static final String COLUMNNAME_num_impres = "num_impres";

	/** Set num_impres	  */
	public void setnum_impres (String num_impres);

	/** Get num_impres	  */
	public String getnum_impres();

    /** Column name num_prefact */
    public static final String COLUMNNAME_num_prefact = "num_prefact";

	/** Set num_prefact	  */
	public void setnum_prefact (String num_prefact);

	/** Get num_prefact	  */
	public String getnum_prefact();
    ...
    /** Column name planilla_imp */
    public static final String COLUMNNAME_planilla_imp = "planilla_imp";

	/** Set planilla_imp	  */
	public void setplanilla_imp (String planilla_imp);

	/** Get planilla_imp	  */
	public String getplanilla_imp();
    ...
    /** Column name Proc_Rel */
    public static final String COLUMNNAME_Proc_Rel = "Proc_Rel";

	/** Set Proc_Rel	  */
	public void setProc_Rel (String Proc_Rel);

	/** Get Proc_Rel	  */
	public String getProc_Rel();
    ...
    /** Column name rep_lcompras */
    public static final String COLUMNNAME_rep_lcompras = "rep_lcompras";

	/** Set rep_lcompras	  */
	public void setrep_lcompras (boolean rep_lcompras);

	/** Get rep_lcompras	  */
	public boolean isrep_lcompras();
    ...
    /** Column name Sheet_In */
    public static final String COLUMNNAME_Sheet_In = "Sheet_In";

	/** Set Sheet_In	  */
	public void setSheet_In (String Sheet_In);

	/** Get Sheet_In	  */
	public String getSheet_In();

    /** Column name Total_Invoice */
    public static final String COLUMNNAME_Total_Invoice = "Total_Invoice";
    ...
    public static final String COLUMNNAME_TotalTax = "TotalTax";
    ...
    /** Column name Undo_Invoice */
    public static final String COLUMNNAME_Undo_Invoice = "Undo_Invoice";

	/** Set Undo_Invoice	  */
	public void setUndo_Invoice (String Undo_Invoice);

	/** Get Undo_Invoice	  */
	public String getUndo_Invoice();
	...
	/** Set DateRev	  */
	public void setDateRev (Timestamp DateRev);

	/** Get DateRev	  */
	public Timestamp getDateRev();

	/** Set DateAprob	  */
	public void setDateAprob (Timestamp DateAprob);

	/** Get DateAprob	  */
	public Timestamp getDateAprob();
	
    /** Column name DateRev */
    public static final String COLUMNNAME_DateRev = "DateRev";
    
    /** Column name DateAprob */
    public static final String COLUMNNAME_DateAprob = "DateAprob";
