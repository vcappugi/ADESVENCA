...
public class ProductCost
{
	...
	/** Product Expense Aditional Acct    (No Purchase Order)*/
	public static final int ACCTTYPE_P_Expense2      = 24;
	...
	public MAccount getAccount(int AcctType, MAcctSchema as)
	{
		...
		String sql = "SELECT P_Revenue_Acct, P_Expense_Acct, P_Asset_Acct, P_Cogs_Acct, "	//	1..4
			...
			+ "P_Overhead_Acct,P_Scrap_Acct,P_AverageCostVariance_Acct, P_Expense2_Acct "	//  21,23, 24
			+ "FROM M_Product_Acct "
