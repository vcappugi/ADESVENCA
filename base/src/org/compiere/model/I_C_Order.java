...
public interface I_C_Order 
{
    ...
    /** Column name Amount_Coverage */
    public static final String COLUMNNAME_Amount_Coverage = "Amount_Coverage";
    ...
    /** Column name Aprob */
    public static final String COLUMNNAME_Aprob = "Aprob";
    ...
    /** Column name C_ORder */
    public static final String COLUMNNAME_C_ORder = "C_ORder";
    ...
    /** Column name C_PaymentTerm2_ID */
    public static final String COLUMNNAME_C_PaymentTerm2_ID = "C_PaymentTerm2_ID";
    ...
    /** Column name Create_Invoice */
    public static final String COLUMNNAME_Create_Invoice = "Create_Invoice";
    ...
    /** Column name DateReverse */
    public static final String COLUMNNAME_DateReverse = "DateReverse";
    ...
    public static final String COLUMNNAME_Driver_Data = "Driver_Data";
    ...
    /** Column name Guia_No */
    public static final String COLUMNNAME_Guia_No = "Guia_No";
    ...
    /** Column name isMultipleBP */
    public static final String COLUMNNAME_isMultipleBP = "isMultipleBP";
    ...
    /** Column name PreInvoiceNo */
    public static final String COLUMNNAME_PreInvoiceNo = "PreInvoiceNo";
    ...
    public static final String COLUMNNAME_quotation_number = "quotation_number";
    ...
    /** Column name Undo_Orders */
    public static final String COLUMNNAME_Undo_Orders = "Undo_Orders";
