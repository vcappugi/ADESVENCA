...
// 5
	...
	/** Set C_InOut.
		@param C_InOut C_InOut	  */
	public void setC_InOut (String C_InOut)
	{
		set_Value (COLUMNNAME_C_InOut, C_InOut);
	}

	/** Get C_InOut.
		@return C_InOut	  */
	public String getC_InOut () 
	{
		return (String)get_Value(COLUMNNAME_C_InOut);
	}
	...
	/** Set Create_From_POD.
		@param Create_From_POD Create_From_POD	  */
	public void setCreate_From_POD (String Create_From_POD)
	{
		set_Value (COLUMNNAME_Create_From_POD, Create_From_POD);
	}

	/** Get Create_From_POD.
		@return Create_From_POD	  */
	public String getCreate_From_POD () 
	{
		return (String)get_Value(COLUMNNAME_Create_From_POD);
	}
	...
	/** Set Generate_Lab_Test.
		@param Generate_Lab_Test Generate_Lab_Test	  */
	public void setGenerate_Lab_Test (String Generate_Lab_Test)
	{
		set_Value (COLUMNNAME_Generate_Lab_Test, Generate_Lab_Test);
	}

	/** Get Generate_Lab_Test.
		@return Generate_Lab_Test	  */
	public String getGenerate_Lab_Test () 
	{
		return (String)get_Value(COLUMNNAME_Generate_Lab_Test);
	}
