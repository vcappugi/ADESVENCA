...
// S
	...
	{
		set_Value (COLUMNNAME_Beneficiario, Beneficiario);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_Beneficiario);
	}
	...
	/** Set Conv_PayAmt.
		@param Conv_PayAmt Conv_PayAmt	  */
	public void setConv_PayAmt (BigDecimal Conv_PayAmt)
	{
		throw new IllegalArgumentException ("Conv_PayAmt is virtual column");	}

	/** Get Conv_PayAmt.
		@return Conv_PayAmt	  */
	public BigDecimal getConv_PayAmt () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_Conv_PayAmt);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	public void setC_Payment_Plan_ID (int C_Payment_Plan_ID)
	{
		if (C_Payment_Plan_ID < 1) 
			set_Value (COLUMNNAME_C_Payment_Plan_ID, null);
		else 
			set_Value (COLUMNNAME_C_Payment_Plan_ID, Integer.valueOf(C_Payment_Plan_ID));
	}
	...
	/** Set DateAdvice.
		@param DateAdvice DateAdvice	  */
	public void setDateAdvice (Timestamp DateAdvice)
	{
		set_Value (COLUMNNAME_DateAdvice, DateAdvice);
	}

	/** Get DateAdvice.
		@return DateAdvice	  */
	public Timestamp getDateAdvice () 
	{
		return (Timestamp)get_Value(COLUMNNAME_DateAdvice);
	}
	...
	/** Set Generate_Comprobant.
		@param Generate_Comprobant Generate_Comprobant	  */
	public void setGenerate_Comprobant (String Generate_Comprobant)
	{
		set_Value (COLUMNNAME_Generate_Comprobant, Generate_Comprobant);
	}

	/** Get Generate_Comprobant.
		@return Generate_Comprobant	  */
	public String getGenerate_Comprobant () 
	{
		return (String)get_Value(COLUMNNAME_Generate_Comprobant);
	}

	/** Set Generate_Comprobant2.
		@param Generate_Comprobant2 Generate_Comprobant2	  */
	public void setGenerate_Comprobant2 (String Generate_Comprobant2)
	{
		set_Value (COLUMNNAME_Generate_Comprobant2, Generate_Comprobant2);
	}

	/** Get Generate_Comprobant2.
		@return Generate_Comprobant2	  */
	public String getGenerate_Comprobant2 () 
	{
		return (String)get_Value(COLUMNNAME_Generate_Comprobant2);
	}

	/** Set Generate_Comprobant_CXC.
		@param Generate_Comprobant_CXC Generate_Comprobant_CXC	  */
	public void setGenerate_Comprobant_CXC (String Generate_Comprobant_CXC)
	{
		set_Value (COLUMNNAME_Generate_Comprobant_CXC, Generate_Comprobant_CXC);
	}

	/** Get Generate_Comprobant_CXC.
		@return Generate_Comprobant_CXC	  */
	public String getGenerate_Comprobant_CXC () 
	{
		return (String)get_Value(COLUMNNAME_Generate_Comprobant_CXC);
	}
	...
	/** Set IsCadivi.
		@param IsCadivi IsCadivi	  */
	public void setIsCadivi (boolean IsCadivi)
	{
		set_Value (COLUMNNAME_IsCadivi, Boolean.valueOf(IsCadivi));
	}

	/** Get IsCadivi.
		@return IsCadivi	  */
	public boolean isCadivi () 
	{
		Object oo = get_Value(COLUMNNAME_IsCadivi);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	{
		set_Value (COLUMNNAME_IsChk, Boolean.valueOf(IsChk));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsChk);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set IsTaxIVA.
		@param IsTaxIVA IsTaxIVA	  */
	public void setIsTaxIVA (boolean IsTaxIVA)
	{
		set_Value (COLUMNNAME_IsTaxIVA, Boolean.valueOf(IsTaxIVA));
	}

	/** Get IsTaxIVA.
		@return IsTaxIVA	  */
	public boolean isTaxIVA () 
	{
		Object oo = get_Value(COLUMNNAME_IsTaxIVA);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	{
		set_Value (COLUMNNAME_IsTxt, Boolean.valueOf(IsTxt));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsTxt);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set ModDoc_Pago.
		@param ModDoc_Pago ModDoc_Pago	  */
	public void setModDoc_Pago (String ModDoc_Pago)
	{
		set_Value (COLUMNNAME_ModDoc_Pago, ModDoc_Pago);
	}

	/** Get ModDoc_Pago.
		@return ModDoc_Pago	  */
	public String getModDoc_Pago () 
	{
		return (String)get_Value(COLUMNNAME_ModDoc_Pago);
	}
	...
	{
		set_Value (COLUMNNAME_PaymentAdvice, PaymentAdvice);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_PaymentAdvice);
	}
	...
	/** Source AD_Reference_ID=1000201 */
	public static final int SOURCE_AD_Reference_ID=1000201;
	/** CREDITO = C */
	public static final String SOURCE_CREDITO = "C";
	/** PDVSA = P */
	public static final String SOURCE_PDVSA = "P";
	/** Set Source.
		@param Source Source	  */
	...
	/** Set Undo_Payment.
		@param Undo_Payment Undo_Payment	  */
	public void setUndo_Payment (String Undo_Payment)
	{
		set_Value (COLUMNNAME_Undo_Payment, Undo_Payment);
	}

	/** Get Undo_Payment.
		@return Undo_Payment	  */
	public String getUndo_Payment () 
	{
		return (String)get_Value(COLUMNNAME_Undo_Payment);
	}
	...
	/** Set Purchase_Plain_Line.
	@param Purchase_Plain_Line 
	Purchase_Plain_Line
  */
	...
	/** Get Purchase_Plain_Line.
		@return Purchase_Plain_Line
	  */
	...
	public void setC_Manage_Unit_ID(int C_Manage_Unit_ID) {
		set_Value (COLUMNNAME_C_Manage_Unit_ID, C_Manage_Unit_ID);
	...
	public void setC_BudgetPublic_ID(int C_BudgetPublic_ID) {
		set_Value (COLUMNNAME_C_BudgetPublic_ID, C_BudgetPublic_ID);
