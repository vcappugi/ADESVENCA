...
// N
	...
	/** Crite_Cod AD_Reference_ID=1000162 */
	public static final int CRITE_COD_AD_Reference_ID=1000162;
	/** Sustitucion de Material con el mismo Costo = S */
	public static final String CRITE_COD_SustitucionDeMaterialConElMismoCosto = "S";
	/** No Aplica = N */
	public static final String CRITE_COD_NoAplica = "N";
	/** Set Crite_Cod.
		@param Crite_Cod Crite_Cod	  */
	public void setCrite_Cod (String Crite_Cod)
	{

		set_Value (COLUMNNAME_Crite_Cod, Crite_Cod);
	}

	/** Get Crite_Cod.
		@return Crite_Cod	  */
	public String getCrite_Cod () 
	{
		return (String)get_Value(COLUMNNAME_Crite_Cod);
	}
	...
	/** Admision = ADM */
	public static final String DOCBASETYPE_Admision = "ADM";
	/** VacationR = VRQ */
	public static final String DOCBASETYPE_VacationR = "VRQ";
	/** AgeBenefitsAdv = ABA */
	public static final String DOCBASETYPE_AgeBenefitsAdv = "ABA";
	/** VacBonusAdv = VBA */
	public static final String DOCBASETYPE_VacBonusAdv = "VBA";
	/** WorkPermit = WPE */
	public static final String DOCBASETYPE_WorkPermit = "WPE";
	/** JourneyManagement = JMA */
	public static final String DOCBASETYPE_JourneyManagement = "JMA";
	/** AdvanceR = ADR */
	public static final String DOCBASETYPE_AdvanceR = "ADR";
	...
	/** GenerateWithholding AD_Reference_ID=1000008 */
	public static final int GENERATEWITHHOLDING_AD_Reference_ID=1000008;
	/** Yes = Y */
	...
	/** Set IsFactAcct.
		@param IsFactAcct IsFactAcct	  */
	public void setIsFactAcct (boolean IsFactAcct)
	{
		set_Value (COLUMNNAME_IsFactAcct, Boolean.valueOf(IsFactAcct));
	}

	/** Get IsFactAcct.
		@return IsFactAcct	  */
	public boolean isFactAcct () 
	{
		Object oo = get_Value(COLUMNNAME_IsFactAcct);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set IsSMenssage.
		@param IsSMenssage IsSMenssage	  */
	public void setIsSMenssage (boolean IsSMenssage)
	{
		set_Value (COLUMNNAME_IsSMenssage, Boolean.valueOf(IsSMenssage));
	}

	/** Get IsSMenssage.
		@return IsSMenssage	  */
	public boolean isSMenssage () 
	{
		Object oo = get_Value(COLUMNNAME_IsSMenssage);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
