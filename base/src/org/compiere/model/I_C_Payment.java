...
public interface I_C_Payment 
{
    ...
    public static final String COLUMNNAME_Beneficiario = "Beneficiario";
    ...
    /** Column name Conv_PayAmt */
    public static final String COLUMNNAME_Conv_PayAmt = "Conv_PayAmt";
    ...
    /** Column name C_Payment_Plan_ID */
    public static final String COLUMNNAME_C_Payment_Plan_ID = "C_Payment_Plan_ID";
    ...
    public static final String COLUMNNAME_DateAdvice = "DateAdvice";
    ...
    /** Column name Generate_Comprobant */
    public static final String COLUMNNAME_Generate_Comprobant = "Generate_Comprobant";
    ...
    /** Column name Generate_Comprobant2 */
    public static final String COLUMNNAME_Generate_Comprobant2 = "Generate_Comprobant2";
    ...
    /** Column name Generate_Comprobant_CXC */
    public static final String COLUMNNAME_Generate_Comprobant_CXC = "Generate_Comprobant_CXC";
    ...
    /** Column name IsChk */
    public static final String COLUMNNAME_IsChk = "IsChk";
    ...
    /** Column name IsTaxIVA */
    public static final String COLUMNNAME_IsTaxIVA = "IsTaxIVA";
    ...
    /** Column name IsTxt */
    public static final String COLUMNNAME_IsTxt = "IsTxt";
    ...
    /** Column name ModDoc_Pago */
    public static final String COLUMNNAME_ModDoc_Pago = "ModDoc_Pago";
    ...
    /** Column name PaymentAdvice */
    public static final String COLUMNNAME_PaymentAdvice = "PaymentAdvice";
    ...
    /** Column name Undo_Payment */
    public static final String COLUMNNAME_Undo_Payment = "Undo_Payment";
