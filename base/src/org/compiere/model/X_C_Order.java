...
// 5
	...
	/** Set Amount_Coverage.
		@param Amount_Coverage Amount_Coverage	  */
	public void setAmount_Coverage (BigDecimal Amount_Coverage)
	{
		set_Value (COLUMNNAME_Amount_Coverage, Amount_Coverage);
	}

	/** Get Amount_Coverage.
		@return Amount_Coverage	  */
	public BigDecimal getAmount_Coverage () 
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_Amount_Coverage);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Aprob AD_Reference_ID=319 */
	public static final int APROB_AD_Reference_ID=319;
	/** Yes = Y */
	public static final String APROB_Yes = "Y";
	/** No = N */
	public static final String APROB_No = "N";
	/** Set Aprob.
		@param Aprob Aprob	  */
	public void setAprob (String Aprob)
	{

		set_Value (COLUMNNAME_Aprob, Aprob);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_Aprob);
	}
	...
	public void setC_JourneyManagement_ID (int C_JourneyManagement_ID)
	{
		if (C_JourneyManagement_ID < 1) 
			set_Value (COLUMNNAME_C_JourneyManagement_ID, null);
		else 
			set_Value (COLUMNNAME_C_JourneyManagement_ID, Integer.valueOf(C_JourneyManagement_ID));
	}
	...
	/** Set C_ORder.
		@param C_ORder C_ORder	  */
	public void setC_ORder (String C_ORder)
	{
		set_Value (COLUMNNAME_C_ORder, C_ORder);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_C_ORder);
	}
	...
	public org.compiere.model.I_C_PaymentTerm getC_PaymentTerm2() throws RuntimeException
    {
		return (org.compiere.model.I_C_PaymentTerm)MTable.get(getCtx(), org.compiere.model.I_C_PaymentTerm.Table_Name)
			.getPO(getC_PaymentTerm2_ID(), get_TrxName());	}

	/** Set C_PaymentTerm2_ID.
		@param C_PaymentTerm2_ID C_PaymentTerm2_ID	  */
	public void setC_PaymentTerm2_ID (int C_PaymentTerm2_ID)
	{
		if (C_PaymentTerm2_ID < 1) 
			set_Value (COLUMNNAME_C_PaymentTerm2_ID, null);
		else 
			set_Value (COLUMNNAME_C_PaymentTerm2_ID, Integer.valueOf(C_PaymentTerm2_ID));
	}

	/** Get C_PaymentTerm2_ID.
		@return C_PaymentTerm2_ID	  */
	public int getC_PaymentTerm2_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_PaymentTerm2_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Create_Invoice.
		@param Create_Invoice Create_Invoice	  */
	public void setCreate_Invoice (String Create_Invoice)
	{
		set_Value (COLUMNNAME_Create_Invoice, Create_Invoice);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_Create_Invoice);
	}
	...
	/** Set DateReverse.
		@param DateReverse DateReverse	  */
	public void setDateReverse (Timestamp DateReverse)
	{
		set_Value (COLUMNNAME_DateReverse, DateReverse);
	}

	/** Get DateReverse.
		@return DateReverse	  */
	public Timestamp getDateReverse () 
	{
		return (Timestamp)get_Value(COLUMNNAME_DateReverse);
	}
	...
	/** Set Driver_Data.
		@param Driver_Data Driver_Data	  */
	public void setDriver_Data (String Driver_Data)
	{
		set_Value (COLUMNNAME_Driver_Data, Driver_Data);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_Driver_Data);
	}
	...
	/** Set Guia_No.
		@param Guia_No Guia_No	  */
	public void setGuia_No (String Guia_No)
	{
		set_Value (COLUMNNAME_Guia_No, Guia_No);
	}

	/** Get Guia_No.
		@return Guia_No	  */
	public String getGuia_No () 
	{
		return (String)get_Value(COLUMNNAME_Guia_No);
	}
	...
	/** Set isMultipleBP.
		@param isMultipleBP isMultipleBP	  */
	public void setisMultipleBP (boolean isMultipleBP)
	{
		set_Value (COLUMNNAME_isMultipleBP, Boolean.valueOf(isMultipleBP));
	}

	/** Get isMultipleBP.
		@return isMultipleBP	  */
	public boolean isMultipleBP () 
	{
		Object oo = get_Value(COLUMNNAME_isMultipleBP);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set PreInvoiceNo.
		@param PreInvoiceNo PreInvoiceNo	  */
	public void setPreInvoiceNo (String PreInvoiceNo)
	{
		set_Value (COLUMNNAME_PreInvoiceNo, PreInvoiceNo);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_PreInvoiceNo);
	}
	...
	{
		set_Value (COLUMNNAME_quotation_number, quotation_number);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_quotation_number);
	}
	...
	/** Set Undo_Orders.
		@param Undo_Orders Undo_Orders	  */
	public void setUndo_Orders (String Undo_Orders)
	{
		set_Value (COLUMNNAME_Undo_Orders, Undo_Orders);
	}

	/** Get Undo_Orders.
		@return Undo_Orders	  */
	public String getUndo_Orders () 
	{
		return (String)get_Value(COLUMNNAME_Undo_Orders);
	}
