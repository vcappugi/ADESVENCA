...
// @#Date@
	...
	public org.compiere.model.I_C_Activity getA_ActivityTarget() throws RuntimeException
    {
		return (org.compiere.model.I_C_Activity)MTable.get(getCtx(), org.compiere.model.I_C_Activity.Table_Name)
			.getPO(getA_ActivityTarget_ID(), get_TrxName());	}

	/** Set A_ActivityTarget_ID.
		@param A_ActivityTarget_ID A_ActivityTarget_ID	  */
	public void setA_ActivityTarget_ID (int A_ActivityTarget_ID)
	{
		if (A_ActivityTarget_ID < 1) 
			set_Value (COLUMNNAME_A_ActivityTarget_ID, null);
		else 
			set_Value (COLUMNNAME_A_ActivityTarget_ID, Integer.valueOf(A_ActivityTarget_ID));
	}

	/** Get A_ActivityTarget_ID.
		@return A_ActivityTarget_ID	  */
	public int getA_ActivityTarget_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_A_ActivityTarget_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	{
		set_Value (COLUMNNAME_isVirtual, Boolean.valueOf(isVirtual));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_isVirtual);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	public org.compiere.model.I_M_Locator getM_LocatorToInd() throws RuntimeException
    {
		return (org.compiere.model.I_M_Locator)MTable.get(getCtx(), org.compiere.model.I_M_Locator.Table_Name)
			.getPO(getM_LocatorToInd_ID(), get_TrxName());	}

	/** Set M_LocatorToInd_ID.
		@param M_LocatorToInd_ID M_LocatorToInd_ID	  */
	public void setM_LocatorToInd_ID (int M_LocatorToInd_ID)
	{
		if (M_LocatorToInd_ID < 1) 
			set_Value (COLUMNNAME_M_LocatorToInd_ID, null);
		else 
			set_Value (COLUMNNAME_M_LocatorToInd_ID, Integer.valueOf(M_LocatorToInd_ID));
	}

	/** Get M_LocatorToInd_ID.
		@return M_LocatorToInd_ID	  */
	public int getM_LocatorToInd_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_M_LocatorToInd_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
