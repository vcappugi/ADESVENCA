...
public interface I_M_Production 
{
    ...
    /** Column name production_justifield */
    public static final String COLUMNNAME_production_justifield = "production_justifield";

	/** Set production_justifield	  */
	public void setproduction_justifield (String production_justifield);

	/** Get production_justifield	  */
	public String getproduction_justifield();

    /** Column name production_type */
    public static final String COLUMNNAME_production_type = "production_type";
    ...
    /** Column name request_uni */
    public static final String COLUMNNAME_request_uni = "request_uni";

	/** Set request_uni	  */
	public void setrequest_uni (String request_uni);

	/** Get request_uni	  */
	public String getrequest_uni();
