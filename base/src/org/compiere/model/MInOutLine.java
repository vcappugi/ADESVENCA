...
public class MInOutLine extends X_M_InOutLine
{
	...
	public void setOrderLine (MOrderLine oLine, int M_Locator_ID, BigDecimal Qty)
	{
		...
		setM_Product_Cost(oLine.getLineNetAmt());
	}	//	setOrderLine
	...
	public void setInvoiceLine (MInvoiceLine iLine, int M_Locator_ID, BigDecimal Qty)
	{
		...
		//Las lineas del recibo se hacen con la unidad 
	...
	public void setM_Product_ID (int M_Product_ID, boolean setUOM)
	{
		...
		setM_AttributeSetInstance_ID(0);
		//Aditionate Prodct_Cost to variable 
		BigDecimal costo;
		if (getC_OrderLine_ID()> 0) {
		   costo = DB.getSQLValueBD(get_TrxName(), "SELECT LineNetAmt FROM C_OrderLine WHERE C_OrderLine_ID=" + getC_OrderLine_ID() );				   
		}
		else
			costo = new BigDecimal(0); 
		setM_Product_Cost(costo);
		//End Aditionate
