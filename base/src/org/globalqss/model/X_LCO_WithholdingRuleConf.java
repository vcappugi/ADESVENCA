...
public class X_LCO_WithholdingRuleConf extends PO implements I_LCO_WithholdingRuleConf, I_Persistent 
{
	...
	/** Set IsProduct_CIIU.
		@param IsProduct_CIIU IsProduct_CIIU	  */
	public void setIsProduct_CIIU (boolean IsProduct_CIIU)
	{
		set_Value (COLUMNNAME_IsProduct_CIIU, Boolean.valueOf(IsProduct_CIIU));
	}

	/** Get IsProduct_CIIU.
		@return IsProduct_CIIU	  */
	public boolean isProduct_CIIU () 
	{
		Object oo = get_Value(COLUMNNAME_IsProduct_CIIU);
		if (oo != null) 
		{
	...
	/** Set IsUseMunicipality.
		@param IsUseMunicipality IsUseMunicipality	  */
	public void setIsUseMunicipality (boolean IsUseMunicipality)
	{
		set_Value (COLUMNNAME_IsUseMunicipality, Boolean.valueOf(IsUseMunicipality));
	}

	/** Get IsUseMunicipality.
		@return IsUseMunicipality	  */
	public boolean isUseMunicipality () 
	{
		Object oo = get_Value(COLUMNNAME_IsUseMunicipality);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	/** Set IsUseTaxIdType.
		@param IsUseTaxIdType IsUseTaxIdType	  */
	public void setIsUseTaxIdType (boolean IsUseTaxIdType)
	{
		set_Value (COLUMNNAME_IsUseTaxIdType, Boolean.valueOf(IsUseTaxIdType));
	}

	/** Get IsUseTaxIdType.
		@return IsUseTaxIdType	  */
	public boolean isUseTaxIdType () 
	{
		Object oo = get_Value(COLUMNNAME_IsUseTaxIdType);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
