...
public class X_LCO_WithholdingRule extends PO implements I_LCO_WithholdingRule, I_Persistent 
{
	...
	public org.globalqss.model.I_LCO_ISIC getLCO_Product_CIIU() throws RuntimeException
    {
		return (org.globalqss.model.I_LCO_ISIC)MTable.get(getCtx(), org.globalqss.model.I_LCO_ISIC.Table_Name)
			.getPO(getLCO_Product_CIIU_ID(), get_TrxName());	}

	/** Set LCO_Product_CIIU_ID.
		@param LCO_Product_CIIU_ID LCO_Product_CIIU_ID	  */
	public void setLCO_Product_CIIU_ID (int LCO_Product_CIIU_ID)
	{
		if (LCO_Product_CIIU_ID < 1) 
			set_Value (COLUMNNAME_LCO_Product_CIIU_ID, null);
		else 
			set_Value (COLUMNNAME_LCO_Product_CIIU_ID, Integer.valueOf(LCO_Product_CIIU_ID));
	}

	/** Get LCO_Product_CIIU_ID.
		@return LCO_Product_CIIU_ID	  */
	public int getLCO_Product_CIIU_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_LCO_Product_CIIU_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
