...
public class LCO_CalloutWithholding extends CalloutEngine
{
			...
			GridTab mTab, GridField mField, Object value, Object oldValue)
	{
		...
		//Colocar el monto gravable
		int invoice_id = (Integer) mTab.getValue(MLCOInvoiceWithholding.COLUMNNAME_C_Invoice_ID) ;
		MInvoice inv = new MInvoice(ctx, invoice_id , null);
        mTab.setValue(MLCOInvoiceWithholding.COLUMNNAME_TaxBaseAmt,inv.getTotalLines());
