...
package org.adempiere.appweb.apps;
...
import org.adempiere.appweb.theme.ThemeManager;
...
public final class AEnv
{
	...
	*/
	 ...
	 * 	Get Login Record_ID
	 *	@param ctx context
	 *	@return login Record_ID
	 */
	public static int getRecord_ID (Properties ctx)
	{
		return Env.getContextAsInt(ctx, "#Record_ID");
	}	//	getRecord_ID
	
	/**
	 * 	Get Login APPWEB_ID
	 *	@param ctx context
	 *	@return login Appweb_ID
	 */
	public static int getAppweb_ID (Properties ctx)
	{
		return Env.getContextAsInt(ctx, "#Appweb_ID");
	}	//	getAppweb_ID
	...
	/**
	 * 	Get Login AD_Table_ID
	 *	@param ctx context
	 *	@return login AD_Table_ID
	 */
	public static int getAD_Table_ID (Properties ctx)
	{
		return Env.getContextAsInt(ctx, "#AD_Table_ID");
	}	//	getAD_Table_ID
	
	public static int getAD_WF_Activity_ID (Properties ctx)
	{
		return Env.getContextAsInt(ctx, "#AD_WF_Activity_ID");
	}	//	getAppweb_ID
