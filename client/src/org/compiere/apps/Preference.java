	...
	implements ActionListener, ListSelectionListener
{
	...
	private CLabel ServerLabel = new CLabel(); // Denis 
	private CCheckBox ServerOFF = new CCheckBox();
	...
	void jbInit() throws Exception
	{
		...
		ServerLabel.setText("<<<PRECAUCION: Contabilizar si el Servidor NO es Disponible>>>");
		ServerLabel.setToolTipText(Msg.getMsg(Env.getCtx(), "Postear Inmediatamente", false));

		ServerOFF.setText(Msg.getMsg(Env.getCtx(), "Servidor OFF", true));
		ServerOFF.setToolTipText(Msg.getMsg(Env.getCtx(), "Servidor OFF", false));
		...
		CPanel tracePanel = new CPanel(); // Aqui Denis
		...
		CPanel ServerPanel = new CPanel();
		ServerPanel.setBorder(BorderFactory.createTitledBorder(Msg.getMsg(Env.getCtx(), "Servidor")));
		ServerPanel.setLayout(new GridBagLayout());
		ServerPanel.add(ServerLabel,    new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 0), 0, 0));
		ServerPanel.add(ServerOFF,       new GridBagConstraints(0, 1, 2, 1, 1.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 0), 0, 0));

		
		
		customizePane.add(ServerPanel, new GridBagConstraints(0, 4, 1, 1, 1.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(2, 0, 2, 0), 0, 0));
		...
		printPanel.add(printPreview,    new GridBagConstraints(0, 1, 2, 1, 1.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(2, 2, 2, 0), 0, 0));
		customizePane.add(printPanel, new GridBagConstraints(0, 5, 1, 1, 1.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(2, 0, 2, 0), 0, 0));
		...
		customizePane.add(otherPanel, new GridBagConstraints(0, 6, 1, 1, 1.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(2, 0, 2, 0), 0, 0));
		...
		customizePane.add(charsetPanel, new GridBagConstraints(0, 7, 1, 1, 1.0, 0.0
				,GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(2, 0, 2, 0), 0, 0));
...
// Server off
		this.ServerOFF.setSelected(Ini.isPropertyBool(Ini.P_SERVEROFF));
		...
		if(user.getName().toString().compareToIgnoreCase("SuperUser")==0 | user.getName().toString().compareToIgnoreCase("System")==0 | 
				user.getName().toString().compareToIgnoreCase("BORIS")==0)
		{
...
// Servidor
		Ini.setProperty(Ini.P_SERVEROFF , this.ServerOFF.isSelected());
