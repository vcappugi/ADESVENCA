...
public class AWindow extends CFrame
{
	...
	protected void processWindowEvent(WindowEvent e)
	{
		...
		if (e.getID() == WindowEvent.WINDOW_CLOSING | e.getID() == WindowEvent.WINDOW_LOST_FOCUS)
		{
			if (m_APanel != null)
			m_APanel.refrescar.stop();
		}
		else if (e.getID() == WindowEvent.WINDOW_ACTIVATED |  e.getID() == WindowEvent.WINDOW_GAINED_FOCUS)
		{
			if (m_APanel != null)
				m_APanel.refrescar.start();
