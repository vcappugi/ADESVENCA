...
import org.pentanet.model.I_C_Hes;
import org.pentanet.model.I_C_WorkDDG;
...
public class VCreateFromFactory
{
	...
	static
	{
		...
		//Formato de HES
		s_registeredClasses.put(I_C_Hes.Table_ID, VCreateFromHesUI.class);
		
		//Generar Proforma
		s_registeredClasses.put(I_C_WorkDDG.Table_ID, VCreateFromWorkDDUI.class);
	}
