...
public class PosPaymenDeposito  extends CDialog implements ActionListener {

	
	private static final long serialVersionUID = 1L;
	public static CLogger log = CLogger.getCLogger(PosPaymenDeposito.class);
	...
	public PosPaymenDeposito (PosBasePanel posPanel,boolean modal)
	{
		super (Env.getFrame(posPanel),Msg.translate(posPanel.getCtx(), "Pago Cheque"), true);
	...
	private static ColumnInfo[] s_layout = new ColumnInfo[] 
	{
		...
		new ColumnInfo(Msg.translate(Env.getCtx(), "Deposito No"), "checkno", String.class),
    ...
    private void initComponents() {
        ...
        dtCheckno = new PosTextField(Msg.translate(Env.getCtx(), "Deposito No"), posPanel, posPanel.p_pos.getOSK_KeyLayout_ID());
        ...
        lblcheckno.setText("Deposito No");
        ...
        lblTendertype.setText(Msg.translate(Env.getCtx(), "Deposito"));
