...
public class PosPaymenTransf  extends CDialog implements ActionListener {

	
	private static final long serialVersionUID = 1L;
	public static CLogger log = CLogger.getCLogger(PosPaymenTransf.class);
	...
	public PosPaymenTransf (PosBasePanel posPanel,boolean modal)
	{
		super (Env.getFrame(posPanel),Msg.translate(posPanel.getCtx(), "Pago Transferencias"), true);
	...
	private static ColumnInfo[] s_layout = new ColumnInfo[] 
	{
		...
		new ColumnInfo(Msg.translate(Env.getCtx(), "Transferencia No"), "checkno", String.class),
    ...
    private void initComponents() {
        ...
        dtCheckno = new PosTextField(Msg.translate(Env.getCtx(), "Transferencia No"), posPanel, posPanel.p_pos.getOSK_KeyLayout_ID());
        ...
        lblcheckno.setText("Transferencia No");
        ...
        lblTendertype.setText(Msg.translate(Env.getCtx(), "Transferencias"));
