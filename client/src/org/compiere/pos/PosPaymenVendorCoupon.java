...
public class PosPaymenVendorCoupon  extends CDialog implements ActionListener {

	
	private static final long serialVersionUID = 1L;
	public static CLogger log = CLogger.getCLogger(PosPaymenVendorCoupon.class);
	...
	public PosPaymenVendorCoupon (PosBasePanel posPanel,boolean modal)
	{
		super (Env.getFrame(posPanel),Msg.translate(posPanel.getCtx(), "PosPaymenVendorCoupon"), true);
    ...
    private void initComponents() {
        ...
        lblTendertype.setText(Msg.translate(Env.getCtx(), "Vendor Coupon"));
