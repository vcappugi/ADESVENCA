...
public class PosPago_T_Debito_Grid extends javax.swing.JDialog {
    public PosPago_T_Debito_Grid(java.awt.Frame parent, boolean modal,double dBalance) {
        super(parent, modal);
        initComponents();
        ...
        comboBox_Bancos.setFont(new Font("SansSerif", Font.PLAIN, 14));
        comboBox_Tipo.setFont(new Font("SansSerif", Font.PLAIN, 14));
        Tabla_Data.getColumnModel().getColumn(1).setCellEditor(defaultCellEditorBancos);
        Tabla_Data.getColumnModel().getColumn(1).setPreferredWidth(200);
        ...
        Tabla_Data.getColumnModel().getColumn(2).setCellEditor(defaultCellEditorTipo);
    ...
    private static final String[] DATA_TIPO = { "Ahorro", "Corriente" };
    private JComboBox comboBox_Bancos = new JComboBox(DATA_BANCOS);
    private JComboBox comboBox_Tipo = new JComboBox(DATA_TIPO);
    ...
    private DefaultCellEditor defaultCellEditorTipo=new DefaultCellEditor(comboBox_Tipo);
   ...
   private void ActualizaMonto_Items()
	...
	private void ActualizaBalance()
    {
        ...
        this.Txt_Balance.setText("Calcular");
...
//             textField.setText("8000");
    ...
    private void initComponents() {
        ...
        EFE_Titulo.setText("Tarjeta de Debito");

        Tabla_Data.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        Tabla_Data.setFont(new java.awt.Font("SansSerif", Font.PLAIN, 14)); // NOI18N
        Tabla_Data.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] { },
            new String [] {"Nro. Tarjeta", "Banco", "Tipo de Cuenta", "Monto" }
        ) 
        {
        ...
        Tabla_Suma.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(EFE_Titulo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Tabla_Aceptar, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(Tabla_Cancelar, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(Tabla_Eli, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(Tabla_Add, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {Tabla_Aceptar, Tabla_Add, Tabla_Cancelar, Tabla_Eli});
