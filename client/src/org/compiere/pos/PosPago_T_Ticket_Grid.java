...
public class PosPago_T_Ticket_Grid extends javax.swing.JDialog {

    /**
     * Creates new form PosPago_T_Ticket_Grid
     */
    public PosPago_T_Ticket_Grid(java.awt.Frame parent, boolean modal,double dBalance) {
        super(parent, modal);
        initComponents();
    ...
    private static final String[] DATA_TARJETA = { "Sodexo", "Banesco", "Mercantil", "Bicentenario"};
    ...
    private void initComponents() {
        ...
        EFE_Titulo.setText("Tarjeta Cesta Ticket");
        ...
        Tabla_Data.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tarjeta", "Nro. Tarjeta", "Mes", "Año", "Nombre", "Monto"
            }
        ) {
        ...
        Tabla_Data.getColumnModel().getColumn(4).setPreferredWidth(150);
