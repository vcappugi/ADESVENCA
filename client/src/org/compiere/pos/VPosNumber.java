 ...
 */
public final class VPosNumber extends JComponent
	implements VEditor, ActionListener, KeyListener, FocusListener, VManagedEditor
{
	...
	final class VNumber_mouseAdapter extends MouseAdapter
	{
		 ...
		 */
		VNumber_mouseAdapter(VPosNumber adaptee)
		{
			m_adaptee = adaptee;
		}	//	VNumber_mouseAdapter

		private VPosNumber m_adaptee;
	 ...
	 *  @param title title
	 */
	public VPosNumber(String columnName, boolean mandatory, boolean isReadOnly, boolean isUpdateable,
	...
	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(VPosNumber.class);
	 ...
	 *  @param color color
	 */
	public void setFont(java.awt.Font fg)
	{
		m_text.setFont(fg);
	}   //  setForeground
	...
	protected void fireActionPerformed()
	{
		...
		ActionEvent ae = new ActionEvent (this, ActionEvent.ACTION_PERFORMED,
			"VPosNumber", EventQueue.getMostRecentEventTime(), modifiers);
