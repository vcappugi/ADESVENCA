...
public class PosPaymenStoreCoupon  extends CDialog implements ActionListener {

	
	private static final long serialVersionUID = 1L;
	public static CLogger log = CLogger.getCLogger(PosPaymenStoreCoupon.class);
	...
	public PosPaymenStoreCoupon (PosBasePanel posPanel,boolean modal)
	{
		super (Env.getFrame(posPanel),Msg.translate(posPanel.getCtx(), "PosPaymenStoreCoupon"), true);
    ...
    private void initComponents() {
        ...
        lblTendertype.setText("Store Coupon");
