...
public class PosPaymenCheck  extends CDialog implements ActionListener {
	...
	public PosPaymenCheck (PosBasePanel posPanel,boolean modal)
	{
	...
	private static ColumnInfo[] s_layout = new ColumnInfo[] 
	{
		...
		new ColumnInfo(Msg.translate(Env.getCtx(), "Cheque No"), "checkno", String.class),
    ...
    private void initComponents() {
        ...
        dtCheckno = new PosTextField(Msg.translate(Env.getCtx(), "Cheque No"), posPanel, posPanel.p_pos.getOSK_KeyLayout_ID());
        ...
        lblTendertype.setText(Msg.translate(Env.getCtx(), "Cheque"));
