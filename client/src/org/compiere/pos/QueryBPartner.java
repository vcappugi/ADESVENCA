...
public class QueryBPartner extends PosQuery
{
	...
	protected void close()
	{
		...
		if( !isOnlySearch)
		{
			...
			{
				//p_posPanel.f_order.setC_BPartner_ID(m_C_BPartner_ID); //@nicaury
				p_posPanel.f_subpanel.setC_BPartner_ID(m_C_BPartner_ID);
			//	p_posPanel.f_curLine.setCurrency(m_Price);
			}
			else
			{
				//p_posPanel.f_order.setC_BPartner_ID(0); //@nicaury
				p_posPanel.f_subpanel.setC_BPartner_ID(0);
	...
	public void SetisOnlySearch(boolean value)
	{
		 isOnlySearch = value;
	}	
	public void setm_C_BPartner_ID(int value)
	{
		m_C_BPartner_ID=value;
	}	
