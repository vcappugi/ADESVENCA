...
public final class VBPartnerPOS extends CDialog implements ActionListener
{
	/**
	 * 
	 */
	...
	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(VBPartnerPOS.class);
	//
	...
	public VString GetfValue()
	{
		return fValue;
	}
	public VString GetfName()
	{
		return fName;
	}
