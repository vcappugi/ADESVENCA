...
public class PosPin extends CDialog implements PosKeyListener, VetoableChangeListener, ActionListener {
	...
	public PosPin(PosBasePanel posPanel) {
	...
	public static boolean pay(PosBasePanel posPanel) {
		...
		PosPin pay = new PosPin(posPanel);
		pay.setVisible(true);
	...
	private boolean isPaid() {
		System.err.println("PRINT ISPAID "+paid);
		return paid ;
	}
