...
public class PosPago_Cheque_Grid extends javax.swing.JDialog {

    /**
     * Creates new form PosPago_Cheque_Grid
     */
    public PosPago_Cheque_Grid(java.awt.Frame parent, boolean modal,double dBalance) {
        super(parent, modal);
        initComponents();
        ...
        Tabla_Data.getColumnModel().getColumn(5).setCellEditor(defaultCellEditorMonto);
    ...
    private void initComponents() {
        ...
        Tabla_Data.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nro. Cheque", "Banco", "Nro Cuenta", "Verificacion", "Nombre", "Monto"
            }
        ) {
        ...
        Tabla_Data.getColumnModel().getColumn(2).setPreferredWidth(120);
        Tabla_Data.getColumnModel().getColumn(3).setPreferredWidth(100);
        Tabla_Data.getColumnModel().getColumn(4).setPreferredWidth(250);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(filler1, javax.swing.GroupLayout.DEFAULT_SIZE, 733, Short.MAX_VALUE)
                    ...
                    .addComponent(filler2, javax.swing.GroupLayout.DEFAULT_SIZE, 733, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLabel3)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(Txt_Balance, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(290, 523, Short.MAX_VALUE))
                    .addComponent(EFE_Titulo, javax.swing.GroupLayout.DEFAULT_SIZE, 733, Short.MAX_VALUE))
                .addContainerGap())
        );
   ...
   private void ActualizaMonto_Items()
    {
        ...
        if (model.getColumnCount()>0)
        {
           for (int i = 0, rows = model.getRowCount(); i < rows; i++)
               {
                   total_item += Double.valueOf(model.getValueAt(i, 5).toString().replaceAll(",", "").toString());
