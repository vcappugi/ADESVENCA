...
public class PosPago_Deposito_Grid extends javax.swing.JDialog {

    /**
     * Creates new form PosPago_Deposito_Grid
     */
    public PosPago_Deposito_Grid(java.awt.Frame parent, boolean modal,double dBalance) {
        super(parent, modal);
        initComponents();
        ...
        Tabla_Data.getColumnModel().getColumn(4).setCellEditor(defaultCellEditorMonto);
    ...
    private void initComponents() {
        ...
        Tabla_Data.getColumnModel().getColumn(2).setPreferredWidth(100);
        Tabla_Data.getColumnModel().getColumn(3).setPreferredWidth(200);
        Tabla_Data.getColumnModel().getColumn(4).setPreferredWidth(100);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Tabla_Add, javax.swing.GroupLayout.DEFAULT_SIZE, 53, Short.MAX_VALUE)
                    .addComponent(Tabla_Eli, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(Tabla_Cancelar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(Tabla_Aceptar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
   ...
   private void ActualizaMonto_Items()
    {
        ...
        if (model.getColumnCount()>0)
        {
           for (int i = 0, rows = model.getRowCount(); i < rows; i++)
               {
                   total_item += Double.valueOf(model.getValueAt(i, 4).toString().replaceAll(",", "").toString());
