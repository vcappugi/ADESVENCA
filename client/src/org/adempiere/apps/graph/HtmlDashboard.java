...
public class HtmlDashboard extends JPanel implements MouseListener,
	...
	private String createHTML(PAGE_TYPE requestPage){
		...
		switch (requestPage) {
		    case PAGE_LOGO:
		    	String logo = DB.getSQLValueString(null, "Select Url_Image from AD_CLient Where AD_Client_ID=" +Env.getAD_Client_ID(Env.getCtx()));
		    	result += "</head><body class=\"header\">"
		    			 + "<table width=\"100%\" ><tr><td>"
		    			// + "<img src=\"res:org/compiere/images/Logo.gif\">"   //Este es el Logo de la primera parte
		    			 + "<img src=\""+logo+"\">"   //Este es el Logo de la primera parte
		    			 + "</td align=\"Left\">"
		    			 + "<div> </div>"
			...
			case PAGE_HOME: //**************************************************************
				 ...
				 +"<div style=\"height:100%; width:100%; font:small\" >"
				+"...."		 
