...
-- BF 2806709 - Reinstate Lost Report: Sales Tranactions
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,0,53176,53320,20,'IsSOTrx',TO_DATE('2009-06-15 18:35:31','YYYY-MM-DD HH24:MI:SS'),100,'Y','This is a Sales Transaction','D',1,'The Sales Transaction checkbox indicates if this item is a Sales Transaction.','Y','Y','N','N','Sales Transaction',20,TO_DATE('2009-06-15 18:35:31','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- BF 2806709 - Reinstate Lost Report: Sales Tranactions
INSERT INTO AD_Menu (Action,AD_Client_ID,AD_Menu_ID,AD_Org_ID,AD_Process_ID,Created,CreatedBy,EntityType,IsActive,IsReadOnly,IsSOTrx,IsSummary,Name,Updated,UpdatedBy) VALUES ('R',0,53223,0,53176,TO_DATE('2009-06-15 18:37:24','YYYY-MM-DD HH24:MI:SS'),100,'D','Y','N','N','N','Order Transactions',TO_DATE('2009-06-15 18:37:24','YYYY-MM-DD HH24:MI:SS'),100)
;
-- 15-Jun-2009 18:37:25 BST
-- BF 2806709 - Reinstate Lost Report: Sales Tranactions
...
-- 15-Jun-2009 18:37:25 BST
-- BF 2806709 - Reinstate Lost Report: Sales Tranactions
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo) SELECT t.AD_Client_ID,0, 'Y', SysDate, 0, SysDate, 0,t.AD_Tree_ID, 53223, 0, 999 FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=53223)
;
...
-- 15-Jun-2009 18:37:44 BST
-- BF 2806709 - Reinstate Lost Report: Sales Tranactions
UPDATE AD_TreeNodeMM SET Parent_ID=236, SeqNo=0, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=53223
;
