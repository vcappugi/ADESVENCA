...
-- Feb 14, 2009 10:26:49 AM COT
INSERT INTO AD_Process_Access (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Role_ID,Created,CreatedBy,IsActive,Updated,UpdatedBy) VALUES (0,0,53161,50002,TO_DATE('2009-02-14 10:26:49','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_DATE('2009-02-14 10:26:49','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Feb 14, 2009 10:26:49 AM COT
INSERT INTO AD_Process_Access (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Role_ID,Created,CreatedBy,IsActive,Updated,UpdatedBy) VALUES (0,0,53161,0,TO_DATE('2009-02-14 10:26:49','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_DATE('2009-02-14 10:26:49','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Feb 14, 2009 10:26:49 AM COT
INSERT INTO AD_Process_Access (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Role_ID,Created,CreatedBy,IsActive,Updated,UpdatedBy) VALUES (0,0,53161,102,TO_DATE('2009-02-14 10:26:49','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_DATE('2009-02-14 10:26:49','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Feb 14, 2009 10:26:49 AM COT
INSERT INTO AD_Process_Access (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Role_ID,Created,CreatedBy,IsActive,Updated,UpdatedBy) VALUES (0,0,53161,103,TO_DATE('2009-02-14 10:26:49','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_DATE('2009-02-14 10:26:49','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Feb 14, 2009 10:26:49 AM COT
INSERT INTO AD_Process_Access (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Role_ID,Created,CreatedBy,IsActive,Updated,UpdatedBy) VALUES (0,0,53161,50001,TO_DATE('2009-02-14 10:26:49','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_DATE('2009-02-14 10:26:49','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Feb 14, 2009 10:27:04 AM COT
INSERT INTO AD_Menu (Action,AD_Client_ID,AD_Menu_ID,AD_Org_ID,AD_Process_ID,Created,CreatedBy,EntityType,IsActive,IsReadOnly,IsSOTrx,IsSummary,Name,Updated,UpdatedBy) VALUES ('P',0,53202,0,53161,TO_DATE('2009-02-14 10:27:03','YYYY-MM-DD HH24:MI:SS'),100,'D','Y','N','N','N','Initial Client Setup Process',TO_DATE('2009-02-14 10:27:03','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Feb 14, 2009 10:27:04 AM COT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo) SELECT t.AD_Client_ID,0, 'Y', SysDate, 0, SysDate, 0,t.AD_Tree_ID, 53202, 0, 999 FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=53202)
;
...
-- Feb 14, 2009 10:27:08 AM COT
UPDATE AD_TreeNodeMM SET Parent_ID=156, SeqNo=6, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=531
;

-- Feb 14, 2009 10:27:08 AM COT
UPDATE AD_TreeNodeMM SET Parent_ID=156, SeqNo=7, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=530
;

-- Feb 14, 2009 10:28:55 AM COT
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,0,53161,53282,10,'ClientName',TO_DATE('2009-02-14 10:28:54','YYYY-MM-DD HH24:MI:SS'),100,'D',60,'Y','Y','Y','N','Client Name',10,TO_DATE('2009-02-14 10:28:54','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Process_Para SET DefaultValue='client',Updated=TO_DATE('2009-02-14 10:29:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=53282
;

-- Feb 14, 2009 10:29:55 AM COT
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,DefaultValue,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,0,53161,53283,10,'OrgName',TO_DATE('2009-02-14 10:29:55','YYYY-MM-DD HH24:MI:SS'),100,'org','D',60,'Y','Y','Y','N','Organization Name',10,TO_DATE('2009-02-14 10:29:55','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,DefaultValue,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,0,53161,53284,10,'AdminUserName',TO_DATE('2009-02-14 10:30:43','YYYY-MM-DD HH24:MI:SS'),100,'clientAdmin','D',60,'Y','Y','Y','N','Administrative User Name',20,TO_DATE('2009-02-14 10:30:43','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,DefaultValue,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,0,53161,53285,10,'NormalUserName',TO_DATE('2009-02-14 10:31:12','YYYY-MM-DD HH24:MI:SS'),100,'clientUser','D',60,'Y','Y','Y','N','Normal User Name',40,TO_DATE('2009-02-14 10:31:12','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,192,0,53161,53287,19,'C_Country_ID',TO_DATE('2009-02-14 10:44:06','YYYY-MM-DD HH24:MI:SS'),100,'@SQL=SELECT MIN(co.C_Country_ID) AS DefaultValue FROM C_Country co JOIN AD_Language l ON (co.AD_Language = l.AD_Language) WHERE l.AD_Language = ''@#AD_Language@''','Country','D',0,'The Country defines a Country.  Each Country must be defined before it can be used in any document.','Y','Y','Y','N','Country',60,TO_DATE('2009-02-14 10:44:06','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,0,53161,53289,10,'CityName',TO_DATE('2009-02-14 10:47:58','YYYY-MM-DD HH24:MI:SS'),100,'D',60,'Y','Y','N','N','City Name',80,TO_DATE('2009-02-14 10:47:58','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Val_Rule (AD_Client_ID,AD_Org_ID,AD_Val_Rule_ID,Code,Created,CreatedBy,EntityType,IsActive,Name,Type,Updated,UpdatedBy) VALUES (0,0,52045,'C_City.C_Region_ID=@C_Region_ID@',TO_DATE('2009-02-14 10:49:17','YYYY-MM-DD HH24:MI:SS'),100,'D','Y','C_City of Region','S',TO_DATE('2009-02-14 10:49:17','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Feb 14, 2009 10:49:29 AM COT
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,AD_Val_Rule_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,1830,0,53161,53290,19,52045,'C_City_ID',TO_DATE('2009-02-14 10:49:28','YYYY-MM-DD HH24:MI:SS'),100,'D',60,'Y','Y','N','N','City',90,TO_DATE('2009-02-14 10:49:28','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,0,53161,53292,20,'IsUseBPDimension',TO_DATE('2009-02-14 10:53:17','YYYY-MM-DD HH24:MI:SS'),100,'Y','Use Product accounting dimension','D',0,'Define if this client will use product accounting dimension.  This can be changed later in Accounting Schema window of the client.','Y','Y','Y','N','Product Accounting',110,TO_DATE('2009-02-14 10:53:17','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,0,53161,53293,20,'IsUseProjectDimension',TO_DATE('2009-02-14 10:53:54','YYYY-MM-DD HH24:MI:SS'),100,'N','Use Project accounting dimension','D',0,'Define if this client will use project accounting dimension.  This can be changed later in Accounting Schema window of the client.','Y','Y','Y','N','Project Accounting',120,TO_DATE('2009-02-14 10:53:54','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,0,53161,53295,20,'IsUseSalesRegionDimension',TO_DATE('2009-02-14 10:54:56','YYYY-MM-DD HH24:MI:SS'),100,'N','Use Sales Region accounting dimension','D',0,'Define if this client will use sales region accounting dimension.  This can be changed later in Accounting Schema window of the client.','Y','Y','Y','N','Sales Region Accounting',140,TO_DATE('2009-02-14 10:54:56','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,0,53161,53296,39,'CoAFile',TO_DATE('2009-02-14 10:55:42','YYYY-MM-DD HH24:MI:SS'),100,'D',0,'Y','Y','Y','N','Chart of Accounts File',150,TO_DATE('2009-02-14 10:55:42','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Process_Para SET Description='Location of the chart of accounts to be used with this client.  At this stage just the default accounts will be created.',Updated=TO_DATE('2009-02-14 10:56:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=53296
;
