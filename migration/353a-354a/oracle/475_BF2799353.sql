...
-- Posted button hidden for matching document - ID: 2799353
UPDATE AD_Field SET DisplayLogic='@Processed@=Y & @#ShowAcct@=Y',Updated=TO_DATE('2009-06-01 15:53:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=11098
;

-- Jun 1, 2009 3:54:02 PM MYT
-- Posted button hidden for matching document - ID: 2799353
UPDATE AD_Field SET DisplayLogic='@Processed@=Y & @#ShowAcct@=Y',Updated=TO_DATE('2009-06-01 15:54:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=11151
;
