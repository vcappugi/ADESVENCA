...
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsTranslated,IsUpdateable,Name,Updated,UpdatedBy,Version) VALUES (0,57017,275,0,10,53144,'Description',TO_DATE('2009-04-01 12:50:35','YYYY-MM-DD HH24:MI:SS'),0,'Optional short description of the record','EE01',255,'A description is limited to 255 characters.','Y','N','N','N','N','N','N','N','N','N','Description',TO_DATE('2009-04-01 12:50:35','YYYY-MM-DD HH24:MI:SS'),0,0)
;
...
-- Adding Description to RV_DD_ORDERDETAIL
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,AD_Reference_Value_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,275,0,53151,53311,17,131,'DocStatus',TO_DATE('2009-04-01 12:56:17','YYYY-MM-DD HH24:MI:SS'),0,'The current status of the document','EE01',0,'The Document Status indicates the status of a document at this time.  If you want to change the document status, use the Document Action field','Y','Y','N','N','Document Status',100,TO_DATE('2009-04-01 12:56:17','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Adding Description to RV_DD_ORDERDETAIL
UPDATE AD_Process_Para SET AD_Reference_ID=10, AD_Reference_Value_ID=NULL, ColumnName='Description', Description='Description', FieldLength=30, Help='Optional short description of the record', Name='Description',Updated=TO_DATE('2009-04-01 12:57:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53311
;
