...
-- 22/04/2009 12:25:03
-- Table reference selectable zoom target window
ALTER TABLE AD_Ref_Table ADD AD_Window_ID NUMBER(10)
;

-- 22/04/2009 12:25:55
-- Table reference selectable zoom target window
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,57270,57011,0,103,TO_DATE('2009-04-22 12:25:54','YYYY-MM-DD HH24:MI:SS'),100,'Data entry or display window',0,'D','The Window field identifies a unique Window in the system.','Y','Y','Y','N','N','N','N','N','Window',120,0,TO_DATE('2009-04-22 12:25:54','YYYY-MM-DD HH24:MI:SS'),100)
;
