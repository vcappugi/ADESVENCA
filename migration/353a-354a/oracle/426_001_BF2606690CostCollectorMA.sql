...
-- Fix Allocation with Collector Cost
UPDATE AD_Element SET ColumnName='PP_Cost_CollectorMA_ID', Name='Manufacturing Order MA',Updated=TO_DATE('2009-02-13 11:12:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Element_ID=53343
;
...
-- Feb 13, 2009 11:12:11 AM ECT
-- Fix Allocation with Collector Cost
UPDATE AD_PrintFormatItem pi SET PrintName='Manufacturing Cost Collector', Name='Manufacturing Order MA' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=53343)
;

-- Feb 13, 2009 11:12:43 AM ECT
-- Fix Allocation with Collector Cost
UPDATE AD_Column SET AD_Element_ID=53310, ColumnName='PP_Cost_Collector_ID', Description=NULL, Help=NULL, Name='Manufacturing Cost Collector',Updated=TO_DATE('2009-02-13 11:12:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=54319
;
...
-- Fix Allocation with Collector Cost
INSERT INTO AD_Tab (AD_Client_ID,AD_Org_ID,AD_Tab_ID,AD_Table_ID,AD_Window_ID,Created,CreatedBy,EntityType,HasTree,ImportFields,IsActive,IsAdvancedTab,IsInfoTab,IsInsertRecord,IsReadOnly,IsSingleRow,IsSortTab,IsTranslationTab,Name,Processing,SeqNo,TabLevel,Updated,UpdatedBy) VALUES (0,0,53192,53062,53014,TO_DATE('2009-02-13 11:14:29','YYYY-MM-DD HH24:MI:SS'),0,'EE01','N','N','Y','N','N','Y','N','N','N','N','Cost Collector MA','N',20,1,TO_DATE('2009-02-13 11:14:29','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Fix Allocation with Collector Cost
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,54315,56695,0,53192,TO_DATE('2009-02-13 11:14:33','YYYY-MM-DD HH24:MI:SS'),0,'The record is active in the system',1,'EE01','There are two methods of making records unavailable in the system: One is to delete the record, the other is to de-activate the record. A de-activated record is not available for selection, but available for reports.
There are two reasons for de-activating and not deleting records:
(1) The system requires the record for audit purposes.
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.','Y','Y','Y','N','N','N','N','N','Active',TO_DATE('2009-02-13 11:14:33','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Fix Allocation with Collector Cost
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,54311,56697,0,53192,TO_DATE('2009-02-13 11:14:34','YYYY-MM-DD HH24:MI:SS'),0,'Client/Tenant for this installation.',10,'EE01','A Client is a company or a legal entity. You cannot share data between Clients. Tenant is a synonym for Client.','Y','Y','Y','N','N','N','N','N','Client',TO_DATE('2009-02-13 11:14:34','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Fix Allocation with Collector Cost
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,54319,56698,0,53192,TO_DATE('2009-02-13 11:14:36','YYYY-MM-DD HH24:MI:SS'),0,10,'EE01','Y','Y','Y','N','N','N','N','N','Manufacturing Cost Collector',TO_DATE('2009-02-13 11:14:36','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Feb 13, 2009 11:14:37 AM ECT
-- Fix Allocation with Collector Cost
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,54318,56699,0,53192,TO_DATE('2009-02-13 11:14:37','YYYY-MM-DD HH24:MI:SS'),0,10,'EE01','Y','Y','N','N','N','N','N','N','Manufacturing Order MA',TO_DATE('2009-02-13 11:14:37','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Fix Allocation with Collector Cost
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,54312,56701,0,53192,TO_DATE('2009-02-13 11:14:38','YYYY-MM-DD HH24:MI:SS'),0,'Organizational entity within client',10,'EE01','An organization is a unit of your client or legal entity - examples are store, department. You can share data between organizations.','Y','Y','Y','N','N','N','N','N','Organization',TO_DATE('2009-02-13 11:14:38','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Fix Allocation with Collector Cost
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2009-02-13 11:15:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=56701
;

-- Feb 13, 2009 11:15:58 AM ECT
-- Fix Allocation with Collector Cost
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2009-02-13 11:15:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=56696
;

-- Feb 13, 2009 11:17:49 AM ECT
-- Fix Allocation with Collector Cost
UPDATE AD_Tab SET IsInsertRecord='N', IsReadOnly='Y', Name='Attributes',Updated=TO_DATE('2009-02-13 11:17:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Tab_ID=53192
;
...
-- Fix Allocation with Collector Cost
INSERT INTO AD_Ref_List (AD_Client_ID,AD_Org_ID,AD_Ref_List_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy,Value) VALUES (0,0,53453,183,TO_DATE('2009-02-13 11:22:06','YYYY-MM-DD HH24:MI:SS'),0,'EE01','Y','Manufacturing Cost Collector',TO_DATE('2009-02-13 11:22:06','YYYY-MM-DD HH24:MI:SS'),0,'MCC')
;
...
-- Fix Allocation with Collector Cost
INSERT INTO AD_Reference (AD_Client_ID,AD_Org_ID,AD_Reference_ID,Created,CreatedBy,EntityType,IsActive,IsOrderByValue,Name,Updated,UpdatedBy,ValidationType) VALUES (0,0,53289,TO_DATE('2009-02-13 11:22:47','YYYY-MM-DD HH24:MI:SS'),0,'EE01','Y','N','C_DocType MFG Cost Collector',TO_DATE('2009-02-13 11:22:47','YYYY-MM-DD HH24:MI:SS'),0,'T')
;
...
-- Fix Allocation with Collector Cost
UPDATE C_DocType SET DocNoSequence_ID=53272,Updated=TO_DATE('2009-02-13 11:30:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=50013
;

-- Feb 13, 2009 11:44:28 AM ECT
-- Fix Allocation with Collector Cost
UPDATE C_DocType SET DocNoSequence_ID=53174,Updated=TO_DATE('2009-02-13 11:44:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=50013
;

UPDATE C_DocType SET DocNoSequence_ID=53272,Updated=TO_DATE('2009-02-16 14:26:40
