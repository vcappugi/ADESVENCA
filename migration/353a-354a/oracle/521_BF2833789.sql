...
-- [2833789] - concat instead of contac
UPDATE AD_Element_Trl SET IsTranslated='Y',Updated=TO_DATE('2009-08-09 13:38:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=2835 AND AD_Language='es_MX'
;
