...
UPDATE AD_Element SET Name='Allow Logging', PrintName='Allow Logging',Updated=TO_DATE('2009-08-01 15:01:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=53669
;
...
-- Aug 1, 2009 3:01:46 PM EEST
-- FR2830806 - IsAllowLogging human readable
UPDATE AD_PrintFormatItem pi SET PrintName='Allow Logging', Name='Allow Logging' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=53669)
;
