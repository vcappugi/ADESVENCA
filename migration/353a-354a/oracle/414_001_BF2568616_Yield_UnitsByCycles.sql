...
-- Implement Yield and Units Cycle
ALTER TABLE AD_Workflow ADD Yield NUMBER(10) DEFAULT NULL 
;

-- Feb 5, 2009 11:25:21 PM ECT
-- Implement Yield and Units Cycle
ALTER TABLE AD_WF_Node ADD Yield NUMBER(10) DEFAULT NULL 
;
...
-- Implement Yield and Units Cycle
ALTER TABLE AD_Workflow ADD UnitsCycles NUMBER DEFAULT NULL 
;
...
-- Implement Yield and Units Cycle
ALTER TABLE PP_Order_Workflow ADD Yield NUMBER(10) DEFAULT NULL 
;
...
-- Implement Yield and Units Cycle
ALTER TABLE PP_Order_Workflow ADD UnitsCycles NUMBER DEFAULT NULL 
;
...
-- Implement Yield and Units Cycle
ALTER TABLE PP_Order_Node ADD Yield NUMBER(10) DEFAULT NULL 
;

-- Feb 5, 2009 11:30:20 PM ECT
-- Implement Yield and Units Cycle
ALTER TABLE PP_Order_Node MODIFY Yield NUMBER(10) DEFAULT NULL 
;
...
For Multi-Lingual systems, the template is translated based on the Business Partner''s language selection.','Y','Y','Y','N','N','N','N','N','Mail Template',TO_DATE('2009-02-05 23:31:21','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Implement Yield and Units Cycle
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2009-02-05 23:33:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=56690
;
...
-- Implement Yield and Units Cycle
ALTER TABLE PP_Order_Workflow ADD OverlapUnits NUMBER DEFAULT NULL 
;
...
-- Implement Yield and Units Cycle
ALTER TABLE AD_Workflow ADD OverlapUnits NUMBER DEFAULT NULL 
;
...
-- Implement Yield and Units Cycle
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2009-02-05 23:37:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=56691
;

-- Feb 5, 2009 11:37:50 PM ECT
-- Implement Yield and Units Cycle
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2009-02-05 23:37:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=56685
;
...
-- Implement Yield and Units Cycle
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2009-02-05 23:43:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=56692
;

-- Feb 5, 2009 11:43:57 PM ECT
-- Implement Yield and Units Cycle
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2009-02-05 23:43:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=56694
;
...
-- Implement Yield and Units Cycle
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2009-02-05 23:44:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=56692
;

-- Feb 5, 2009 11:44:54 PM ECT
-- Implement Yield and Units Cycle
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2009-02-05 23:44:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=56693
;

-- Feb 5, 2009 11:46:05 PM ECT
-- Implement Yield and Units Cycle
UPDATE AD_Field SET DisplayLogic='@ProcessType@=''DR''',Updated=TO_DATE('2009-02-05 23:46:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=56693
;
...
-- Implement Yield and Units Cycle
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2009-02-05 23:46:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=53699
;

-- Feb 5, 2009 11:47:01 PM ECT
-- Implement Yield and Units Cycle
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2009-02-05 23:47:01','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=53698
;

-- Feb 5, 2009 11:47:06 PM ECT
-- Implement Yield and Units Cycle
UPDATE AD_Field SET DisplayLogic='@ProcessType@=''DR''',Updated=TO_DATE('2009-02-05 23:47:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=53698
;
...
-- Implement Yield and Units Cycle
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2009-02-05 23:48:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=56691
;

-- Feb 5, 2009 11:48:05 PM ECT
-- Implement Yield and Units Cycle
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2009-02-05 23:48:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=56683
;

-- Feb 5, 2009 11:48:10 PM ECT
-- Implement Yield and Units Cycle
UPDATE AD_Field SET DisplayLogic='@ProcessType@=''DR''',Updated=TO_DATE('2009-02-05 23:48:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=56683
;
...
-- Implement Yield and Units Cycle
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2009-02-05 23:48:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=53403
;

-- Feb 5, 2009 11:48:36 PM ECT
-- Implement Yield and Units Cycle
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2009-02-05 23:48:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=53402
;

-- Feb 5, 2009 11:49:37 PM ECT
-- Implement Yield and Units Cycle
UPDATE AD_Field SET DisplayLogic='@ProcessType@=''DR''',Updated=TO_DATE('2009-02-05 23:49:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=53402
;
...
-- Implement Yield and Units Cycle
UPDATE AD_Element SET Description='The Units for Cycles are defined for process type  Flow Repetitive Dedicated and  indicated the product to be manufactured on a production line for duration unit.', Help='When units for cycles is defined the duration time is the total time for units', Name='Units for Cycles', PrintName='Units for Cycles',Updated=TO_DATE('2009-02-06 00:21:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Element_ID=53239
;
...
-- Feb 6, 2009 12:21:00 AM ECT
-- Implement Yield and Units Cycle
UPDATE AD_PrintFormatItem pi SET PrintName='Units for Cycles', Name='Units for Cycles' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=53239)
;

-- Feb 6, 2009 12:23:09 AM ECT
-- Implement Yield and Units Cycle
UPDATE AD_Element SET Help='When Units by Cycles is defined the duration time is the total time for units', Name='Units by Cycles', PrintName='Units by Cycles',Updated=TO_DATE('2009-02-06 00:23:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Element_ID=53239
;
...
-- Feb 6, 2009 12:23:10 AM ECT
-- Implement Yield and Units Cycle
UPDATE AD_PrintFormatItem pi SET PrintName='Units by Cycles', Name='Units by Cycles' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=53239)
;

-- Feb 6, 2009 12:32:48 AM ECT
-- Implement Yield and Units Cycle
UPDATE AD_Element SET Description='The Units by Cycles are defined for process type  Flow Repetitive Dedicated and  indicated the product to be manufactured on a production line for duration unit.', Help='When Units by Cycles are defined the duration time is the total of time to manufactured the units',Updated=TO_DATE('2009-02-06 00:32:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Element_ID=53239
;
...
-- Implement Yield and Units Cycle
UPDATE AD_Element SET Description='Overlap Units are number of units that must be completed before they are moved the next activity', Help='When there are two consecutive avtivity, you can sometimes save time by moving partial quantites from one activity to the next before the first activity as been completed.',Updated=TO_DATE('2009-02-06 00:36:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Element_ID=53241
;
...
',Updated=TO_DATE('2009-02-06 00:49:41','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Element_ID=53272
;
...
-- Implement Yield and Units Cycle
UPDATE AD_Element SET Name='% Yield', PrintName='% Yield',Updated=TO_DATE('2009-02-06 00:49:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Element_ID=53272
;
...
-- Implement Yield and Units Cycle
UPDATE AD_PrintFormatItem pi SET PrintName='% Yield', Name='% Yield' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=53272)
;

-- Feb 6, 2009 12:50:22 AM ECT
-- Implement Yield and Units Cycle
UPDATE AD_Element SET Name='Yield %', PrintName='Yield %',Updated=TO_DATE('2009-02-06 00:50:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Element_ID=53272
;
...
-- Implement Yield and Units Cycle
UPDATE AD_Column SET DefaultValue='100',Updated=TO_DATE('2009-02-06 01:46:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=56777
;

-- Feb 6, 2009 1:46:38 AM ECT
-- Implement Yield and Units Cycle
ALTER TABLE AD_Workflow MODIFY Yield NUMBER(10) DEFAULT 100
;

-- Feb 6, 2009 1:47:29 AM ECT
-- Implement Yield and Units Cycle
UPDATE AD_Column SET DefaultValue='100',Updated=TO_DATE('2009-02-06 01:47:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=56776
;

-- Feb 6, 2009 1:47:31 AM ECT
-- Implement Yield and Units Cycle
ALTER TABLE AD_WF_Node MODIFY Yield NUMBER(10) DEFAULT 100
;

-- Feb 6, 2009 1:48:04 AM ECT
-- Implement Yield and Units Cycle
UPDATE AD_Column SET DefaultValue='100',Updated=TO_DATE('2009-02-06 01:48:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=56779
;

-- Feb 6, 2009 1:48:08 AM ECT
-- Implement Yield and Units Cycle
ALTER TABLE PP_Order_Workflow MODIFY Yield NUMBER(10) DEFAULT 100
;

-- Feb 6, 2009 1:48:28 AM ECT
-- Implement Yield and Units Cycle
UPDATE AD_Column SET DefaultValue='100',Updated=TO_DATE('2009-02-06 01:48:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=56781
;

-- Feb 6, 2009 1:48:31 AM ECT
-- Implement Yield and Units Cycle
ALTER TABLE PP_Order_Node MODIFY Yield NUMBER(10) DEFAULT 100
;
