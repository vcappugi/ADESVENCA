...
UPDATE AD_Element SET Description='Organization Type',Updated=TO_TIMESTAMP('2009-08-28 14:54:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=2355
;
