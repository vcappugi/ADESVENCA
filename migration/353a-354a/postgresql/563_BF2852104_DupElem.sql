...
UPDATE AD_Column SET AD_Element_ID=913, ColumnName='I_IsImported', Description='Has this import been processed', Help='The Imported check box indicates if this import has been processed.', Name='Imported',Updated=TO_TIMESTAMP('2009-09-04 22:46:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=56027
;
...
-- FR-2852104-Duplicated elements found
UPDATE AD_Column SET AD_Element_ID=1949, ColumnName='VersionNo', Description='Version Number', Help=NULL, Name='Version No',Updated=TO_TIMESTAMP('2009-09-04 22:48:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=55861
;
...
-- FR-2852104-Duplicated elements found
UPDATE AD_Column SET AD_Element_ID=2438, ColumnName='TextMsg', Description='Text Message', Help=NULL, Name='Text Message',Updated=TO_TIMESTAMP('2009-09-04 22:48:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=55739
;
