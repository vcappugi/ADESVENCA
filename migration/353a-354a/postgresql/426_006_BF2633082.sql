...
-- 
UPDATE AD_Field SET IsSameLine='N', DisplayLogic=NULL,Updated=TO_TIMESTAMP('2009-02-26 09:41:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=53994
;

-- Feb 26, 2009 9:41:50 AM EET
-- 
UPDATE AD_Field SET DisplayLogic=NULL,Updated=TO_TIMESTAMP('2009-02-26 09:41:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=53993
;
