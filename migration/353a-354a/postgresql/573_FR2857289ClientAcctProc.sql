...
INSERT INTO AD_Process (AccessLevel,AD_Client_ID,AD_Org_ID,AD_Process_ID,Classname,Created,CreatedBy,Description,EntityType,Help,IsActive,IsBetaFunctionality,IsDirectPrint,IsReport,IsServerProcess,Name,ShowHelp,Statistic_Count,Statistic_Seconds,Updated,UpdatedBy,Value) VALUES ('2',0,0,53187,'org.adempiere.process.ClientAcctProcessor',TO_TIMESTAMP('2009-09-13 17:53:15','YYYY-MM-DD HH24:MI:SS'),100,'Client Accounting Processor','D','The client accounting processor allows a user to run the accounting processor in a client session.  The system configurator parameter CLIENT_ACCOUNTING must be enabled (configured as [I]mmediate or [Q]ueue).','Y','N','N','N','N','Client Accounting Processor','Y',0,0,TO_TIMESTAMP('2009-09-13 17:53:15','YYYY-MM-DD HH24:MI:SS'),100,'Client_Acct_Processor')
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,181,0,53187,53345,19,'C_AcctSchema_ID',TO_TIMESTAMP('2009-09-13 17:57:59','YYYY-MM-DD HH24:MI:SS'),100,'Accounting Schema','D',0,'An Accounting Schema defines the rules used in accounting such as costing method, currency and calendar','Y','Y','N','N','Accounting Schema',10,TO_TIMESTAMP('2009-09-13 17:57:59','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,AD_Val_Rule_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,126,0,53187,53346,19,213,'AD_Table_ID',TO_TIMESTAMP('2009-09-13 17:59:17','YYYY-MM-DD HH24:MI:SS'),100,NULL,'Database Table information','D',10,'The Database Table provides the information of the table definition','Y','Y','N','N','Table',10,TO_TIMESTAMP('2009-09-13 17:59:17','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Process_Para SET FieldLength=10,Updated=TO_TIMESTAMP('2009-09-13 17:59:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=53345
;

-- Sep 13, 2009 5:59:59 PM COT
INSERT INTO AD_Menu ("action",AD_Client_ID,AD_Menu_ID,AD_Org_ID,AD_Process_ID,Created,CreatedBy,Description,EntityType,IsActive,IsReadOnly,IsSOTrx,IsSummary,Name,Updated,UpdatedBy) VALUES ('P',0,53248,0,53187,TO_TIMESTAMP('2009-09-13 17:59:58','YYYY-MM-DD HH24:MI:SS'),100,'Client Accounting Processor','D','Y','N','N','N','Client Accounting Processor',TO_TIMESTAMP('2009-09-13 17:59:58','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Sep 13, 2009 5:59:59 PM COT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo) SELECT t.AD_Client_ID,0, 'Y', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, 0,t.AD_Tree_ID, 53248, 0, 999 FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=53248)
;
...
-- FR2857289-Run Accounting Embedded Server
UPDATE AD_Process_Para SET SeqNo=20,Updated=TO_TIMESTAMP('2009-09-13 18:18:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=53346
;
