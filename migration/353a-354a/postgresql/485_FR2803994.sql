...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,53874,0,'Parent_Column_ID',TO_TIMESTAMP('2009-06-11 14:51:43','YYYY-MM-DD HH24:MI:SS'),100,'The link column on the parent tab.','D','Y','Parent Column','Parent Column',TO_TIMESTAMP('2009-06-11 14:51:43','YYYY-MM-DD HH24:MI:SS'),100)
;
...
AD_Column.AD_Table_ID IN (SELECT t.AD_Table_ID FROM AD_Tab t
		...
		AND t2.SeqNo < @SeqNo@
                                                     AND t2.SeqNo > t.SeqNo) )',TO_TIMESTAMP('2009-06-11 14:53:27','YYYY-MM-DD HH24:MI:SS'),100,'D','Y','AD_Column (Parent tab link column)','S',TO_TIMESTAMP('2009-06-11 14:53:27','YYYY-MM-DD HH24:MI:SS'),100)
;

-- 11/06/2009 14:55:41
-- Add Parent_Column_ID to tab
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,AD_Val_Rule_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,57842,53874,0,18,251,106,52056,'Parent_Column_ID',TO_TIMESTAMP('2009-06-11 14:55:39','YYYY-MM-DD HH24:MI:SS'),100,'The link column on the parent tab.','D',22,'Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Parent Column',0,TO_TIMESTAMP('2009-06-11 14:55:39','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- 11/06/2009 14:55:45
-- Add Parent_Column_ID to tab
ALTER TABLE AD_Tab ADD COLUMN Parent_Column_ID NUMERIC(10) DEFAULT NULL 
;

-- 11/06/2009 14:57:07
-- Add Parent_Column_ID to tab
UPDATE AD_Field SET IsSameLine='N',Updated=TO_TIMESTAMP('2009-06-11 14:57:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=2575
;

-- 11/06/2009 14:58:54
-- Add Parent_Column_ID to tab
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,57842,57266,0,106,TO_TIMESTAMP('2009-06-11 14:58:53','YYYY-MM-DD HH24:MI:SS'),100,'The link column on the parent tab.',14,'D','Y','Y','Y','N','N','N','N','Y','Parent Column',205,0,TO_TIMESTAMP('2009-06-11 14:58:53','YYYY-MM-DD HH24:MI:SS'),100)
;
