...
-- -
INSERT INTO AD_Window (IsActive,Created,AD_Client_ID,Help,UpdatedBy,AD_Org_ID,AD_Window_ID,Name,WindowType,Description,CreatedBy,Updated,IsSOTrx,AD_Image_ID,EntityType,Processing,IsDefault,IsBetaFunctionality) VALUES ('Y',TO_TIMESTAMP('2009-06-26 14:52:36','YYYY-MM-DD HH24:MI:SS'),0,'The system creates notices will running MRP process. In this window you can view them.
',0,0,53085,'MRP Notice (all)','T','View all MRP Notices',0,TO_TIMESTAMP('2009-06-26 14:52:36','YYYY-MM-DD HH24:MI:SS'),'Y',107,'EE01','N','N','N')
;
...
-- -
UPDATE AD_Window_Trl SET IsTranslated='Y',Name='Notificare MRP (all)',Description='Vizualizarea tuturor notificărilor MRP făcute de sistem',Help='Este un grup de mesaje generate în timpul procesării MRP-ului. Acestea indică planificatorului acţiunile necesare pentru a ajunge la MPS. Mesajele (acţiunile) sunt transmise planificatorului ca Note când intră într-o sesiune de lucru în ADempiere.
',Updated=TO_TIMESTAMP('2009-06-26 14:54:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Window_ID=53085 AND AD_Language='ro_RO'
;

-- 26.06.2009 14:57:04 EEST
-- -
INSERT INTO AD_Tab (SeqNo,IsSingleRow,HasTree,AD_Table_ID,WhereClause,AD_Tab_ID,Description,Help,AD_Window_ID,AD_Client_ID,AD_Org_ID,Created,CreatedBy,Updated,IsActive,IsTranslationTab,Name,IsReadOnly,IsInfoTab,IsSortTab,UpdatedBy,EntityType,ImportFields,Processing,TabLevel,IsInsertRecord,IsAdvancedTab) VALUES (10,'Y','N',389,'EXISTS (SELECT 1 FROM AD_Message m WHERE m.AD_Message_ID=AD_Note.AD_Message_ID AND m.Value like ''MRP-%'')',53237,'MRP Notice','The Notice Tab provides a method of viewing messages that are generated by MRP process.',53085,0,0,TO_TIMESTAMP('2009-06-26 14:57:03','YYYY-MM-DD HH24:MI:SS'),0,TO_TIMESTAMP('2009-06-26 14:57:03','YYYY-MM-DD HH24:MI:SS'),'Y','N','Notice','N','N','N',0,'EE01','N','N',0,'N','N')
;
...
(2) The record is referenced by other records. E.g., you cannot delete a Business Partner, if there are invoices for this partner record existing. You de-activate the Business Partner and prevent that this record is used for future entries.','N','Active',53237,4828,'N',0,'Y',TO_TIMESTAMP('2009-06-26 14:57:36','YYYY-MM-DD HH24:MI:SS'),'N','N',0,0,TO_TIMESTAMP('2009-06-26 14:57:36','YYYY-MM-DD HH24:MI:SS'),'The record is active in the system',0,'N','Y','EE01')
;
...
-- -
INSERT INTO AD_Menu (Name,CreatedBy,Updated,UpdatedBy,IsActive,Created,Description,"action",AD_Menu_ID,AD_Window_ID,IsSummary,AD_Client_ID,IsSOTrx,AD_Org_ID,EntityType,IsReadOnly) VALUES ('MRP Notice (all)',0,TO_TIMESTAMP('2009-06-26 14:58:43','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_TIMESTAMP('2009-06-26 14:58:43','YYYY-MM-DD HH24:MI:SS'),'View all MRP Notices','W',53224,53085,'N',0,'N',0,'EE01','N')
;
...
-- 26.06.2009 14:58:44 EEST
-- -
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo) SELECT t.AD_Client_ID,0, 'Y', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, 0,t.AD_Tree_ID, 53224, 0, 999 FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=53224)
;
...
-- 26.06.2009 14:58:58 EEST
-- -
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=14, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=1000089
;

-- 26.06.2009 14:58:58 EEST
-- -
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=15, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=1500041
;
...
-- 26.06.2009 14:58:58 EEST
-- -
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=17, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=519
;

-- 26.06.2009 14:58:58 EEST
-- -
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=18, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=1500016
;

-- 26.06.2009 14:58:58 EEST
-- -
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=19, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=1500084
;

-- 26.06.2009 14:58:58 EEST
-- -
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=20, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=1500087
;

-- 26.06.2009 14:58:58 EEST
-- -
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=21, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=1500098
;

-- 26.06.2009 14:58:58 EEST
-- -
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=22, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=1500103
;

-- 26.06.2009 14:58:58 EEST
-- -
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=23, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=1500108
;

-- 26.06.2009 14:58:58 EEST
-- -
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=24, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=1500121
;

-- 26.06.2009 14:58:58 EEST
-- -
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=25, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=1500124
;

-- 26.06.2009 14:58:58 EEST
-- -
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=26, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=1500158
;
...
-- 26.06.2009 14:58:58 EEST
-- -
UPDATE AD_TreeNodeMM SET Parent_ID=53034, SeqNo=6, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53041
;

-- 26.06.2009 14:58:58 EEST
-- -
UPDATE AD_TreeNodeMM SET Parent_ID=53034, SeqNo=7, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53224
;

-- 26.06.2009 14:58:58 EEST
-- -
UPDATE AD_TreeNodeMM SET Parent_ID=53034, SeqNo=8, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53042
;
...
-- 26.06.2009 14:59:10 EEST
-- -
UPDATE AD_TreeNodeMM SET Parent_ID=53034, SeqNo=7, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53041
;
