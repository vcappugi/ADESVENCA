...
INSERT INTO AD_Scheduler_Para (AD_Client_ID,AD_Org_ID,AD_Process_Para_ID,AD_Scheduler_ID,Created,CreatedBy,IsActive,ParameterDefault,Updated,UpdatedBy) VALUES (0,0,53130,100,TO_TIMESTAMP('2008-02-14 23:57:39','YYYY-MM-DD HH24:MI:SS'),100,'Y','7',TO_TIMESTAMP('2008-02-14 23:57:39','YYYY-MM-DD HH24:MI:SS'),100)
;

UPDATE AD_Column SET IsParent='Y', IsUpdateable='N',Updated=TO_TIMESTAMP('2008-02-14 23:59:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=11396
;