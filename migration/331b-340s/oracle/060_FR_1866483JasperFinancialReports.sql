...
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Reference_Value_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,54091,50064,0,18,400,445,'JasperProcess_ID',TO_DATE('2008-01-07 21:37:34','YYYY-MM-DD HH24:MI:SS'),100,'The Jasper Process used by the printengine if any process defined','D',22,'Y','N','N','N','N','N','N','N','N','N','Y','Jasper Process',0,TO_DATE('2008-01-07 21:37:34','YYYY-MM-DD HH24:MI:SS'),100,1.000000000000)
;
...
ALTER TABLE PA_Report ADD JasperProcess_ID NUMBER(10)
;

INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,53323,0,'JasperProcessing',TO_DATE('2008-01-07 21:40:17','YYYY-MM-DD HH24:MI:SS'),100,'D','Y','Jasper Process Now','Jasper Process Now',TO_DATE('2008-01-07 21:40:17','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Access (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Role_ID,Created,CreatedBy,IsActive,Updated,UpdatedBy) VALUES (0,0,53063,0,TO_DATE('2008-01-07 21:41:57','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_DATE('2008-01-07 21:41:57','YYYY-MM-DD HH24:MI:SS'),100)
;

INSERT INTO AD_Process_Access (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Role_ID,Created,CreatedBy,IsActive,Updated,UpdatedBy) VALUES (0,0,53063,102,TO_DATE('2008-01-07 21:41:57','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_DATE('2008-01-07 21:41:57','YYYY-MM-DD HH24:MI:SS'),100)
;

INSERT INTO AD_Process_Access (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Role_ID,Created,CreatedBy,IsActive,Updated,UpdatedBy) VALUES (0,0,53063,103,TO_DATE('2008-01-07 21:41:57','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_DATE('2008-01-07 21:41:57','YYYY-MM-DD HH24:MI:SS'),100)
;

INSERT INTO AD_Process_Access (AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_Role_ID,Created,CreatedBy,IsActive,Updated,UpdatedBy) VALUES (0,0,53063,50001,TO_DATE('2008-01-07 21:41:57','YYYY-MM-DD HH24:MI:SS'),100,'Y',TO_DATE('2008-01-07 21:41:57','YYYY-MM-DD HH24:MI:SS'),100)
;

INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,54092,53323,0,53063,28,445,'JasperProcessing',TO_DATE('2008-01-07 21:42:27','YYYY-MM-DD HH24:MI:SS'),100,'D',1,'Y','N','N','N','N','Y','N','N','N','N','Y','Jasper Process Now',0,TO_DATE('2008-01-07 21:42:27','YYYY-MM-DD HH24:MI:SS'),100,1)
;

INSERT INTO AD_Column_Trl (AD_Language,AD_Column_ID, Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language,t.AD_Column_ID, t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Column t WHERE l.IsActive='Y' AND l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N' AND t.AD_Column_ID=54092 AND EXISTS (SELECT * FROM AD_Column_Trl tt WHERE tt.AD_Language!=l.AD_Language OR tt.AD_Column_ID!=t.AD_Column_ID)
;

UPDATE AD_Column SET IsMandatory='N',Updated=TO_DATE('2008-01-07 21:43:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=54092
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,1005,0,53063,53119,19,'C_Activity_ID',TO_DATE('2008-01-07 21:47:41','YYYY-MM-DD HH24:MI:SS'),100,'Business Activity','D',0,'Activities indicate tasks that are performed and used to utilize Activity based Costing','Y','Y','N','N','Activity',60,TO_DATE('2008-01-07 21:47:41','YYYY-MM-DD HH24:MI:SS'),100)
;

INSERT INTO AD_Process_Para_Trl (AD_Language,AD_Process_Para_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language,t.AD_Process_Para_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Process_Para t WHERE l.IsActive='Y' AND l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N' AND t.AD_Process_Para_ID=53119 AND EXISTS (SELECT * FROM AD_Process_Para_Trl tt WHERE tt.AD_Language!=l.AD_Language OR tt.AD_Process_Para_ID!=t.AD_Process_Para_ID)
;

INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,210,0,53063,53120,19,'C_SalesRegion_ID',TO_DATE('2008-01-07 21:48:11','YYYY-MM-DD HH24:MI:SS'),100,'Sales coverage region','D',0,'The Sales Region indicates a specific area of sales coverage.','Y','Y','N','N','Sales Region',70,TO_DATE('2008-01-07 21:48:11','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,2344,0,53063,53123,20,'UpdateBalances',TO_DATE('2008-01-07 21:49:52','YYYY-MM-DD HH24:MI:SS'),100,'Y','Update Accounting Balances first (not required for subsequent runs)','D',0,'Y','Y','Y','N','Update Balances',100,TO_DATE('2008-01-07 21:49:52','YYYY-MM-DD HH24:MI:SS'),100)
;

INSERT INTO AD_Process_Para_Trl (AD_Language,AD_Process_Para_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language,t.AD_Process_Para_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Process_Para t WHERE l.IsActive='Y' AND l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N' AND t.AD_Process_Para_ID=53123 AND EXISTS (SELECT * FROM AD_Process_Para_Trl tt WHERE tt.AD_Language!=l.AD_Language OR tt.AD_Process_Para_ID!=t.AD_Process_Para_ID)
;

INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,2868,0,53063,53124,19,'PA_Hierarchy_ID',TO_DATE('2008-01-07 21:50:22','YYYY-MM-DD HH24:MI:SS'),100,'Optional Reporting Hierarchy - If not selected the default hierarchy trees are used.','D',0,'Reporting Hierarchy allows you to select different Hierarchies/Trees for the report.
Accounting Segments like Organization, Account, Product may have several hierarchies to accomodate different views on the business.','Y','Y','N','N','Reporting Hierarchy',110,TO_DATE('2008-01-07 21:50:22','YYYY-MM-DD HH24:MI:SS'),100)
;

INSERT INTO AD_Process_Para_Trl (AD_Language,AD_Process_Para_ID, Description,Help,Name, IsTranslated,AD_Client_ID,AD_Org_ID,Created,Createdby,Updated,UpdatedBy) SELECT l.AD_Language,t.AD_Process_Para_ID, t.Description,t.Help,t.Name, 'N',t.AD_Client_ID,t.AD_Org_ID,t.Created,t.Createdby,t.Updated,t.UpdatedBy FROM AD_Language l, AD_Process_Para t WHERE l.IsActive='Y' AND l.IsSystemLanguage='Y' AND l.IsBaseLanguage='N' AND t.AD_Process_Para_ID=53124 AND EXISTS (SELECT * FROM AD_Process_Para_Trl tt WHERE tt.AD_Language!=l.AD_Language OR tt.AD_Process_Para_ID!=t.AD_Process_Para_ID)
;

INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,54091,54234,0,372,TO_DATE('2008-01-07 21:51:00','YYYY-MM-DD HH24:MI:SS'),100,'The Jasper Process used by the printengine if any process defined',22,'D','Y','Y','Y','N','N','N','N','N','Jasper Process',TO_DATE('2008-01-07 21:51:00','YYYY-MM-DD HH24:MI:SS'),100)
;
...
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,54092,54235,0,372,TO_DATE('2008-01-07 21:51:02','YYYY-MM-DD HH24:MI:SS'),100,1,'D','Y','Y','Y','N','N','N','N','N','Jasper Process Now',TO_DATE('2008-01-07 21:51:02','YYYY-MM-DD HH24:MI:SS'),100)
;
...
UPDATE AD_Field SET DisplayLogic='@JasperProcess_ID@=0',Updated=TO_DATE('2008-01-07 21:52:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=4737
;

UPDATE AD_Field SET DisplayLogic='@JasperProcess_ID@>0',Updated=TO_DATE('2008-01-07 21:53:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=54235
;

UPDATE AD_Field SET DisplayLength=23,Updated=TO_DATE('2008-01-07 21:55:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=54235
;

UPDATE AD_Field SET Name='Create Report (Jasper)',Updated=TO_DATE('2008-01-07 21:55:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=54235
;

UPDATE AD_Field_Trl SET IsTranslated='N' WHERE AD_Field_ID=54235
;

UPDATE AD_Field SET Description='Create Financial Report (Jasper)',Updated=TO_DATE('2008-01-07 21:55:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=54235
;

UPDATE AD_Field_Trl SET IsTranslated='N' WHERE AD_Field_ID=54235
;

UPDATE AD_Field SET Help='The default period is the current period. You can optionally enter other restrictions.  You can select an alternative Reporting Hierarchy.',Updated=TO_DATE('2008-01-07 21:55:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=54235
;

UPDATE AD_Field_Trl SET IsTranslated='N' WHERE AD_Field_ID=54235
;

UPDATE AD_Field SET AD_FieldGroup_ID=114,Updated=TO_DATE('2008-01-07 21:55:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=54235
;
