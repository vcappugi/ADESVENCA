...
-- Feb 13, 2008 4:40:01 PM SGT
-- [ 1887651 ] Add Ad_Reference_Value_ID and AD_Val_Rule_ID to AD_Field
ALTER TABLE AD_Field ADD AD_Reference_Value_ID NUMBER(10) DEFAULT  NULL 
;

-- Feb 13, 2008 4:41:01 PM SGT
-- [ 1887651 ] Add Ad_Reference_Value_ID and AD_Val_Rule_ID to AD_Field
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,54357,139,0,19,107,'AD_Val_Rule_ID',TO_DATE('2008-02-13 16:41:00','YYYY-MM-DD HH24:MI:SS'),100,'Dynamic Validation Rule','D',22,'These rules define how an entry is determined to valid. You can use variables for dynamic (context sensitive) validation.','Y','N','N','N','N','N','N','N','N','N','Y','Dynamic Validation',0,TO_DATE('2008-02-13 16:41:00','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- [ 1887651 ] Add Ad_Reference_Value_ID and AD_Val_Rule_ID to AD_Field
ALTER TABLE AD_Field ADD AD_Val_Rule_ID NUMBER(10) DEFAULT  NULL 
;

-- Feb 13, 2008 4:46:04 PM SGT
-- [ 1887651 ] Add Ad_Reference_Value_ID and AD_Val_Rule_ID to AD_Field
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,DisplayLogic,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,54357,54401,0,107,TO_DATE('2008-02-13 16:46:03','YYYY-MM-DD HH24:MI:SS'),100,'Dynamic Validation Rule',14,'@AD_Reference_ID@=17 | @AD_Reference_ID@=18 | @AD_Reference_ID@=19 | @AD_Reference_ID@=28 | @AD_Reference_ID@=30','D','These rules define how an entry is determined to valid. You can use variables for dynamic (context sensitive) validation.','Y','Y','Y','N','N','N','N','Y','Dynamic Validation',280,0,TO_DATE('2008-02-13 16:46:03','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- [ 1887651 ] Add Ad_Reference_Value_ID and AD_Val_Rule_ID to AD_Field
UPDATE AD_Field SET IsSameLine='N',Updated=TO_DATE('2008-02-13 16:47:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=13424
;
