...
-- Replication Functionality
INSERT INTO AD_Menu (AD_Client_ID,AD_Menu_ID,AD_Org_ID,AD_Process_ID,Action,Created,CreatedBy,EntityType,IsActive,IsReadOnly,IsSOTrx,IsSummary,Name,Updated,UpdatedBy) VALUES (0,53125,0,53085,'P',TO_DATE('2008-03-24 21:09:42','YYYY-MM-DD HH24:MI:SS'),0,'EE05','Y','N','N','N','Create Export Format from Window',TO_DATE('2008-03-24 21:09:42','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Mar 24, 2008 9:10:26 PM CST
-- Replication Functionality
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo) SELECT t.AD_Client_ID,0, 'Y', SysDate, 0, SysDate, 0,t.AD_Tree_ID, 53125, 0, 999 FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=53125)
;
...
-- Mar 24, 2008 9:10:51 PM CST
-- Replication Functionality
UPDATE AD_TreeNodeMM SET Parent_ID=0, SeqNo=11, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=53105
;
...
-- Mar 24, 2008 9:10:51 PM CST
-- Replication Functionality
UPDATE AD_TreeNodeMM SET Parent_ID=53098, SeqNo=6, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=53101
;

-- Mar 24, 2008 9:10:51 PM CST
-- Replication Functionality
UPDATE AD_TreeNodeMM SET Parent_ID=53098, SeqNo=7, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=53104
;

-- Mar 24, 2008 9:10:51 PM CST
-- Replication Functionality
UPDATE AD_TreeNodeMM SET Parent_ID=53098, SeqNo=8, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=53103
;

-- Mar 24, 2008 9:11:15 PM CST
-- Replication Functionality
UPDATE AD_Menu SET Name='Create Export Format from a Window',Updated=TO_DATE('2008-03-24 21:11:15','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Menu_ID=53125
;
...
-- Replication Functionality
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,392,0,53085,53143,20,'IsMandatory',TO_DATE('2008-03-24 21:23:03','YYYY-MM-DD HH24:MI:SS'),0,'Generated an Export Format Line  if the column is mandatory ','EE05',1,'Y','N','N','N','IsMandatory',30,TO_DATE('2008-03-24 21:23:03','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Replication Functionality
UPDATE AD_Process_Para SET IsMandatory='Y',Updated=TO_DATE('2008-03-24 21:25:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53141
;

-- Mar 24, 2008 9:30:09 PM CST
-- Replication Functionality
UPDATE AD_Process SET Description='Create multiple Export Format based in a Window',Updated=TO_DATE('2008-03-24 21:30:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_ID=53085
;
...
-- Mar 24, 2008 9:30:09 PM CST
-- Replication Functionality
UPDATE AD_Menu SET Description='Create multiple Export Format based in a Window', IsActive='Y', Name='EXP_Format Generator',Updated=TO_DATE('2008-03-24 21:30:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Menu_ID=53125
;
...
-- Replication Functionality
UPDATE AD_Process_Para SET Name='Insert Record',Updated=TO_DATE('2008-03-24 21:31:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53142
;
...
-- Replication Functionality
UPDATE AD_Process_Para SET Name='Includes only the Tabs that Insert records',Updated=TO_DATE('2008-03-24 21:34:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53142
;
...
-- Replication Functionality
UPDATE AD_Process_Para SET Name='Includes only the mandatory columns',Updated=TO_DATE('2008-03-24 21:35:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53143
;
