...
-- Fixed MRP
UPDATE AD_Process_Para SET Name='Resource',Updated=TO_DATE('2008-03-02 22:32:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53132
;
...
-- Fixed MRP
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,459,0,53016,53133,19,'M_Warehouse_ID',TO_DATE('2008-03-02 22:34:50','YYYY-MM-DD HH24:MI:SS'),0,'Storage Warehouse and Service Point','EE01',22,'The Warehouse identifies a unique Warehouse where products are stored or Services are provided.','Y','Y','N','N','Warehouse',40,TO_DATE('2008-03-02 22:34:50','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Fixed MRP
UPDATE AD_Process_Para SET AD_Val_Rule_ID=202,Updated=TO_DATE('2008-03-02 22:35:29','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53054
;

-- Mar 2, 2008 10:35:37 PM CST
-- Fixed MRP
UPDATE AD_Process_Para SET SeqNo=20,Updated=TO_DATE('2008-03-02 22:35:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53132
;

-- Mar 2, 2008 10:35:43 PM CST
-- Fixed MRP
UPDATE AD_Process_Para SET SeqNo=30,Updated=TO_DATE('2008-03-02 22:35:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53133
;

-- Mar 2, 2008 10:35:49 PM CST
-- Fixed MRP
UPDATE AD_Process_Para SET SeqNo=40,Updated=TO_DATE('2008-03-02 22:35:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53053
;
