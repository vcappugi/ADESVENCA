...
UPDATE AD_Field SET DisplayLogic=NULL,Updated=TO_DATE('2008-01-20 20:25:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=54221
;
...
The transaction is completed, if confirmed.',0,'Y',190,54240,'IsInTransit',0,0,1,'N',TO_DATE('2008-01-20 20:28:37','YYYY-MM-DD HH24:MI:SS'),'N',20,0,TO_DATE('2008-01-20 20:28:37','YYYY-MM-DD HH24:MI:SS'),2397,'Y','N','N',0,'N','N','EE01')
;
...
-- [ 1875623 ] Add the reference in Replenish Report to Distribution Order
ALTER TABLE M_Warehouse ADD IsInTransit CHAR(1) DEFAULT 'N' CHECK (IsInTransit IN ('Y','N'))
;

-- Jan 20, 2008 8:29:13 PM CST
-- [ 1875623 ] Add the reference in Replenish Report to Distribution Order
INSERT INTO AD_Field (IsEncrypted,AD_Org_ID,UpdatedBy,IsDisplayed,IsCentrallyMaintained,IsActive,Created,AD_Client_ID,AD_Field_ID,Description,DisplayLength,AD_Column_ID,IsFieldOnly,CreatedBy,Help,Updated,Name,AD_Tab_ID,IsSameLine,IsHeading,IsReadOnly,EntityType) VALUES ('N',0,0,'Y','Y','Y',TO_DATE('2008-01-20 20:29:10','YYYY-MM-DD HH24:MI:SS'),0,54334,'Movement is in transit',1,54240,'N',0,'Material Movement is in transit - shipped, but not received.
The transaction is completed, if confirmed.',TO_DATE('2008-01-20 20:29:10','YYYY-MM-DD HH24:MI:SS'),'In Transit',177,'N','N','N','EE01')
;
...
-- [ 1875623 ] Add the reference in Replenish Report to Distribution Order
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2008-01-20 20:30:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=54334
;
