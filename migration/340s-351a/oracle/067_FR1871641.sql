...
-- [+1871641+]+Account+Bank+into+POS+Terminal
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_DATE('2008-01-16 20:34:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=54330
;

-- Jan 16, 2008 9:23:14 PM CST
-- [+1871641+]+Account+Bank+into+POS+Terminal
ALTER TABLE C_POS ADD C_BankAccount_ID NUMBER(10) DEFAULT  NULL 
;
