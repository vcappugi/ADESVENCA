...
UPDATE AD_Tab SET WhereClause='MovementType IN (''C-'', ''C+'')',Updated=TO_TIMESTAMP('2008-03-10 08:51:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Tab_ID=257
;

-- Mar 10, 2008 8:52:19 AM CST
-- Improve RMA Functionality
UPDATE AD_Tab SET WhereClause='MovementType IN (''V+'', ''V-'')',Updated=TO_TIMESTAMP('2008-03-10 08:52:19','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Tab_ID=296
;
-- 10-mar-2008 16:52:00 CST
-- Improve RMA Functionality
UPDATE AD_Field SET DisplayLogic='@DocBaseType@=''SOO'' | ( @DocBaseType@=''POO'' & (DocSubTypeSO_Sub=null OR DocSubTypeSO_Sub=''RM'') )',Updated=TO_TIMESTAMP('2008-03-10 16:52:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=2581
;

-- 10-mar-2008 16:54:36 CST
-- Improve RMA Functionality
UPDATE AD_Field SET DisplayLogic='@DocBaseType@=''SOO'' | ( @DocBaseType@=''POO'' & @DocSubTypeSO@=''RM'' )',Updated=TO_TIMESTAMP('2008-03-10 16:54:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=3071
;

-- 10-mar-2008 16:54:44 CST
-- Improve RMA Functionality
UPDATE AD_Field SET DisplayLogic='@DocBaseType@=''SOO'' | ( @DocBaseType@=''POO'' & @DocSubTypeSO@=''RM'' )',Updated=TO_TIMESTAMP('2008-03-10 16:54:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=3073
;

-- 10-mar-2008 17:02:53 CST
-- Improve RMA Functionality
UPDATE AD_Field SET DisplayLogic='@DocBaseType@=''SOO''  ^ @DocBaseType@=''POO'' & @DocSubTypeSO@=''RM''',Updated=TO_TIMESTAMP('2008-03-10 17:02:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=3073
;

-- 10-mar-2008 17:04:31 CST
-- Improve RMA Functionality
UPDATE AD_Field SET DisplayLogic='@DocBaseType@=''SOO'' | @DocBaseType@=''POO''',Updated=TO_TIMESTAMP('2008-03-10 17:04:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=3071
;

-- 10-mar-2008 17:04:38 CST
-- Improve RMA Functionality
UPDATE AD_Field SET DisplayLogic='@DocBaseType@=''SOO'' | @DocBaseType@=''POO''',Updated=TO_TIMESTAMP('2008-03-10 17:04:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=3073
;

-- 10-mar-2008 17:06:09 CST
-- Improve RMA Functionality
UPDATE AD_Field SET DisplayLogic='@DocBaseType@=''SOO'' | @DocBaseType@=''POO''',Updated=TO_TIMESTAMP('2008-03-10 17:06:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=2581
;

-- 10-mar-2008 17:22:30 CST
-- Improve RMA Functionality
UPDATE C_DocType SET GL_Category_ID=0,Updated=TO_TIMESTAMP('2008-03-10 17:22:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=150
;
...
-- Improve RMA Functionality
UPDATE AD_Field SET DisplayLogic='@MovementType@=''C+''',Updated=TO_TIMESTAMP('2008-03-10 17:48:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=4242
;

-- 10-mar-2008 17:48:14 CST
-- Improve RMA Functionality
UPDATE AD_Field SET DisplayLogic='@MovementType@=''C+''',Updated=TO_TIMESTAMP('2008-03-10 17:48:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=4243
;

-- 10-mar-2008 17:58:26 CST
-- Improve RMA Functionality
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2008-03-10 17:58:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=4243
;

-- 10-mar-2008 18:04:37 CST
-- Improve RMA Functionality
UPDATE AD_Field SET DisplayLogic='@MovementType@=''C+''',Updated=TO_TIMESTAMP('2008-03-10 18:04:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=2932
;

-- 10-mar-2008 18:04:42 CST
-- Improve RMA Functionality
UPDATE AD_Field SET DisplayLogic='@MovementType@!''C+''',Updated=TO_TIMESTAMP('2008-03-10 18:04:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=2932
;

-- 10-mar-2008 18:05:46 CST
-- Improve RMA Functionality
UPDATE AD_Field SET DisplayLogic=NULL,Updated=TO_TIMESTAMP('2008-03-10 18:05:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=2932
;
-- Mar 11, 2008 8:29:43 AM CST
-- Improve RMA Functionality
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,52009,54714,0,257,TO_TIMESTAMP('2008-03-11 08:29:36','YYYY-MM-DD HH24:MI:SS'),0,'Return Material Authorization',22,'D','A Return Material Authorization may be required to accept returns and to create Credit Memos','Y','Y','Y','N','N','N','N','N','RMA',TO_TIMESTAMP('2008-03-11 08:29:36','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Mar 11, 2008 8:29:43 AM CST
-- Improve RMA Functionality
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,15903,54715,0,257,TO_TIMESTAMP('2008-03-11 08:29:43','YYYY-MM-DD HH24:MI:SS'),0,'Volume of a product',22,'D','The Volume indicates the volume of the product in the Volume UOM of the Client','Y','Y','Y','N','N','N','N','N','Volume',TO_TIMESTAMP('2008-03-11 08:29:43','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Improve RMA Functionality
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,15904,54716,0,257,TO_TIMESTAMP('2008-03-11 08:29:43','YYYY-MM-DD HH24:MI:SS'),0,'Weight of a product',22,'D','The Weight indicates the weight  of the product in the Weight UOM of the Client','Y','Y','Y','N','N','N','N','N','Weight',TO_TIMESTAMP('2008-03-11 08:29:43','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Improve RMA Functionality
UPDATE AD_Field SET DisplayLogic='@M_RMA_ID@!0',Updated=TO_TIMESTAMP('2008-03-11 08:31:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=54714
;

-- Mar 11, 2008 8:33:45 AM CST
-- Improve RMA Functionality
INSERT INTO AD_Sequence (AD_Client_ID,AD_Org_ID,AD_Sequence_ID,Created,CreatedBy,CurrentNext,CurrentNextSys,Description,IncrementNo,IsActive,IsAudited,IsAutoSequence,IsTableID,Name,StartNewYear,StartNo,Updated,UpdatedBy) VALUES (11,0,53100,TO_TIMESTAMP('2008-03-11 08:33:44','YYYY-MM-DD HH24:MI:SS'),100,590001,59000,'MM Customer Return',1,'Y','N','Y','N','MM Customer Return','N',590000,TO_TIMESTAMP('2008-03-11 08:33:44','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Mar 11, 2008 8:34:12 AM CST
-- Improve RMA Functionality
UPDATE C_DocType SET DocNoSequence_ID=53100,Updated=TO_TIMESTAMP('2008-03-11 08:34:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=149
;

-- Mar 11, 2008 8:34:48 AM CST
-- Improve RMA Functionality
UPDATE C_DocType SET DocBaseType='MMR',Updated=TO_TIMESTAMP('2008-03-11 08:34:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=149
;

-- Mar 11, 2008 8:35:16 AM CST
-- Improve RMA Functionality
UPDATE C_DocType SET DocBaseType='MMS',Updated=TO_TIMESTAMP('2008-03-11 08:35:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE C_DocType_ID=151
;
