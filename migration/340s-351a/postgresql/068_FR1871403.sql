...
-- [ 1871403 ] Adding new field of product into Price List Schema
ALTER TABLE M_DiscountSchemaLine ADD COLUMN Classification VARCHAR(12)
;

-- Jan 16, 2008 9:00:34 PM CST
-- [ 1871403 ] Adding new field of product into Price List Schema
ALTER TABLE M_DiscountSchemaLine ADD COLUMN Group2 VARCHAR(255)
;

-- Jan 16, 2008 9:00:39 PM CST
-- [ 1871403 ] Adding new field of product into Price List Schema
ALTER TABLE M_DiscountSchemaLine ADD COLUMN Group1 VARCHAR(255)
;


-- Jan 16, 2008 9:02:42 PM CST
-- [ 1871403 ] Adding new field of product into Price List Schema
INSERT INTO AD_Field (IsEncrypted,AD_Org_ID,UpdatedBy,IsDisplayed,IsCentrallyMaintained,IsActive,Created,AD_Client_ID,AD_Field_ID,Description,DisplayLength,AD_Column_ID,IsFieldOnly,CreatedBy,Help,Updated,Name,AD_Tab_ID,IsSameLine,IsHeading,IsReadOnly,EntityType) VALUES ('N',0,0,'Y','Y','Y',TO_TIMESTAMP('2008-01-16 21:02:39','YYYY-MM-DD HH24:MI:SS'),0,54331,'Classification for grouping',12,54239,'N',0,'The Classification can be used to optionally group products.',TO_TIMESTAMP('2008-01-16 21:02:39','YYYY-MM-DD HH24:MI:SS'),'Classification',405,'N','N','N','D')
;
...
-- [ 1871403 ] Adding new field of product into Price List Schema
INSERT INTO AD_Field (IsEncrypted,AD_Org_ID,UpdatedBy,IsDisplayed,IsCentrallyMaintained,IsActive,Created,AD_Client_ID,AD_Field_ID,DisplayLength,AD_Column_ID,IsFieldOnly,CreatedBy,Updated,Name,AD_Tab_ID,IsSameLine,IsHeading,IsReadOnly,EntityType) VALUES ('N',0,0,'Y','Y','Y',TO_TIMESTAMP('2008-01-16 21:02:45','YYYY-MM-DD HH24:MI:SS'),0,54333,255,54238,'N',0,TO_TIMESTAMP('2008-01-16 21:02:45','YYYY-MM-DD HH24:MI:SS'),'Group2',405,'N','N','N','D')
;
...
-- [ 1871403 ] Adding new field of product into Price List Schema
UPDATE AD_Field SET IsSameLine='N',Updated=TO_TIMESTAMP('2008-01-16 21:04:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=5251
;

-- Jan 16, 2008 9:04:25 PM CST
-- [ 1871403 ] Adding new field of product into Price List Schema
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2008-01-16 21:04:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=5249
;

-- Jan 16, 2008 9:04:36 PM CST
-- [ 1871403 ] Adding new field of product into Price List Schema
UPDATE AD_Field SET IsSameLine='N',Updated=TO_TIMESTAMP('2008-01-16 21:04:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=5249
;

-- Jan 16, 2008 9:04:42 PM CST
-- [ 1871403 ] Adding new field of product into Price List Schema
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2008-01-16 21:04:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=54331
;

-- Jan 16, 2008 9:04:45 PM CST
-- [ 1871403 ] Adding new field of product into Price List Schema
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2008-01-16 21:04:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=54333
;

-- Jan 16, 2008 9:09:32 PM CST
-- [ 1871403 ] Adding new field of product into Price List Schema
UPDATE AD_Field SET DisplayLength=20,Updated=TO_TIMESTAMP('2008-01-16 21:09:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=54332
;

-- Jan 16, 2008 9:09:36 PM CST
-- [ 1871403 ] Adding new field of product into Price List Schema
UPDATE AD_Field SET DisplayLength=20,Updated=TO_TIMESTAMP('2008-01-16 21:09:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=54333
;
