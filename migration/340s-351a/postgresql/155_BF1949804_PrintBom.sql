...
ALTER TABLE T_BOMLine ADD COLUMN Implotion CHAR(1) CHECK (Implotion IN ('Y','N'))
;

-- May 13, 2008 10:18:38 AM EST
-- BF1949804 Broken Report - MultiLevel BOM & Formula Detail
ALTER TABLE T_BOMLine ADD COLUMN Sel_Product_ID NUMERIC(10) NOT NULL
;
...
-- BF1949804 Broken Report - MultiLevel BOM & Formula Detail
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,55324,53466,0,20,53045,'Implotion',TO_TIMESTAMP('2008-05-12 13:32:36','YYYY-MM-DD HH24:MI:SS'),100,'N','Implosion of a Bill of Materials refers to finding all the BOM''s in which a component is used.','EE01',1,'Commonly called a Where-Used report.','Y','N','N','N','N','N','N','N','N','N','Y','Implotion',0,TO_TIMESTAMP('2008-05-12 13:32:36','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- May 12, 2008 1:32:26 PM EST
-- BF1949804 Broken Report - MultiLevel BOM & Formula Detail
UPDATE AD_PrintFormatItem SET PrintName='Implosion', Name='Implotion' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=53466)
;

-- May 12, 2008 1:34:11 PM EST
-- BF1949804 Broken Report - MultiLevel BOM & Formula Detail
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,53464,0,'Sel_Product_ID',TO_TIMESTAMP('2008-05-12 13:34:10','YYYY-MM-DD HH24:MI:SS'),100,'EE01','Y','Sel_Product_ID','Selected Product',TO_TIMESTAMP('2008-05-12 13:34:10','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- BF1949804 Broken Report - MultiLevel BOM & Formula Detail
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,55325,53464,0,13,53045,'Sel_Product_ID',TO_TIMESTAMP('2008-05-12 13:39:28','YYYY-MM-DD HH24:MI:SS'),100,'EE01',10,'Y','N','N','N','N','Y','N','N','N','N','Y','Sel_Product_ID',0,TO_TIMESTAMP('2008-05-12 13:39:28','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- BF1949804 Broken Report - MultiLevel BOM & Formula Detail
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,53465,0,'TM_Product_ID',TO_TIMESTAMP('2008-05-12 13:42:51','YYYY-MM-DD HH24:MI:SS'),100,'T_Bomline M_Product_ID','EE01','Y','TM_Product_ID','TM_Product_ID',TO_TIMESTAMP('2008-05-12 13:42:51','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- BF1949804 Broken Report - MultiLevel BOM & Formula Detail
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,55326,53465,0,13,53063,'TM_Product_ID',TO_TIMESTAMP('2008-05-12 13:43:58','YYYY-MM-DD HH24:MI:SS'),100,'T_Bomline M_Product_ID','EE01',22,'Y','N','N','N','N','N','N','N','N','N','Y','TM_Product_ID',0,TO_TIMESTAMP('2008-05-12 13:43:58','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- BF1949804 Broken Report - MultiLevel BOM & Formula Detail
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,55327,53466,0,20,53063,'Implotion',TO_TIMESTAMP('2008-05-12 13:45:09','YYYY-MM-DD HH24:MI:SS'),100,'N','Implosion of a Bill of Materials refers to finding all the BOM''s in which a component is used.','EE01',1,'Commonly called a Where-Used report.','Y','N','N','N','N','N','N','N','N','N','Y','Implotion',0,TO_TIMESTAMP('2008-05-12 13:45:09','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
UPDATE AD_PrintFormatItem SET AD_Column_ID=55326, IsGroupBy='N', IsPageBreak='N', SortNo=0, XPosition=0, YPosition=0,Updated=TO_TIMESTAMP('2008-05-13 12:06:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_PrintFormatItem_ID=50470
;

-- May 13, 2008 12:31:28 PM EST
-- New Event Model Validator
UPDATE AD_Column SET AD_Reference_ID=30, AD_Reference_Value_ID=162,Updated=TO_TIMESTAMP('2008-05-13 12:31:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=55326
;
