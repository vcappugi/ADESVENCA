...
-- Libero HR & Payroll
UPDATE AD_Window SET Description='Payroll Process', Name='Payroll Process',Updated=TO_TIMESTAMP('2008-04-08 22:26:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Window_ID=53037
;
...
-- Apr 8, 2008 10:26:22 PM CDT
-- Libero HR & Payroll
UPDATE AD_Menu SET AD_Window_ID=NULL, Description='Payroll Process', IsActive='Y', Name='Payroll Process',Updated=TO_TIMESTAMP('2008-04-08 22:26:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Menu_ID=53116
;
...
-- Apr 8, 2008 10:27:25 PM CDT
-- Libero HR & Payroll
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo) SELECT t.AD_Client_ID,0, 'Y', CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP, 0,t.AD_Tree_ID, 53127, 0, 999 FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=53127)
;
...
-- Apr 8, 2008 10:27:32 PM CDT
-- Libero HR & Payroll
UPDATE AD_TreeNodeMM SET Parent_ID=53114, SeqNo=0, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53118
;

-- Apr 8, 2008 10:27:32 PM CDT
-- Libero HR & Payroll
UPDATE AD_TreeNodeMM SET Parent_ID=53114, SeqNo=1, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53115
;

-- Apr 8, 2008 10:27:32 PM CDT
-- Libero HR & Payroll
UPDATE AD_TreeNodeMM SET Parent_ID=53114, SeqNo=2, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53119
;

-- Apr 8, 2008 10:27:32 PM CDT
-- Libero HR & Payroll
UPDATE AD_TreeNodeMM SET Parent_ID=53114, SeqNo=3, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53120
;

-- Apr 8, 2008 10:27:32 PM CDT
-- Libero HR & Payroll
UPDATE AD_TreeNodeMM SET Parent_ID=53114, SeqNo=4, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53117
;

-- Apr 8, 2008 10:27:32 PM CDT
-- Libero HR & Payroll
UPDATE AD_TreeNodeMM SET Parent_ID=53114, SeqNo=5, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53123
;

-- Apr 8, 2008 10:27:32 PM CDT
-- Libero HR & Payroll
UPDATE AD_TreeNodeMM SET Parent_ID=53114, SeqNo=6, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53127
;

-- Apr 8, 2008 10:27:32 PM CDT
-- Libero HR & Payroll
UPDATE AD_TreeNodeMM SET Parent_ID=53114, SeqNo=7, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53116
;

-- Apr 8, 2008 10:27:32 PM CDT
-- Libero HR & Payroll
UPDATE AD_TreeNodeMM SET Parent_ID=53114, SeqNo=8, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53121
;

-- Apr 8, 2008 10:27:32 PM CDT
-- Libero HR & Payroll
UPDATE AD_TreeNodeMM SET Parent_ID=53114, SeqNo=9, Updated=CURRENT_TIMESTAMP WHERE AD_Tree_ID=10 AND Node_ID=53122
;

-- Apr 8, 2008 10:45:03 PM CDT
-- Libero HR & Payroll
INSERT INTO AD_Val_Rule (AD_Client_ID,AD_Org_ID,AD_Val_Rule_ID,Code,Created,CreatedBy,Description,EntityType,IsActive,Name,Type,Updated,UpdatedBy) VALUES (0,0,52021,'C_DocType.DocBaseType=''HRP''',TO_TIMESTAMP('2008-04-08 22:45:01','YYYY-MM-DD HH24:MI:SS'),0,'Document Type for Payroll','EE02','Y','C_DocType Payroll','S',TO_TIMESTAMP('2008-04-08 22:45:01','YYYY-MM-DD HH24:MI:SS'),0)
;

-- Apr 8, 2008 10:45:39 PM CDT
-- Libero HR & Payroll
UPDATE AD_Column SET AD_Val_Rule_ID=52021,Updated=TO_TIMESTAMP('2008-04-08 22:45:39','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=54863
;

-- Apr 8, 2008 10:45:40 PM CDT
-- Libero HR & Payroll
...
-- Libero HR & Payroll
UPDATE AD_Column SET AD_Val_Rule_ID=52021,Updated=TO_TIMESTAMP('2008-04-08 22:45:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=54858
;
...
-- Libero HR & Payroll
UPDATE AD_Ref_List SET Name='Payroll',Updated=TO_TIMESTAMP('2008-04-08 22:52:46','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Ref_List_ID=53240
;
