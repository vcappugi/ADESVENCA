...
UPDATE AD_Column SET AD_Reference_ID=18, DefaultValue='U', FieldLength=40, ReadOnlyLogic='@EntityType@=D',Updated=TO_TIMESTAMP('2007-12-19 16:07:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=53474
;
...
UPDATE AD_Column SET AD_Reference_ID=18, DefaultValue='U', FieldLength=40, ReadOnlyLogic='@EntityType@=D',Updated=TO_TIMESTAMP('2007-12-19 16:07:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=53520
;
...
UPDATE AD_Column SET AD_Reference_ID=18, DefaultValue='U', FieldLength=40, ReadOnlyLogic='@EntityType@=D',Updated=TO_TIMESTAMP('2007-12-19 16:08:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=53701
;
