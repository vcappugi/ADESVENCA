...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,54272,0,'HideInListView',TO_DATE('2010-08-23 17:52:26','YYYY-MM-DD HH24:MI:SS'),100,'When checked this field will be hidden by default in list view','D','Y','Hide in list view','Hide in list view',TO_DATE('2010-08-23 17:52:26','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- FR 3051618 - Grid view improvements - Hide columns by default - preferred width
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,54273,0,'PreferredWidth',TO_DATE('2010-08-23 17:52:58','YYYY-MM-DD HH24:MI:SS'),100,'Preferred width in pixels','D','Y','Preferred Width','Preferred Width',TO_DATE('2010-08-23 17:52:58','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- FR 3051618 - Grid view improvements - Hide columns by default - preferred width
ALTER TABLE AD_Field ADD HideInListView CHAR(1) DEFAULT 'N' CHECK (HideInListView IN ('Y','N'))
;

-- Aug 23, 2010 5:59:02 PM CEST
-- FR 3051618 - Grid view improvements - Hide columns by default - preferred width
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,59704,54273,0,11,107,'PreferredWidth',TO_DATE('2010-08-23 17:59:01','YYYY-MM-DD HH24:MI:SS'),100,'Preferred width in pixels','D',10,'Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Preferred Width',0,TO_DATE('2010-08-23 17:59:01','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- FR 3051618 - Grid view improvements - Hide columns by default - preferred width
ALTER TABLE AD_Field ADD PreferredWidth NUMBER(10) DEFAULT NULL 
;

-- Aug 23, 2010 6:00:33 PM CEST
-- FR 3051618 - Grid view improvements - Hide columns by default - preferred width
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,59703,59620,0,107,TO_DATE('2010-08-23 18:00:31','YYYY-MM-DD HH24:MI:SS'),100,'When checked this field will be hidden by default in list view',1,'D','Y','Y','Y','N','N','N','N','N','Hide in list view',290,0,TO_DATE('2010-08-23 18:00:31','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- FR 3051618 - Grid view improvements - Hide columns by default - preferred width
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,59704,59621,0,107,TO_DATE('2010-08-23 18:01:12','YYYY-MM-DD HH24:MI:SS'),100,'Preferred width in pixels',10,'D','Y','Y','Y','N','N','N','N','Y','Preferred Width',300,0,TO_DATE('2010-08-23 18:01:12','YYYY-MM-DD HH24:MI:SS'),100)
;
