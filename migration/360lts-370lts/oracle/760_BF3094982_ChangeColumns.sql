...
-- Payroll
UPDATE AD_Column SET AD_Element_ID=1474, ColumnName='IsManual', DefaultValue='''N''', Description='This is a manual process', Help='The Manual check box indicates if the process will done manually.', Name='Manual',Updated=TO_DATE('2010-10-25 11:25:10','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=55031
;
...
-- Payroll
UPDATE AD_Column SET AD_Element_ID=1474, ColumnName='IsManual', DefaultValue='''N''', Description='This is a manual process', Help='The Manual check box indicates if the process will done manually.', Name='Manual',Updated=TO_DATE('2010-10-25 11:26:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=54829
;
...
-- Payroll
UPDATE AD_Column SET AD_Element_ID=53684, ColumnName='IsSaveInHistoric', DefaultValue='''Y''', Description=NULL, Help=NULL, Name='Save In Historic',Updated=TO_DATE('2010-10-25 11:27:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=54815
;
...
-- Payroll
UPDATE AD_Column SET DefaultValue='Y',Updated=TO_DATE('2010-10-25 11:27:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=54815
;
