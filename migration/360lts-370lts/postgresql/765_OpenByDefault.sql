...
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,54360,0,'IsOpenByDefault',TO_TIMESTAMP('2010-11-09 12:02:21','YYYY-MM-DD HH24:MI:SS'),100,'D','Y','Open By Default','Open By Default',TO_TIMESTAMP('2010-11-09 12:02:21','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- FR [3106704] - ZK Closed by Default Dashlet
-- https://sourceforge.net/tracker/?func=detail&aid=3106704&group_id=176962&atid=883808
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,DefaultValue,EntityType,FieldLength,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,60079,54360,0,20,50010,'IsOpenByDefault',TO_TIMESTAMP('2010-11-09 12:03:00','YYYY-MM-DD HH24:MI:SS'),100,'Y','D',1,'Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Open By Default',0,TO_TIMESTAMP('2010-11-09 12:03:00','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- FR [3106704] - ZK Closed by Default Dashlet
-- https://sourceforge.net/tracker/?func=detail&aid=3106704&group_id=176962&atid=883808
ALTER TABLE PA_DashboardContent ADD COLUMN IsOpenByDefault CHAR(1) DEFAULT 'Y' CHECK (IsOpenByDefault IN ('Y','N'))
;

-- Nov 9, 2010 12:04:04 PM CET
-- FR [3106704] - ZK Closed by Default Dashlet
-- https://sourceforge.net/tracker/?func=detail&aid=3106704&group_id=176962&atid=883808
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,HideInListView,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,PreferredWidth,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,60079,60822,0,50010,TO_TIMESTAMP('2010-11-09 12:03:57','YYYY-MM-DD HH24:MI:SS'),100,1,'D','N','Y','Y','Y','N','N','N','N','N','Open By Default',0,130,0,TO_TIMESTAMP('2010-11-09 12:03:57','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- FR [3106704] - ZK Closed by Default Dashlet
-- https://sourceforge.net/tracker/?func=detail&aid=3106704&group_id=176962&atid=883808
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2010-11-09 12:05:11','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=60822
;
