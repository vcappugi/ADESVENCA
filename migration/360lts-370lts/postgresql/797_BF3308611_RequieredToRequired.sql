...
UPDATE AD_Element SET ColumnName='QtyRequired', Name='Qty Required',Updated=TO_TIMESTAMP('2011-05-27 18:41:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=53288
;
...
-- Fixed wrong field name
UPDATE AD_Element SET ColumnName='DurationRequired', Name='Duration Required', PrintName='Duration Required',Updated=TO_TIMESTAMP('2011-05-27 19:45:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=53284
;
...
-- Fixed wrong field name
UPDATE AD_Element SET ColumnName='SetupTimeRequired', Name='Setup Time Required', PrintName='Setup Time Required',Updated=TO_TIMESTAMP('2011-05-27 19:46:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=53291
;
