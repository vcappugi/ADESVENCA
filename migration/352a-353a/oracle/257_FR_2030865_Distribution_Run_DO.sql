...
-- DRP Functionality
UPDATE AD_Process_Para SET IsMandatory='N',Updated=TO_DATE('2008-08-04 19:48:21','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53221
;

-- Aug 4, 2008 7:50:08 PM CDT
-- DRP Functionality
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,2182,0,53150,53240,20,'ConsolidateDocument',TO_DATE('2008-08-04 19:49:59','YYYY-MM-DD HH24:MI:SS'),0,'Consolidate Lines into one Document','EE01',1,'Y','Y','N','N','Consolidate to one Document',60,TO_DATE('2008-08-04 19:49:59','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- DRP Functionality
UPDATE AD_Process_Para SET IsActive='N',Updated=TO_DATE('2008-08-04 19:51:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53219
;
...
Consolidate to one Document let the distribution in current Documents with ranges dates promised, if do not is selected then a new Order is generate.',Updated=TO_DATE('2008-08-04 20:09:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_ID=53150
;
