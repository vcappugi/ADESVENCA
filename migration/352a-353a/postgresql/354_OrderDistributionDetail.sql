...
-- Adding BP Group in Distribution Order Detail
UPDATE AD_Process_Para SET SeqNo=40,Updated=TO_TIMESTAMP('2008-12-10 22:54:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53262
;

-- Dec 10, 2008 10:54:57 PM ECT
-- Adding BP Group in Distribution Order Detail
UPDATE AD_Process_Para SET SeqNo=50,Updated=TO_TIMESTAMP('2008-12-10 22:54:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53227
;

-- Dec 10, 2008 10:54:59 PM ECT
-- Adding BP Group in Distribution Order Detail
UPDATE AD_Process_Para SET SeqNo=60,Updated=TO_TIMESTAMP('2008-12-10 22:54:59','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53228
;

-- Dec 10, 2008 10:55:02 PM ECT
-- Adding BP Group in Distribution Order Detail
UPDATE AD_Process_Para SET SeqNo=70,Updated=TO_TIMESTAMP('2008-12-10 22:55:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53230
;

-- Dec 10, 2008 10:55:07 PM ECT
-- Adding BP Group in Distribution Order Detail
UPDATE AD_Process_Para SET SeqNo=80,Updated=TO_TIMESTAMP('2008-12-10 22:55:07','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53231
;

-- Dec 10, 2008 10:55:16 PM ECT
-- Adding BP Group in Distribution Order Detail
UPDATE AD_Process_Para SET SeqNo=90,Updated=TO_TIMESTAMP('2008-12-10 22:55:16','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53229
;

-- Dec 10, 2008 11:01:58 PM ECT
-- Adding BP Group in Distribution Order Detail
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsTranslated,IsUpdateable,Name,Updated,UpdatedBy,Version) VALUES (0,56523,187,0,19,53144,'C_BPartner_ID',TO_TIMESTAMP('2008-12-10 23:01:55','YYYY-MM-DD HH24:MI:SS'),0,'Identifies a Business Partner','EE01',10,'A Business Partner is anyone with whom you transact.  This can include Vendor, Customer, Employee or Salesperson','Y','N','N','N','N','N','N','N','N','N','Business Partner ',TO_TIMESTAMP('2008-12-10 23:01:55','YYYY-MM-DD HH24:MI:SS'),0,0)
;
...
-- Adding BP Group in Distribution Order Detail
UPDATE AD_Process_Para SET SeqNo=40,Updated=TO_TIMESTAMP('2008-12-10 23:04:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53226
;

-- Dec 10, 2008 11:04:37 PM ECT
-- Adding BP Group in Distribution Order Detail
UPDATE AD_Process_Para SET SeqNo=30,Updated=TO_TIMESTAMP('2008-12-10 23:04:37','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53262
;
