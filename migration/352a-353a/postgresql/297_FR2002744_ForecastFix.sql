...
-- Fix Forecast Report
UPDATE AD_Process_Para SET Description='Material Forecast', Name='Forecast',Updated=TO_TIMESTAMP('2008-07-08 18:53:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53202
;
...
-- Fix Forecast Report
UPDATE AD_Process_Para_Trl SET Name='Pronostico',Description='Pronostico de Venta',Updated=TO_TIMESTAMP('2008-07-08 18:53:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53202 AND AD_Language='es_MX'
;

-- Jul 8, 2008 6:53:50 PM CDT
-- Fix Forecast Report
UPDATE AD_Process_Para_Trl SET IsTranslated='Y',Updated=TO_TIMESTAMP('2008-07-08 18:53:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53202 AND AD_Language='es_MX'
;

-- Jul 8, 2008 6:54:06 PM CDT
-- Fix Forecast Report
UPDATE AD_Process_Para SET Name='Rule',Updated=TO_TIMESTAMP('2008-07-08 18:54:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53201
;
...
-- Fix Forecast Report
UPDATE AD_Process_Para_Trl SET IsTranslated='Y',Name='Regla de C�lculo',Updated=TO_TIMESTAMP('2008-07-08 18:54:33','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53201 AND AD_Language='es_MX'
;

-- Jul 8, 2008 7:02:10 PM CDT
-- Forecast
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,453,0,53148,53209,19,'M_Product_Category_ID',TO_TIMESTAMP('2008-07-08 19:01:47','YYYY-MM-DD HH24:MI:SS'),0,'Category of a Product','EE01',22,'Identifies the category which this product belongs to.  Product categories are used for pricing and selection.','Y','Y','N','N','Product Category',30,TO_TIMESTAMP('2008-07-08 19:01:47','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Forecast
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,454,0,53148,53210,30,'M_Product_ID',TO_TIMESTAMP('2008-07-08 19:03:12','YYYY-MM-DD HH24:MI:SS'),0,'Product, Service, Item','EE01',22,'Identifies an item which is either purchased or sold in this organization.','Y','Y','N','N','Product',40,TO_TIMESTAMP('2008-07-08 19:03:12','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Forecast
UPDATE AD_Process_Para SET Description='Material Forecast', Help='Material Forecast', Name='Forecast',Updated=TO_TIMESTAMP('2008-07-08 19:04:08','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53193
;
...
-- Forecast
UPDATE AD_Process_Para_Trl SET IsTranslated='Y',Name='Pronostico',Description='Pronostico',Updated=TO_TIMESTAMP('2008-07-08 19:04:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53193 AND AD_Language='es_MX'
;

-- Jul 8, 2008 7:04:51 PM CDT
-- Forecast
UPDATE AD_Process_Para SET Description='Accounting Calendar Name', Help='The Calendar uniquely identifies an accounting calendar.  Multiple calendars can be used.  For example you may need a standard calendar that runs from Jan 1 to Dec 31 and a fiscal calendar that runs from July 1 to June 30.', Name='Calendar',Updated=TO_TIMESTAMP('2008-07-08 19:04:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53192
;
...
-- Forecast
UPDATE AD_Process_Para SET Description='Calendar Year', Help='The Year uniquely identifies an accounting year for a calendar.', Name='Year',Updated=TO_TIMESTAMP('2008-07-08 19:05:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53191
;
...
-- Forecast
UPDATE AD_Process_Para SET Description='Period of the Calendar', Help='The Period indicates an exclusive range of dates for a calendar.', Name='Period',Updated=TO_TIMESTAMP('2008-07-08 19:05:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53190
;
...
-- Forecast
UPDATE AD_Process_Para SET Description='Category of a Product', Help='Identifies the category which this product belongs to.  Product categories are used for pricing and selection.', Name='Product Category',Updated=TO_TIMESTAMP('2008-07-08 19:06:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53188
;
...
-- Forecast
UPDATE AD_Process_Para SET Description='Product, Service, Item', Help='Identifies an item which is either purchased or sold in this organization.', Name='Product',Updated=TO_TIMESTAMP('2008-07-08 19:07:38','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53189
;
...
-- Forecast
UPDATE AD_Process_Para SET Description='Date Order was promised', Help='The Date Promised indicates the date, if any, that an Order was promised for.', Name='Date Promised',Updated=TO_TIMESTAMP('2008-07-08 19:08:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53187
;
...
-- Forecast
UPDATE AD_Column SET AD_Element_ID=1539, ColumnName='TotalAmt', Description='Total Amount', FieldLength=10, Help='The Total Amount indicates the total document amount.', Name='Total Amount',Updated=TO_TIMESTAMP('2008-07-08 19:10:35','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=56134
;
...
-- Forecast
UPDATE AD_Column SET AD_Element_ID=1539, ColumnName='TotalAmt', Description='Total Amount', Help='The Total Amount indicates the total document amount.', Name='Total Amount',Updated=TO_TIMESTAMP('2008-07-08 19:11:32','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=56148
;
...
-- Forecast
UPDATE AD_Column SET AD_Element_ID=469, ColumnName='Name', Description='Alphanumeric identifier of the entity', Help='The name of an entity (record) is used as an default search option in addition to the search key. The name is up to 60 characters in length.', Name='Name',Updated=TO_TIMESTAMP('2008-07-08 19:59:40','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=56147
;
...
-- Forecast
UPDATE AD_Column SET FieldLength=10,Updated=TO_TIMESTAMP('2008-07-09 10:48:20','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=56144
;

-- Jul 9, 2008 10:48:36 AM CDT
-- Forecast
UPDATE AD_Column SET FieldLength=10,Updated=TO_TIMESTAMP('2008-07-09 10:48:36','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=56145
;

-- Jul 9, 2008 10:48:47 AM CDT
-- Forecast
UPDATE AD_Column SET FieldLength=60,Updated=TO_TIMESTAMP('2008-07-09 10:48:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=56147
;

-- Jul 9, 2008 10:48:53 AM CDT
-- Forecast
UPDATE AD_Column SET FieldLength=22,Updated=TO_TIMESTAMP('2008-07-09 10:48:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=56148
;

-- Jul 9, 2008 10:49:12 AM CDT
-- Forecast
UPDATE AD_Column SET FieldLength=10,Updated=TO_TIMESTAMP('2008-07-09 10:49:12','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=56148
;
...
-- Forecast
UPDATE AD_Field SET Included_Tab_ID=654,Updated=TO_TIMESTAMP('2008-07-09 22:05:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=10300
;
...
-- Forecast
UPDATE AD_Tab SET IsSingleRow='Y',Updated=TO_TIMESTAMP('2008-07-09 22:08:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Tab_ID=653
;
...
-- Forecast
UPDATE AD_Column SET DefaultValue='@#AD_User_ID@',Updated=TO_TIMESTAMP('2008-07-09 22:12:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=56113
;

-- Jul 9, 2008 10:20:17 PM CDT
-- Forecast
UPDATE AD_Column SET DefaultValue='@AD_Org_ID@',Updated=TO_TIMESTAMP('2008-07-09 22:20:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=11937
;

-- Jul 9, 2008 10:20:27 PM CDT
-- Forecast
UPDATE AD_Column SET ReadOnlyLogic='@M_Warehouse_ID@',Updated=TO_TIMESTAMP('2008-07-09 22:20:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=53411
;
