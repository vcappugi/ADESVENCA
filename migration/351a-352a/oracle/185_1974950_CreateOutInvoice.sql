...
INSERT INTO AD_Form (AD_Client_ID,AD_Form_ID,AD_Org_ID,AccessLevel,Classname,Created,CreatedBy,Description,EntityType,Help,IsActive,IsBetaFunctionality,Name,Updated,UpdatedBy) VALUES (0,53010,0,'1','org.eevolution.form.VInOutInvoiceGen',TO_DATE('2008-05-29 23:15:59','YYYY-MM-DD HH24:MI:SS'),0,'Select and generate shipments & Invoices','D','Generate Shipments & Invoices from Orders.  
Select the orders to generate the shipments & Invoices for.','Y','N','Generate Shipments & Invoices (manual)',TO_DATE('2008-05-29 23:15:59','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- New Form Shipments & Invoices
INSERT INTO AD_Form_Access (AD_Client_ID,AD_Form_ID,AD_Org_ID,AD_Role_ID,Created,CreatedBy,IsActive,Updated,UpdatedBy) VALUES (0,53010,0,0,TO_DATE('2008-05-29 23:16:00','YYYY-MM-DD HH24:MI:SS'),0,'Y',TO_DATE('2008-05-29 23:16:00','YYYY-MM-DD HH24:MI:SS'),0)
;

-- May 29, 2008 11:18:19 PM CDT
-- New Form Shipments & Invoices
INSERT INTO AD_Menu (AD_Client_ID,AD_Form_ID,AD_Menu_ID,AD_Org_ID,Action,Created,CreatedBy,Description,EntityType,IsActive,IsReadOnly,IsSOTrx,IsSummary,Name,Updated,UpdatedBy) VALUES (0,53010,53132,0,'X',TO_DATE('2008-05-29 23:18:19','YYYY-MM-DD HH24:MI:SS'),0,'Select and generate shipments & Invoices','D','Y','N','N','N','Generate Shipments & Invoices (manual)',TO_DATE('2008-05-29 23:18:19','YYYY-MM-DD HH24:MI:SS'),0)
;
