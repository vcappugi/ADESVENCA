...
UPDATE AD_Role SET IsActive='N', UserLevel='S  ',Updated=TO_DATE('2008-07-25 10:39:47','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Role_ID=50002
;

-- 25-jul-2008 10:39:50 COT
-- Default comment for updating dictionary
UPDATE AD_Role SET IsActive='N', UserLevel='S  ',Updated=TO_DATE('2008-07-25 10:39:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Role_ID=50001
;
