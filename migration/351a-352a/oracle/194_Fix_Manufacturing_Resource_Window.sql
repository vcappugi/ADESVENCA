...
UPDATE AD_Field SET DefaultValue='Y', IsReadOnly='Y',Updated=TO_DATE('2008-06-03 12:09:57','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=53299
;

-- 03.06.2008 12:12:50 EEST
-- Fix Manufacturing Resource Window
UPDATE AD_Field SET DisplayLogic=NULL,Updated=TO_DATE('2008-06-03 12:12:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=53300
;

-- 03.06.2008 12:12:54 EEST
-- Fix Manufacturing Resource Window
UPDATE AD_Field SET DisplayLogic=NULL,Updated=TO_DATE('2008-06-03 12:12:54','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=53301
;

-- 03.06.2008 12:13:00 EEST
-- Fix Manufacturing Resource Window
UPDATE AD_Field SET DisplayLogic=NULL,Updated=TO_DATE('2008-06-03 12:13:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=53302
;

-- 03.06.2008 12:13:03 EEST
-- Fix Manufacturing Resource Window
UPDATE AD_Field SET DisplayLogic=NULL,Updated=TO_DATE('2008-06-03 12:13:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=53303
;

-- 03.06.2008 12:13:06 EEST
-- Fix Manufacturing Resource Window
UPDATE AD_Field SET DisplayLogic=NULL,Updated=TO_DATE('2008-06-03 12:13:06','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=53304
;
...
-- Fix Manufacturing Resource Window
UPDATE AD_Element SET Name='Manufacturing Resource', PrintName='Manufacturing Resource',Updated=TO_DATE('2008-06-03 12:15:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Element_ID=53232
;
...
-- 03.06.2008 12:15:42 EEST
-- Fix Manufacturing Resource Window
UPDATE AD_PrintFormatItem pi SET PrintName='Manufacturing Resource', Name='Manufacturing Resource' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=53232)
;
...
-- Fix Manufacturing Resource Window
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='Resursa de productie',PrintName='Resursa de productie',Updated=TO_DATE('2008-06-03 12:17:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Element_ID=53232 AND AD_Language='ro_RO'
;

-- 03.06.2008 12:19:17 EEST
-- Fix Manufacturing Resource Window
UPDATE AD_Element SET Name='Manufacturing Resource Type', PrintName='Manufacturing Resource Type',Updated=TO_DATE('2008-06-03 12:19:17','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Element_ID=53233
;
...
-- 03.06.2008 12:19:17 EEST
-- Fix Manufacturing Resource Window
UPDATE AD_PrintFormatItem pi SET PrintName='Manufacturing Resource Type', Name='Manufacturing Resource Type' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=53233)
;
...
-- Fix Manufacturing Resource Window
UPDATE AD_Element_Trl SET IsTranslated='Y',Name='Tip resursa productie',PrintName='Tip resursa productie',Updated=TO_DATE('2008-06-03 12:19:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Element_ID=53233 AND AD_Language='ro_RO'
;
