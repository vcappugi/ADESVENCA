-- Jun 9, 2008 8:18:13 PM COT
-- [ 1989305 ] Missing GL Journal Batch in GardenWorld
INSERT INTO AD_Sequence (UpdatedBy,IsAutoSequence,AD_Org_ID,AD_Sequence_ID,Updated,CurrentNext,IsTableID,Created,StartNewYear,IsAudited,IncrementNo,AD_Client_ID,StartNo,Name,CurrentNextSys,CreatedBy,IsActive) VALUES (100,'Y',0,53162,TO_DATE('2008-06-09 20:18:12','YYYY-MM-DD HH24:MI:SS'),100,'N',TO_DATE('2008-06-09 20:18:12','YYYY-MM-DD HH24:MI:SS'),'N','N',1,11,1000,'GL Journal Batch',1002,100,'Y')
;

-- Jun 9, 2008 8:18:33 PM COT
INSERT INTO C_DocType (IsSOTrx,UpdatedBy,IsDocNoControlled,AD_Org_ID,DocNoSequence_ID,Updated,DocumentCopies,HasCharges,C_DocType_ID,Created,IsDefault,GL_Category_ID,PrintName,AD_Client_ID,HasProforma,Name,CreatedBy,IsShipConfirm,IsPickQAConfirm,DocBaseType,IsDefaultCounterDoc,IsActive,IsSplitWhenDifference,IsCreateCounter,IsInTransit,IsOverwriteDateOnComplete,IsOverwriteSeqOnComplete,IsIndexed) VALUES ('N',100,'Y',0,53162,TO_DATE('2008-06-09 20:18:32','YYYY-MM-DD HH24:MI:SS'),0,'N',50001,TO_DATE('2008-06-09 20:18:32','YYYY-MM-DD HH24:MI:SS'),'N',108,'Journal Batch',11,'N','GL Journal Batch',100,'N','N','GLJ','N','Y','N','Y','N','N','N','Y')
;
