...
UPDATE AD_Process_Para SET SeqNo=40,Updated=TO_TIMESTAMP('2008-06-12 19:57:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=712
;
...
-- FR 1992542 - Import Payment doesn't have DocAction parameter
UPDATE AD_Process_Para SET DefaultValue=NULL, AD_Val_Rule_ID=52027,Updated=TO_TIMESTAMP('2008-06-12 20:33:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Process_Para_ID=53177
;
