...
-- Improve MRP
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,Description,EntityType,Help,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,53656,0,'PlanningHorizon',TO_TIMESTAMP('2008-07-07 12:21:51','YYYY-MM-DD HH24:MI:SS'),0,'The planning horizon is the amount of time an organisation will look into the future when preparing a strategic plan.','EE01','The planning horizon is the amount of time an organisation will look into the future when preparing a strategic plan.','Y','Planning Horizon','Planning Horizon',TO_TIMESTAMP('2008-07-07 12:21:51','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Jul 7, 2008 12:23:06 PM CDT
-- Improve MRP
UPDATE AD_PrintFormatItem SET PrintName='Planning Horizon', Name='Planning Horizon' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=53656)
;
...
-- Improve MRP
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,DefaultValue,Description,EntityType,FieldLength,Help,IsActive,IsAlwaysUpdateable,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,56150,53656,0,11,487,'PlanningHorizon',TO_TIMESTAMP('2008-07-07 12:23:24','YYYY-MM-DD HH24:MI:SS'),0,'0','The planning horizon is the amount of time (Days) an organisation will look into the future when preparing a strategic plan.','EE01',22,'The planning horizon is the amount of time (Days) an organisation will look into the future when preparing a strategic plan.','Y','N','N','N','N','N','N','N','N','N','Y','Planning Horizon',0,TO_TIMESTAMP('2008-07-07 12:23:24','YYYY-MM-DD HH24:MI:SS'),0,0)
;
...
-- Improve MRP
ALTER TABLE S_Resource ADD COLUMN PlanningHorizon NUMERIC(10) DEFAULT '0' 
;

-- Jul 7, 2008 12:24:42 PM CDT
-- Improve MRP
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,Updated,UpdatedBy) VALUES (0,56150,56280,0,53015,TO_TIMESTAMP('2008-07-07 12:24:21','YYYY-MM-DD HH24:MI:SS'),0,'The planning horizon is the amount of time (Days) an organisation will look into the future when preparing a strategic plan.',22,'EE01','The planning horizon is the amount of time (Days) an organisation will look into the future when preparing a strategic plan.','Y','Y','Y','N','N','N','N','N','Planning Horizon',TO_TIMESTAMP('2008-07-07 12:24:21','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Improve MRP
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2008-07-07 12:26:04','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=53301
;

-- Jul 7, 2008 12:26:24 PM CDT
-- Improve MRP
UPDATE AD_Field SET IsSameLine='N',Updated=TO_TIMESTAMP('2008-07-07 12:26:24','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=53301
;
...
-- Improve MRP
UPDATE AD_Field SET DisplayLogic='@IsManufacturingResource@=''Y'' & @ManufacturingResourceType@=''PT''',Updated=TO_TIMESTAMP('2008-07-07 12:35:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=56280
;

-- Jul 7, 2008 12:35:50 PM CDT
-- Improve MRP
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2008-07-07 12:35:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Field_ID=56280
;
