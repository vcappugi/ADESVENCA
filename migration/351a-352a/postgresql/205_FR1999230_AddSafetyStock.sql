...
-- Fixed Libero Issue
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,Description,EntityType,FieldLength,Help,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,53354,0,53010,53184,29,'SafetyStock',TO_TIMESTAMP('2008-06-20 18:33:47','YYYY-MM-DD HH24:MI:SS'),0,'Safety Stock Qty','EE01',22,'Safety stock is defined as extra units of inventory carried as protection against possible stockouts. It is held when an organization cannot accurately predict demand and/or lead time for the product.','Y','Y','N','N','Safety Stock Qty',130,TO_TIMESTAMP('2008-06-20 18:33:47','YYYY-MM-DD HH24:MI:SS'),0)
;
...
-- Fixed Libero Issue
UPDATE AD_Process_Para SET SeqNo=105,Updated=TO_TIMESTAMP('2008-06-20 18:34:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Process_Para_ID=53184
;
