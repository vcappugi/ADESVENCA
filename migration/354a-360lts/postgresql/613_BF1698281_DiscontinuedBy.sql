...
UPDATE AD_Column SET ColumnName='DiscontinuedAt',Updated=TO_TIMESTAMP('2009-11-29 22:18:48','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=2704
;
...
-- BF[1698281] - Wrong name and description for DiscontinuedBy field
UPDATE AD_Column SET AD_Element_ID=54086, ColumnName='DiscontinuedAt', Description='Discontinued At indicates Date when product was discontinued', Help=NULL, Name='Discontinued At',Updated=TO_TIMESTAMP('2009-11-29 22:24:02','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=2704
;
...
-- BF[1698281] - Wrong name and description for DiscontinuedBy field
insert into t_alter_column values('m_product','DiscontinuedAt','TIMESTAMP',null,'NULL')
;

-- Nov 29, 2009 10:29:51 PM CET
-- BF[1698281] - Wrong name and description for DiscontinuedBy field
UPDATE AD_Column SET AD_Reference_ID=15, AD_Reference_Value_ID=NULL,Updated=TO_TIMESTAMP('2009-11-29 22:29:51','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=2712
;

-- Nov 29, 2009 10:30:03 PM CET
-- BF[1698281] - Wrong name and description for DiscontinuedBy field
UPDATE AD_Column SET AD_Element_ID=54086, ColumnName='DiscontinuedAt', Description='Discontinued At indicates Date when product was discontinued', Help=NULL, Name='Discontinued At',Updated=TO_TIMESTAMP('2009-11-29 22:30:03','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=2712
;
...
-- BF[1698281] - Wrong name and description for DiscontinuedBy field
UPDATE AD_Column SET AD_Element_ID=54086, ColumnName='DiscontinuedAt', Description='Discontinued At indicates Date when product was discontinued', Help=NULL, Name='Discontinued At',Updated=TO_TIMESTAMP('2009-11-29 22:32:50','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=7851
;
...
-- BF[1698281] - Wrong name and description for DiscontinuedBy field
ALTER TABLE I_Product ADD COLUMN DiscontinuedAt TIMESTAMP DEFAULT NULL 
;
