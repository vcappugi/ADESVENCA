...
-- Reset Allocation
UPDATE AD_Column SET AD_Process_ID=53199, AD_Reference_ID=28,Updated=TO_TIMESTAMP('2010-02-11 15:44:45','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=12314
;

-- Feb 11, 2010 3:44:49 PM EST
-- Reset Allocation
UPDATE AD_Field SET Description='Reset (delete) allocation of invoices to payments', Name='Reset Allocation',Updated=TO_TIMESTAMP('2010-02-11 15:44:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=10431
;
...
-- Reset Allocation
UPDATE AD_Column SET IsAlwaysUpdateable='Y',Updated=TO_TIMESTAMP('2010-02-11 15:50:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=12314
;
