...
UPDATE AD_WF_NodeNext SET AD_WF_Next_ID=136,Updated=TO_TIMESTAMP('2009-12-15 20:56:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_NodeNext_ID=134
;

-- Dec 15, 2009 8:56:55 PM COT
UPDATE AD_WF_NodeNext SET AD_WF_Next_ID=138,Updated=TO_TIMESTAMP('2009-12-15 20:56:55','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_NodeNext_ID=136
;
...
UPDATE AD_WF_Node SET XPosition=167, YPosition=172,Updated=TO_TIMESTAMP('2009-12-15 20:58:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Node_ID=138
;

-- Dec 15, 2009 8:58:28 PM COT
UPDATE AD_WF_Node SET XPosition=3, YPosition=260,Updated=TO_TIMESTAMP('2009-12-15 20:58:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Node_ID=139
;

-- Dec 15, 2009 8:58:28 PM COT
UPDATE AD_WF_Node SET XPosition=2, YPosition=171,Updated=TO_TIMESTAMP('2009-12-15 20:58:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_Node_ID=136
;

-- Dec 15, 2009 8:59:25 PM COT
INSERT INTO AD_WF_Node ("action",AD_Client_ID,AD_Org_ID,AD_WF_Node_ID,AD_Workflow_ID,Cost,Created,CreatedBy,Duration,EntityType,IsActive,IsCentrallyMaintained,JoinElement,"limit",Name,SplitElement,Updated,UpdatedBy,Value,WaitingTime,XPosition,YPosition) VALUES ('Z',0,0,50098,107,0,TO_TIMESTAMP('2009-12-15 20:59:23','YYYY-MM-DD HH24:MI:SS'),100,0,'U','Y','Y','X',0,'Revenue Recognition','X',TO_TIMESTAMP('2009-12-15 20:59:23','YYYY-MM-DD HH24:MI:SS'),100,'Revenue Recognition',0,0,0)
;
...
INSERT INTO AD_WF_NodeNext (AD_Client_ID,AD_Org_ID,AD_WF_Next_ID,AD_WF_Node_ID,AD_WF_NodeNext_ID,Created,CreatedBy,EntityType,IsActive,IsStdUserWorkflow,SeqNo,Updated,UpdatedBy) VALUES (0,0,161,50098,50075,TO_TIMESTAMP('2009-12-15 21:01:15','YYYY-MM-DD HH24:MI:SS'),100,'D','Y','N',10,TO_TIMESTAMP('2009-12-15 21:01:15','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Dec 15, 2009 9:01:27 PM COT
UPDATE AD_WF_NodeNext SET AD_WF_Next_ID=50098,Updated=TO_TIMESTAMP('2009-12-15 21:01:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_WF_NodeNext_ID=171
;

-- Dec 15, 2009 9:04:29 PM COT
INSERT INTO AD_Window (AD_Client_ID,AD_Org_ID,AD_Window_ID,Created,CreatedBy,Description,EntityType,Help,IsActive,IsBetaFunctionality,IsDefault,IsSOTrx,Name,Processing,Updated,UpdatedBy,WindowType,WinHeight,WinWidth) VALUES (0,0,53104,TO_TIMESTAMP('2009-12-15 21:04:28','YYYY-MM-DD HH24:MI:SS'),100,'Define Withholding','D','The Withholding Window defines withholding information for business partners.','Y','Y','N','Y','Withholding','N',TO_TIMESTAMP('2009-12-15 21:04:28','YYYY-MM-DD HH24:MI:SS'),100,'M',0,0)
;
...
INSERT INTO AD_Menu ("action",AD_Client_ID,AD_Menu_ID,AD_Org_ID,AD_Window_ID,Created,CreatedBy,Description,EntityType,IsActive,IsReadOnly,IsSOTrx,IsSummary,Name,Updated,UpdatedBy) VALUES ('W',0,53256,0,53104,TO_TIMESTAMP('2009-12-15 21:08:59','YYYY-MM-DD HH24:MI:SS'),100,'Define Withholding','D','Y','N','Y','N','Withholding',TO_TIMESTAMP('2009-12-15 21:08:59','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Dec 15, 2009 9:09:00 PM COT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo) SELECT t.AD_Client_ID, 0, 'Y', CURRENT_TIMESTAMP, 100, CURRENT_TIMESTAMP, 100,t.AD_Tree_ID, 53256, 0, 999 FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=53256)
;
...
UPDATE AD_Tab SET IsReadOnly='N',Updated=TO_TIMESTAMP('2009-12-15 21:13:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=229
;

-- Dec 15, 2009 9:14:14 PM COT
UPDATE AD_Field SET IsReadOnly='N',Updated=TO_TIMESTAMP('2009-12-15 21:14:14','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=2225
;

-- Dec 15, 2009 9:29:44 PM COT
UPDATE AD_Column SET MandatoryLogic=NULL,Updated=TO_TIMESTAMP('2009-12-15 21:29:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3116
;

-- Dec 15, 2009 9:29:49 PM COT
UPDATE AD_Column SET IsIdentifier='Y', IsUpdateable='N', SeqNo=1,Updated=TO_TIMESTAMP('2009-12-15 21:29:49','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3113
;

-- Dec 15, 2009 9:29:53 PM COT
UPDATE AD_Column SET IsIdentifier='Y', IsUpdateable='N', SeqNo=2,Updated=TO_TIMESTAMP('2009-12-15 21:29:53','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3114
;

-- Dec 15, 2009 9:29:56 PM COT
UPDATE AD_Column SET MandatoryLogic=NULL,Updated=TO_TIMESTAMP('2009-12-15 21:29:56','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=3119
;

-- Dec 15, 2009 9:34:18 PM COT
UPDATE AD_Tab SET IsInsertRecord='Y',Updated=TO_TIMESTAMP('2009-12-15 21:34:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=229
;
