...
ALTER TABLE C_AllocationHdr ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE C_BankStatement ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE C_Cash ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE C_Invoice ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE C_Payment ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE C_ProjectIssue ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE DD_Order ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE GL_Journal ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE HR_Process ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE M_InOut ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE M_Inventory ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE M_MatchInv ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE M_MatchPO ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE M_Movement ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE M_Production ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE M_Requisition ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE PP_Cost_Collector ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
...
ALTER TABLE PP_Order ADD COLUMN ProcessedOn NUMERIC DEFAULT NULL 
;
