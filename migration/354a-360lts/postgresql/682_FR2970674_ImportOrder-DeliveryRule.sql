...
-- Import Order: Import Delivery Rule
ALTER TABLE I_Order ADD COLUMN DeliveryRule CHAR(1) DEFAULT NULL 
;
...
-- Import Order: Import Delivery Rule
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2010-03-15 14:32:18','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=58786
;
