...
UPDATE AD_Element SET Help='Calculate the Maximum (↑)  of the data if the field is numeric, otherwise maximum length of the field.', Name='Calculate Maximum (↑)',Updated=TO_TIMESTAMP('2009-11-26 12:09:28','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=2207
;
...
UPDATE AD_Element SET Help='Calculate the Minimum (↓) of the data if the field is numeric, otherwise minimum length of the field.', Name='Calculate Minimum (↓)',Updated=TO_TIMESTAMP('2009-11-26 12:10:13','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=2208
;
...
-- Nov 26, 2009 12:10:14 PM COT
UPDATE AD_PrintFormatItem SET PrintName='Calc Min', Name='Calculate Minimum (↓)' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=2208)
;

-- Nov 26, 2009 12:10:43 PM COT
UPDATE AD_Element SET Help='The Standard Deviation (σ) is the a measure of dispersion - used in combination with the Mean (?)', Name='Calculate Deviation (σ)',Updated=TO_TIMESTAMP('2009-11-26 12:10:43','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=2275
;
...
-- Nov 26, 2009 12:10:44 PM COT
UPDATE AD_PrintFormatItem SET PrintName='Deviation', Name='Calculate Deviation (σ)' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=2275)
;

-- Nov 26, 2009 12:11:09 PM COT
UPDATE AD_Element SET Help='The Variance (σ²) is the a measure of dispersion - used in combination with the Mean (?)', Name='Calculate Variance (σ²)',Updated=TO_TIMESTAMP('2009-11-26 12:11:09','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=2276
;
...
-- Nov 26, 2009 12:11:09 PM COT
UPDATE AD_PrintFormatItem SET PrintName='Variance', Name='Calculate Variance (σ²)' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=2276)
;

-- Nov 26, 2009 12:11:22 PM COT
UPDATE AD_Element SET Help='The Variance (σ²) is the a measure of dispersion - used in combination with the Mean (μ)',Updated=TO_TIMESTAMP('2009-11-26 12:11:22','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=2276
;
...
UPDATE AD_Element SET Help='Calculate the Sum (Σ) of the data if the field is numeric, otherwise total sum length of the field.', Name='Calculate Sum (Σ)',Updated=TO_TIMESTAMP('2009-11-26 12:11:52','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1241
;
...
-- Nov 26, 2009 12:11:52 PM COT
UPDATE AD_PrintFormatItem SET PrintName='Sum', Name='Calculate Sum (Σ)' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=1241)
;

-- Nov 26, 2009 12:12:27 PM COT
UPDATE AD_Element SET Help='Calculate the Mean (μ) of the data if the field is numeric, otherwise calculate the average length of the field.', Name='Calculate Mean (μ)',Updated=TO_TIMESTAMP('2009-11-26 12:12:27','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1834
;
...
-- Nov 26, 2009 12:12:27 PM COT
UPDATE AD_PrintFormatItem SET PrintName='Mean', Name='Calculate Mean (μ)' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=1834)
;

-- Nov 26, 2009 12:12:44 PM COT
UPDATE AD_Element SET Help='Calculate the total number (№) of not empty (NULL) elements (maximum is the number of lines).', Name='Calculate Count (№)',Updated=TO_TIMESTAMP('2009-11-26 12:12:44','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=1835
;
...
-- Nov 26, 2009 12:12:44 PM COT
UPDATE AD_PrintFormatItem SET PrintName='Count', Name='Calculate Count (№)' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=AD_PrintFormatItem.AD_Column_ID AND c.AD_Element_ID=1835)
;

-- Nov 26, 2009 12:14:30 PM COT
UPDATE AD_Element SET Help='The Standard Deviation (σ) is the a measure of dispersion - used in combination with the Mean (μ)',Updated=TO_TIMESTAMP('2009-11-26 12:14:30','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=2275
;
