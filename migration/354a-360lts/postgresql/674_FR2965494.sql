...
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,59066,53942,0,19,591,'C_OrderSource_ID',TO_TIMESTAMP('2010-03-08 16:20:39','YYYY-MM-DD HH24:MI:SS'),100,'D',10,'Y','N','N','N','N','N','N','N','N','N','N','N','Y','Order Source',0,TO_TIMESTAMP('2010-03-08 16:20:39','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- Import of Order Source
ALTER TABLE I_Order ADD COLUMN C_OrderSource_ID NUMERIC(10) DEFAULT NULL 
;

-- Mar 8, 2010 4:23:40 PM CET
-- Import of Order Source
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,54129,0,'C_OrderSourceValue',TO_TIMESTAMP('2010-03-08 16:23:39','YYYY-MM-DD HH24:MI:SS'),100,'D','Y','Order Source Key','Order Source Key',TO_TIMESTAMP('2010-03-08 16:23:39','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Import of Order Source
INSERT INTO AD_Column (AD_Client_ID,AD_Column_ID,AD_Element_ID,AD_Org_ID,AD_Reference_ID,AD_Table_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsAllowLogging,IsAlwaysUpdateable,IsAutocomplete,IsEncrypted,IsIdentifier,IsKey,IsMandatory,IsParent,IsSelectionColumn,IsSyncDatabase,IsTranslated,IsUpdateable,Name,SeqNo,Updated,UpdatedBy,Version) VALUES (0,59068,54129,0,10,591,'C_OrderSourceValue',TO_TIMESTAMP('2010-03-08 16:27:19','YYYY-MM-DD HH24:MI:SS'),100,'D',40,'Y','Y','N','N','N','N','N','N','N','N','N','N','Y','Order Source Key',0,TO_TIMESTAMP('2010-03-08 16:27:19','YYYY-MM-DD HH24:MI:SS'),100,0)
;
...
-- Import of Order Source
ALTER TABLE I_Order ADD COLUMN C_OrderSourceValue VARCHAR(40) DEFAULT NULL 
;
...
-- Import of Order Source
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,DisplayLength,EntityType,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,59066,58780,0,512,TO_TIMESTAMP('2010-03-08 16:33:47','YYYY-MM-DD HH24:MI:SS'),100,0,'D','Y','Y','Y','N','N','N','N','N','Order Source',600,0,TO_TIMESTAMP('2010-03-08 16:33:47','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Import of Order Source
UPDATE AD_Field SET IsSameLine='Y',Updated=TO_TIMESTAMP('2010-03-08 16:33:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Field_ID=58780
;
