...
-- Dec 1, 2009 4:57:36 PM CET
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,CreatedBy,Updated,Help,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsAlwaysUpdateable,ColumnName,IsEncrypted) VALUES (58672,53247,'D',0,'N','N','N',100,TO_DATE('2009-12-01 16:57:36','YYYY-MM-DD HH24:MI:SS'),'An organization is a unit of your client or legal entity - examples are store, department. You can share data between organizations.','N',0,0,'Organizational entity within client','Organization','Y',10,'N',19,TO_DATE('2009-12-01 16:57:36','YYYY-MM-DD HH24:MI:SS'),'N','N',113,100,'N','AD_Org_ID','N')
;
...
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,CreatedBy,Updated,Help,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsAlwaysUpdateable,ColumnName,IsEncrypted) VALUES (58673,53247,'D',0,'N','N','N',100,TO_DATE('2009-12-01 16:57:36','YYYY-MM-DD HH24:MI:SS'),'Identifies an item which is either purchased or sold in this organization.','N',0,0,'Product, Service, Item','Product','Y',10,'N',19,TO_DATE('2009-12-01 16:57:36','YYYY-MM-DD HH24:MI:SS'),'Y','N',454,100,'N','M_Product_ID','N')
;
...
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,CreatedBy,Updated,Help,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsAlwaysUpdateable,ColumnName,IsEncrypted) VALUES (58674,53247,'D',0,'N','N','N',100,TO_DATE('2009-12-01 16:57:37','YYYY-MM-DD HH24:MI:SS'),'A search key allows you a fast method of finding a particular record.
If you leave the search key empty, the system automatically creates a numeric number.  The document sequence used for this fallback number is defined in the "Maintain Sequence" window with the name "DocumentNo_<TableName>", where TableName is the actual name of the table (e.g. C_Order).','N',0,0,'Search key for the record in the format required - must be unique','Search Key','Y',40,'N',10,TO_DATE('2009-12-01 16:57:37','YYYY-MM-DD HH24:MI:SS'),'Y','N',620,100,'N','Value','N')
;
...
-- Dec 1, 2009 4:57:38 PM CET
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,SeqNo,CreatedBy,Updated,Help,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsAlwaysUpdateable,ColumnName,IsEncrypted) VALUES (58675,53247,'D',0,'N','N','Y',1,100,TO_DATE('2009-12-01 16:57:38','YYYY-MM-DD HH24:MI:SS'),'The name of an entity (record) is used as an default search option in addition to the search key. The name is up to 60 characters in length.','N',0,0,'Alphanumeric identifier of the entity','Name','Y',255,'N',10,TO_DATE('2009-12-01 16:57:38','YYYY-MM-DD HH24:MI:SS'),'Y','N',469,100,'N','Name','N')
;
...
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,CreatedBy,Updated,Help,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsAlwaysUpdateable,ColumnName,IsEncrypted) VALUES (58676,53247,'D',0,'N','N','N',100,TO_DATE('2009-12-01 16:57:38','YYYY-MM-DD HH24:MI:SS'),'A description is limited to 255 characters.','N',0,0,'Optional short description of the record','Description','Y',255,'N',10,TO_DATE('2009-12-01 16:57:38','YYYY-MM-DD HH24:MI:SS'),'Y','N',275,100,'N','Description','N')
;
...
-- Dec 1, 2009 4:57:39 PM CET
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,CreatedBy,Updated,Help,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsAlwaysUpdateable,ColumnName,IsEncrypted) VALUES (58677,53247,'D',0,'N','N','N',100,TO_DATE('2009-12-01 16:57:39','YYYY-MM-DD HH24:MI:SS'),'Use this field to enter the bar code for the product in any of the bar code symbologies (Codabar, Code 25, Code 39, Code 93, Code 128, UPC (A), UPC (E), EAN-13, EAN-8, ITF, ITF-14, ISBN, ISSN, JAN-13, JAN-8, POSTNET and FIM, MSI/Plessey, and Pharmacode) ','N',0,0,'Bar Code (Universal Product Code or its superset European Article Number)','UPC/EAN','Y',30,'N',10,TO_DATE('2009-12-01 16:57:39','YYYY-MM-DD HH24:MI:SS'),'Y','N',603,100,'N','UPC','N')
;
...
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,CreatedBy,Updated,Help,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsAlwaysUpdateable,ColumnName,IsEncrypted) VALUES (58678,53247,'D',0,'N','N','N',100,TO_DATE('2009-12-01 16:57:39','YYYY-MM-DD HH24:MI:SS'),'The SKU indicates a user defined stock keeping unit.  It may be used for an additional bar code symbols or your own schema.','N',0,0,'Stock Keeping Unit','SKU','Y',30,'N',10,TO_DATE('2009-12-01 16:57:39','YYYY-MM-DD HH24:MI:SS'),'Y','N',549,100,'N','SKU','N')
;
...
-- Dec 1, 2009 4:57:40 PM CET
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,CreatedBy,Updated,Help,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsAlwaysUpdateable,ColumnName,IsEncrypted) VALUES (58679,53247,'D',0,'N','N','N',100,TO_DATE('2009-12-01 16:57:40','YYYY-MM-DD HH24:MI:SS'),'The UOM defines a unique non monetary Unit of Measure','N',0,0,'Unit of Measure','UOM','Y',10,'N',19,TO_DATE('2009-12-01 16:57:40','YYYY-MM-DD HH24:MI:SS'),'Y','N',215,100,'N','C_UOM_ID','N')
;
...
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,CreatedBy,Updated,Help,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsAlwaysUpdateable,ColumnName,IsEncrypted) VALUES (58680,53247,'D',0,'N','N','N',100,TO_DATE('2009-12-01 16:57:40','YYYY-MM-DD HH24:MI:SS'),'Identifies the category which this product belongs to.  Product categories are used for pricing and selection.','N',0,0,'Category of a Product','Product Category','Y',10,'N',19,TO_DATE('2009-12-01 16:57:40','YYYY-MM-DD HH24:MI:SS'),'Y','N',453,100,'N','M_Product_Category_ID','N')
;
...
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,CreatedBy,Updated,Help,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsAlwaysUpdateable,ColumnName,IsEncrypted) VALUES (58681,53247,'D',0,'N','N','N',100,TO_DATE('2009-12-01 16:57:41','YYYY-MM-DD HH24:MI:SS'),'The Classification can be used to optionally group products.','N',0,0,'Classification for grouping','Classification','Y',12,'N',10,TO_DATE('2009-12-01 16:57:41','YYYY-MM-DD HH24:MI:SS'),'Y','N',852,100,'N','Classification','N')
;
...
-- Dec 1, 2009 4:57:42 PM CET
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,CreatedBy,Updated,Help,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsAlwaysUpdateable,ColumnName,IsEncrypted) VALUES (58682,53247,'D',0,'N','N','N',100,TO_DATE('2009-12-01 16:57:42','YYYY-MM-DD HH24:MI:SS'),'The Weight indicates the weight  of the product in the Weight UOM of the Client','N',0,0,'Weight of a product','Weight','Y',131089,'N',22,TO_DATE('2009-12-01 16:57:42','YYYY-MM-DD HH24:MI:SS'),'Y','N',629,100,'N','Weight','N')
;
...
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,CreatedBy,Updated,Help,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsAlwaysUpdateable,ColumnName,IsEncrypted) VALUES (58683,53247,'D',0,'N','N','N',100,TO_DATE('2009-12-01 16:57:42','YYYY-MM-DD HH24:MI:SS'),'The Volume indicates the volume of the product in the Volume UOM of the Client','N',0,0,'Volume of a product','Volume','Y',131089,'N',22,TO_DATE('2009-12-01 16:57:42','YYYY-MM-DD HH24:MI:SS'),'Y','N',627,100,'N','Volume','N')
;
...
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,CreatedBy,Updated,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsAlwaysUpdateable,ColumnName,IsEncrypted) VALUES (58684,53247,'D',0,'N','N','N',100,TO_DATE('2009-12-01 16:57:43','YYYY-MM-DD HH24:MI:SS'),'N',0,0,'Version Number','Version No','Y',20,'N',10,TO_DATE('2009-12-01 16:57:43','YYYY-MM-DD HH24:MI:SS'),'Y','N',1949,100,'N','VersionNo','N')
;
...
-- Dec 1, 2009 4:57:44 PM CET
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,CreatedBy,Updated,Help,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsAlwaysUpdateable,ColumnName,IsEncrypted) VALUES (58685,53247,'D',0,'N','N','N',100,TO_DATE('2009-12-01 16:57:44','YYYY-MM-DD HH24:MI:SS'),'If the value is 0, there is no limit to the availability or guarantee, otherwise the guarantee date is calculated by adding the days to the delivery date.','N',0,0,'Number of days the product is guaranteed or available','Guarantee Days','Y',10,'N',11,TO_DATE('2009-12-01 16:57:44','YYYY-MM-DD HH24:MI:SS'),'Y','N',1937,100,'N','GuaranteeDays','N')
;
...
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,CreatedBy,Updated,Help,IsParent,AD_Client_ID,AD_Org_ID,Description,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsAlwaysUpdateable,ColumnName,IsEncrypted) VALUES (58686,53247,'D',0,'N','N','N',100,TO_DATE('2009-12-01 16:57:44','YYYY-MM-DD HH24:MI:SS'),'When selecting batch/products with a guarantee date, the minimum left guarantee days for automatic picking.  You can pick any batch/product manually. ','N',0,0,'Minumum number of guarantee days','Min Guarantee Days','Y',10,'N',11,TO_DATE('2009-12-01 16:57:44','YYYY-MM-DD HH24:MI:SS'),'Y','N',2197,100,'N','GuaranteeDaysMin','N')
;
...
-- Dec 1, 2009 4:57:45 PM CET
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Element (AD_Client_ID,AD_Element_ID,AD_Org_ID,ColumnName,Created,CreatedBy,EntityType,IsActive,Name,PrintName,Updated,UpdatedBy) VALUES (0,54087,0,'sumqtyonhand',TO_DATE('2009-12-01 16:57:45','YYYY-MM-DD HH24:MI:SS'),100,'D','Y','sumqtyonhand','sumqtyonhand',TO_DATE('2009-12-01 16:57:45','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,CreatedBy,Updated,IsParent,AD_Client_ID,AD_Org_ID,Name,IsActive,FieldLength,IsSelectionColumn,AD_Reference_ID,Created,IsUpdateable,IsKey,AD_Element_ID,UpdatedBy,IsAlwaysUpdateable,ColumnName,IsEncrypted) VALUES (58687,53247,'D',0,'N','N','N',100,TO_DATE('2009-12-01 16:57:45','YYYY-MM-DD HH24:MI:SS'),'N',0,0,'sumqtyonhand','Y',131089,'N',29,TO_DATE('2009-12-01 16:57:45','YYYY-MM-DD HH24:MI:SS'),'Y','N',54087,100,'N','sumqtyonhand','N')
;
...
-- RV_STORAGE_PER_PRODUCT
UPDATE AD_Element SET ColumnName='SumQtyOnHand', Description='Summary of product on hand in all locators', Name='Sum Qty on Hand', PrintName='Sum Qty on Hand',Updated=TO_DATE('2009-12-01 16:59:05','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=54087
;
...
-- Dec 1, 2009 4:59:05 PM CET
-- RV_STORAGE_PER_PRODUCT
UPDATE AD_PrintFormatItem pi SET PrintName='Sum Qty on Hand', Name='Sum Qty on Hand' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=54087)
;

-- Dec 1, 2009 5:01:19 PM CET
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_ReportView (AD_Client_ID,AD_Org_ID,AD_ReportView_ID,AD_Table_ID,Created,CreatedBy,EntityType,IsActive,Name,Updated,UpdatedBy) VALUES (0,0,53031,53247,TO_DATE('2009-12-01 17:01:18','YYYY-MM-DD HH24:MI:SS'),100,'D','Y','RV_Storage_Per_Product',TO_DATE('2009-12-01 17:01:18','YYYY-MM-DD HH24:MI:SS'),100)
;

-- Dec 1, 2009 5:03:04 PM CET
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Process (AccessLevel,AD_Client_ID,AD_Org_ID,AD_Process_ID,AD_ReportView_ID,CopyFromProcess,Created,CreatedBy,EntityType,IsActive,IsBetaFunctionality,IsDirectPrint,IsReport,IsServerProcess,Name,ShowHelp,Statistic_Count,Statistic_Seconds,Updated,UpdatedBy,Value) VALUES ('3',0,0,53189,53031,'N',TO_DATE('2009-12-01 17:02:59','YYYY-MM-DD HH24:MI:SS'),100,'D','Y','N','N','Y','N','Storage per Product','Y',0,0,TO_DATE('2009-12-01 17:02:59','YYYY-MM-DD HH24:MI:SS'),100,'RV_Storage_Per_Product')
;
...
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,453,0,53189,53362,19,'M_Product_Category_ID',TO_DATE('2009-12-01 17:05:01','YYYY-MM-DD HH24:MI:SS'),100,'D',10,'Y','Y','N','N','Product Category',10,TO_DATE('2009-12-01 17:05:01','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Process_Para (AD_Client_ID,AD_Element_ID,AD_Org_ID,AD_Process_ID,AD_Process_Para_ID,AD_Reference_ID,ColumnName,Created,CreatedBy,EntityType,FieldLength,IsActive,IsCentrallyMaintained,IsMandatory,IsRange,Name,SeqNo,Updated,UpdatedBy) VALUES (0,454,0,53189,53363,19,'M_Product_ID',TO_DATE('2009-12-01 17:05:40','YYYY-MM-DD HH24:MI:SS'),100,'D',10,'Y','Y','N','N','Product',20,TO_DATE('2009-12-01 17:05:40','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_Menu (Action,AD_Client_ID,AD_Menu_ID,AD_Org_ID,AD_Process_ID,Created,CreatedBy,EntityType,IsActive,IsReadOnly,IsSOTrx,IsSummary,Name,Updated,UpdatedBy) VALUES ('R',0,53253,0,53189,TO_DATE('2009-12-01 17:07:29','YYYY-MM-DD HH24:MI:SS'),100,'D','Y','N','N','N','Storage per Product',TO_DATE('2009-12-01 17:07:29','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Dec 1, 2009 5:07:30 PM CET
-- RV_STORAGE_PER_PRODUCT
INSERT INTO AD_TreeNodeMM (AD_Client_ID,AD_Org_ID, IsActive,Created,CreatedBy,Updated,UpdatedBy, AD_Tree_ID, Node_ID, Parent_ID, SeqNo) SELECT t.AD_Client_ID,0, 'Y', SysDate, 0, SysDate, 0,t.AD_Tree_ID, 53253, 0, 999 FROM AD_Tree t WHERE t.AD_Client_ID=0 AND t.IsActive='Y' AND t.IsAllNodes='Y' AND t.TreeType='MM' AND NOT EXISTS (SELECT * FROM AD_TreeNodeMM e WHERE e.AD_Tree_ID=t.AD_Tree_ID AND Node_ID=53253)
;
...
-- Dec 1, 2009 5:07:37 PM CET
-- RV_STORAGE_PER_PRODUCT
UPDATE AD_TreeNodeMM SET Parent_ID=183, SeqNo=0, Updated=SysDate WHERE AD_Tree_ID=10 AND Node_ID=53253
;
