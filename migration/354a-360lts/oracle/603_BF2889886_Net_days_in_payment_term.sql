...
UPDATE AD_Message_Trl SET IsTranslated='Y',MsgText='Trebuie sa fie numar pozitiv!',Updated=TO_DATE('2009-11-18 11:28:34','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Message_ID=53090 AND AD_Language='ro_RO'
;
