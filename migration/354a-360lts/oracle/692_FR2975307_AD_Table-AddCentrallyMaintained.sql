...
-- https://sourceforge.net/tracker/index.php?func=detail&aid=2975307&group_id=176962&atid=879335
-- ADD IsCentrallyMaintained to AD_Table
ALTER TABLE AD_Table ADD IsCentrallyMaintained CHAR(1) DEFAULT 'Y' CHECK (IsCentrallyMaintained IN ('Y','N'))
;
...
-- https://sourceforge.net/tracker/index.php?func=detail&aid=2975307&group_id=176962&atid=879335
-- ADD IsCentrallyMaintained to AD_Table
INSERT INTO AD_Field (AD_Client_ID,AD_Column_ID,AD_Field_ID,AD_Org_ID,AD_Tab_ID,Created,CreatedBy,Description,DisplayLength,EntityType,Help,IsActive,IsCentrallyMaintained,IsDisplayed,IsEncrypted,IsFieldOnly,IsHeading,IsReadOnly,IsSameLine,Name,SeqNo,SortNo,Updated,UpdatedBy) VALUES (0,59135,58844,0,100,TO_DATE('2010-03-24 15:15:46','YYYY-MM-DD HH24:MI:SS'),100,'Information maintained in System Element table',0,'D','The Centrally Maintained checkbox indicates if the Name, Description and Help maintained in ''System Element'' table  or ''Window'' table.','Y','Y','Y','N','N','N','N','Y','Centrally maintained',180,0,TO_DATE('2010-03-24 15:15:46','YYYY-MM-DD HH24:MI:SS'),100)
;
