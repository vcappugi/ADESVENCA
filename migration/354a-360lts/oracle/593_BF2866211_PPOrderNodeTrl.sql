...
UPDATE AD_Element SET Description='Workflow Node (activity), step or process', Help='The Workflow Node indicates a unique step or process in a Workflow.',Updated=TO_DATE('2009-10-07 08:06:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=53285
;
...
-- Fix PPOrderNodeTrl - Column AD_WF_Node_ID to PP_Order_Node_ID
UPDATE AD_Column SET Help='The Workflow Node indicates a unique step or process in a Workflow.', Description='Workflow Node (activity), step or process', Name='Manufacturing Order Activity', IsUpdateable='N', AD_Element_ID=53285, ColumnName='PP_Order_Node_ID',Updated=TO_DATE('2009-10-07 08:08:23','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=57204
;
