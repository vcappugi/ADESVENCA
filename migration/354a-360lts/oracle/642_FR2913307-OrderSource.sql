...
UPDATE AD_Element SET EntityType='D', Name='Order Source', PrintName='Order Source',Updated=TO_DATE('2009-12-12 22:54:58','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Element_ID=53942
;
...
-- https://sourceforge.net/tracker/?func=detail&aid=2913307&group_id=176962&atid=883808
UPDATE AD_PrintFormatItem pi SET PrintName='Order Source', Name='Order Source' WHERE IsCentrallyMaintained='Y' AND EXISTS (SELECT * FROM AD_Column c WHERE c.AD_Column_ID=pi.AD_Column_ID AND c.AD_Element_ID=53942)
;

-- Dec 12, 2009 11:06:42 PM CET
-- FR [2913307] - New table: Order Source
-- https://sourceforge.net/tracker/?func=detail&aid=2913307&group_id=176962&atid=883808
UPDATE AD_Tab SET IsSingleRow='Y',Updated=TO_DATE('2009-12-12 23:06:42','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Tab_ID=186
;